OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "Is é \"%s\" an crios ama atá in úsáid. Chun na hamanna i do chrios ama reatha a fheiceáil, téigh isteach sa vótaíocht trí chliceáil ar an gcnaipe thíos.",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Tá pobalbhreith {pollTitle} roinnte agat leis an bhfoireann {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "Tá pobalbhreith {pollTitle} roinnte ag {actor} leis an bhfoireann {sharee}",
    "You have shared this poll with team {sharee}" : "Tá an pobalbhreith seo roinnte agat le foireann {sharee}",
    "{actor} has shared this poll with team {sharee}" : "Tá an pobalbhreith seo roinnte ag {actor} le foireann {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Scrios tú an comhroinnt don fhoireann {sharee} ón bpobalbhreith {pollTitle}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "Scrios {actor} an comhroinnt don fhoireann {sharee} ón bpobalbhreith {pollTitle}",
    "You have deleted the share for team {sharee}" : "Scrios tú an comhroinnt don fhoireann {sharee}",
    "{actor} has deleted the share for team {sharee}" : "Scrios {actor} an comhroinnt don fhoireann {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Tá an comhroinnt athchóirithe agat don fhoireann {sharee} ón vótaíocht {pollTitle}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "Tá an comhroinnt athchóirithe ag {actor} don fhoireann {sharee} ón bpobalbhreith {pollTitle}",
    "You have restored the share for team {sharee}" : "Tá an comhroinnt athchóirithe agat don fhoireann {sharee}",
    "{actor} has restored the share for team {sharee}" : "Tá an comhroinnt athchóirithe ag {actor} don fhoireann {sharee}",
    ...
    "Select timezone to apply" : "Roghnaigh crios ama le cur i bhfeidhm",
    "Use original timezone ({pollTimezone})" : "Úsáid an crios ama bunaidh ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Úsáid do chrios ama ({localTimezone})",
    ...
    "Allow download of poll results" : "Ceadaigh íoslódáil thorthaí pobalbhreithe",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Scriosfar an pobalbhreith go neamh-inchúlghairthe leis seo agus cuirfear {username} ar an eolas.",
    "This will irreversibly delete the poll." : "Scriosfaidh sé seo an pobalbhreith go dochúlaithe.",
    "OK" : "Ceart go leor",
    ...
    "Expand options" : "Leathnaigh roghanna",
    ...
    "Submit" : "Cuir isteach",
    "_%n repetition_::_Last of %n repetitions_" : ["%n athrá","Deireanach de %n athrá","Deireanach de %n athrá","Deireanach de %n athrá","Deireanach de %n athrá"],
    ...
    "Expand description" : "Leathnaigh an cur síos",
    ...
    "Current timezone: {timezoneString}" : "Crios ama reatha: {timezoneString}",
    "Original timezone: {timezoneString}" : "Crios ama bunaidh: {timezoneString}",
    ...
    "Expired {dateTime}" : "Imithe in éag {dateTime}",
    "Last activity {dateTime}" : "Gníomhaíocht dheireanach {dateTime}",
    ...
    "Checking email address …" : "Ag seiceáil an seoladh ríomhphoist …",
    ...
    "Register to this poll" : "Cláraigh don vótaíocht seo",
    ...
    "Days after which archived polls should be permanently deleted" : "Laethanta ina dhiaidh sin ba chóir pobalbhreitheanna cartlannaithe a scriosadh go buan",
    ...
    "Use the default terms for public polls" : "Úsáid na téarmaí réamhshocraithe le haghaidh pobalbhreitheanna poiblí",
    ...
    "Error sending invitations" : "Earráid ag seoladh na gcuirí",
    ...
    "Set default timezone for this poll" : "Socraigh crios ama réamhshocraithe don phobalbhreith seo",
    ...
    "Your timezone: ({timezone})" : "Do chrios ama: ({timezone})",
    "Poll timezone: ({timezone})" : "Crios ama na pobalbhreithe: ({timezone})",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Nó [link]logáil isteach[/link] más ball den suíomh seo thú.",
    ...
    "Access" : "Rochtain",
    "Sort by access level" : "Sórtáil de réir leibhéal rochtana",
    "Owner" : "Úinéir",
    "Sort by name of the owner" : "Sórtáil de réir ainm an úinéara",
    "Expiration" : "Dáta éaga",
    "Sort by expiration date" : "Sórtáil de réir dáta éaga",
    "Sort by activity" : "Sórtáil de réir gníomhaíochta",
    "Relevant" : "Ábhartha",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "Pobalbhreitheanna ábhartha atá ábhartha duitse, mar gur rannpháirtí thú, an t-úinéir nó mar go bhfuil cuireadh tugtha duit. Ní thaispeántar ach pobalbhreitheanna nach bhfuil níos sine ná 100 lá i gcomparáid leis an gcruthú, an ghníomhaíocht dheireanach, an dul in éag nó an rogha is déanaí (i gcás pobalbhreitheanna dátaithe).",
