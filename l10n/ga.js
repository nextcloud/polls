OC.L10N.register(
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "Ná húsáid iad ach amháin má tá sé riachtanach go hiomlán (i.e. mura bhfuil do cron ag obair i gceart) nó le haghaidh tástála.",
    ...
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "Ní thaispeánann an fhaisnéis ama ach an rith rialta cron-phoist deireanach, ní na ritheanna a tionscnaíodh de láimh.",
