OC.L10N.register(
    ...
    "You have closed the poll \"{pollTitle}\" " : "Tá an vótaíocht \"{pollTitle}\" dúnta agat",
    ...
    "You have reopened the poll \"{pollTitle}\" " : "D'oscail tú an vótaíocht \"{pollTitle}\"",
    ...
    "Someone voted inside a <strong>poll</strong>" : "Vótáil duine éigin taobh istigh de <strong>vóta</strong>",
    "A polls app, similar to Doodle/Dudle with the possibility to restrict access." : "Aip pobalbhreithe, cosúil le Doodle/Dudle agus an fhéidearthacht ann rochtain a shrianadh.",
    "A polls app, similar to Doodle/Dudle with the possibility to restrict access (members, certain groups/users, hidden and public)." : "Aip pobalbhreithe, cosúil le Doodle/Dudle agus an fhéidearthacht ann rochtain a shrianadh (comhaltaí, grúpaí/úsáideoirí áirithe, folaithe agus poiblí).",
    ...
    "Register" : "Clár",
    "Send information about confirmed options by email" : "Seol faisnéis faoi roghanna deimhnithe trí ríomhphost",
    ...
    "_%n confirmation has been sent_::_%n confirmations have been sent_" : ["%n deimhniú seolta","%n deimhniú seolta","%n deimhniú seolta","%n deimhniú seolta","%n deimhniú seolta"],
    "_%n confirmation could not be sent_::_%n confirmations could not be sent:_" : ["Níorbh fhéidir %n dearbhú a sheoladh:","Níorbh fhéidir %n deimhniú a sheoladh:","Níorbh fhéidir %n deimhniú a sheoladh:","Níorbh fhéidir %n deimhniú a sheoladh:","Níorbh fhéidir %n deimhniú a sheoladh:"],
    "Reveal them" : "Nocht iad",
    "Toggle Sidebar" : "Scoránaigh Barra Taoibh",
    "Enter a date" : "Cuir isteach dáta",
    "Select a time" : "Roghnaigh am",
    "Enter a time" : "Cuir isteach am",
    "Conflict" : "Coimhlint",
    "Add" : "Cuir",
    "You are asked to propose more options. " : "Iarrtar ort tuilleadh roghanna a mholadh.",
    "The proposal period ends {timeRelative}." : "Tagann deireadh le tréimhse an togra {timeRelative}.",
    "Although participant's names are hidden, this is not a real anonymous poll because they are not hidden from the owner." : "Cé go bhfuil ainmneacha na rannpháirtithe i bhfolach, ní pobalbhreith fíor gan ainm é seo toisc nach bhfuil siad i bhfolach ón úinéir.",
    "Additionally the owner can remove the anonymous flag at any time, which will reveal the participant's names." : "Ina theannta sin is féidir leis an úinéir an bhratach gan ainm a bhaint ag am ar bith, rud a nochtfaidh ainmneacha an rannpháirtí.",
    "This poll is closed." : "Tá an pobalbhreith seo dúnta.",
    "No further action is possible." : "Ní féidir a thuilleadh a dhéanamh.",
    "Due to possible performance issues {countHiddenParticipants} voters are hidden." : "De bharr fadhbanna feidhmíochta féideartha {countHiddenParticipants} tá na vótálaithe i bhfolach.",
    "You can reveal them, but you may expect an unwanted long loading time." : "Is féidir leat iad a nochtadh, ach b'fhéidir go mbeifeá ag súil le ham lódála fada nach dteastaíonn.",
    "_%n orphaned vote of a probaly deleted option is possibly blocking your vote limit._::_%n orphaned votes of probaly deleted options are possibly blocking your vote limit._" : ["%n vóta dílleachta de rogha atá scriosta b'fhéidir ag cur bac ar do theorainn vótaíochta.","%n vótaí dílleachta de roghanna atá scriosta b'fhéidir ag cur bac ar do theorainn vótaíochta.","%n vótaí dílleachta de roghanna atá scriosta b'fhéidir ag cur bac ar do theorainn vótaíochta.","%n vótaí dílleachta de roghanna atá scriosta b'fhéidir ag cur bac ar do theorainn vótaíochta.","%n vótaí dílleachta de roghanna atá scriosta b'fhéidir ag cur bac ar do theorainn vótaíochta."],
    "Limited votes." : "Vótaí teoranta.",
    "_%n vote is allowed per option._::_%n votes are allowed per option._" : ["Ceadaítear %n vóta in aghaidh na rogha.","Ceadaítear %n vóta in aghaidh na rogha.","Ceadaítear %n vóta in aghaidh na rogha.","Ceadaítear %n vóta in aghaidh na rogha.","Ceadaítear %n vóta in aghaidh na rogha."],
    "_%n vote is allowed per participant._::_%n votes are allowed per participant._" : ["Ceadaítear %n vóta in aghaidh an rannpháirtí.","Ceadaítear %n vóta in aghaidh an rannpháirtí.","Ceadaítear %n vóta in aghaidh an rannpháirtí.","Ceadaítear %n vóta in aghaidh an rannpháirtí.","%n votes are allowed per participant."],
    "_You have %n vote left._::_You have %n votes left._" : ["Tá %n vóta fágtha agat.","Tá %n vótaí fágtha agat.","Tá %n vótaí fágtha agat.","Tá %n vótaí fágtha agat.","Tá %n vótaí fágtha agat."],
    ...
    "For polls with expiration:" : "Le haghaidh pobalbhreitheanna atá imithe in éag:",
    ...
    "Autoreminder informations" : "Faisnéise uathmheabhrúcháin",
    ...
    "Hide not available Options" : "Folaigh Roghanna nach bhfuil ar fáil",
    "Proposals possible until" : "Tograí is féidir go dtí",
    ...
    "Propose a date" : "Mol dáta",
    "Propose an option" : "Mol rogha",
    "No vote options" : "Gan roghanna vótála",
    "Click to add an option" : "Cliceáil chun rogha a chur leis",
    "Add date" : "Cuir dáta leis",
    ...
    "Select range" : "Roghnaigh raon",
    "Change date" : "Athraigh an dáta",
    "Change time" : "Athraigh am",
    "Remove time" : "Bain am",
    "Add time" : "Cuir am leis",
    "Added" : "Curtha leis",
    "Pick a day." : "Pioc lá.",
    ...
    "Repetitions" : "Athrá",
    "Preview" : "Réamhamharc",
    "_%n repetition until_::_%n repetitions until_" : ["%n athrá go dtí","%n athrá go dtí","%n athrá go dtí","%n athrá go dtí","%n athrá go dtí"],
    "No duration" : "Gan ré",
    ...
    "Close" : "Dún",
    "Poll informations" : "Faisnéis vótaíochta",
    ...
    "_{usedVotes} of %n vote left._::_{usedVotes} of %n votes left._" : ["{usedVotes} de %n vóta fágtha.","{usedVotes} de %n vótaí fágtha.","{usedVotes} de %n vótaí fágtha.","{usedVotes} de %n vótaí fágtha.","{usedVotes} de %n vótaí fágtha."],
    "_Only %n vote per option._::_Only %n votes per option._" : ["Níl ach %n vóta in aghaidh an rogha.","Ní raibh ach %n vótaí in aghaidh an rogha.","Ní raibh ach %n vótaí in aghaidh an rogha.","Ní raibh ach %n vótaí in aghaidh an rogha.","Ní raibh ach %n vótaí in aghaidh an rogha."],
    "Access" : "Rochtain",
    "Owner" : "Úinéir",
    "Created" : "Cruthaithe",
    "Closing date" : "Dáta deiridh",
    "No description provided" : "Níor tugadh tuairisc",
    "By clicking the \"OK\" button you accept our {privacyPolicy}." : "Trí chliceáil ar an gcnaipe \"OK\" glacann tú lenár {privacyPolicy}.",
    "privacy policy" : "Beartas Príobháideachais",
    ...
    "A poll with many options and voters can have a heavy impact on client performance." : "Is féidir le vótaíocht ina bhfuil go leor roghanna agus vótálaithe tionchar mór a bheith aige ar fheidhmíocht na gcliant.",
    "Set the amount of voting cells (options x participants) up to which all voting cells should be displayed." : "Socraigh an méid cealla vótála (roghanna x rannpháirtithe) ar cheart na cealla vótála go léir a thaispeáint suas go dtí sin.",
    "If this threshold gets trespassed, only the current participant will be displayed, to avoid a performance breakdown." : "Má dhéantar foghail ar an tairseach seo, ní thaispeánfar ach an rannpháirtí reatha, chun miondealú feidhmíochta a sheachaint.",
    "The default threshold of 1000 should be a good and safe value." : "Ba cheart go mbeadh an tairseach réamhshocraithe de 1000 ina luach maith agus sábháilte.",
    ...
    "Use alternative option add dialog" : "Úsáid rogha eile dialóg cuir leis",
    "Arrange description and card hints side by side" : "Socraigh cur síos agus leideanna cárta taobh le taobh",
    ...
    "deleted" : "scriosta",
    "Share of {displayName} unlocked" : "Díghlasáil sciar de {displayName}",
    "Share of {displayName} locked" : "Comhroinn de {displayName} faoi ghlas",
    ...
    "Resolve into individual invitations" : "Réitigh isteach cuirí aonair",
    "Grant poll admin access" : "Deonaigh rochtain riaracháin vótaíochta",
    "Withdraw poll admin access" : "Tarraingt siar rochtain riaracháin vótaíochta",
    ...
    "Poll configurations" : "Cumraíochtaí vótaíochta",
    ...
    "Is granted admin rights for this poll" : "Tugtar cearta riaracháin don vótaíocht seo",
    ...
    "Remove Email Address" : "Bain Seoladh Ríomhphoist",
    ...
    "Loading polls…" : "Pobalbhreith á lódáil…",
    ...
    "Error overtaking poll." : "Earráid agus an vótaíocht á scoitheadh.",
    "Error loading polls list for admins" : "Earráid agus an liosta pobalbhreithe á lódáil do riarthóirí",
    ...
    "Do you want to take over this poll?" : "Ar mhaith leat an pobalbhreith seo a ghlacadh ar láimh?",
    "{username} will get notified." : "Cuirfear {username} ar an eolas.",
    "Do you want to delete this poll?" : "Ar mhaith leat an pobalbhreith seo a scriosadh?",
    "This action cannot be reverted." : "Ní féidir an gníomh seo a thabhairt ar ais.",
    ...
    "Error loading poll list" : "Earráid agus an liosta vótaíochta á lódáil",
    ...
    "Try to change these parameters to handle big polls" : "Déan iarracht na paraiméadair seo a athrú chun pobalbhreith mhóra a láimhseáil",
    ...
    "Date order" : "Ordú dáta",
    "Original order" : "Ordú bunaidh",
    "Ranked order" : "Ordú rangaithe",
    "valid email address." : "seoladh ríomhphoist bailí.",
    "Optional email address" : "Seoladh ríomhphoist roghnach",
    "No activity" : "Gan aon ghníomhaíocht",
    ...
    "\"{pollTitle}\" successfully saved" : "Sábháladh \"{pollTitle}\" go rathúil"
},
