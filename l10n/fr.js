OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "Le fuseau horaire utilisé est \"%s\". Pour voir les horaires dans votre fuseau horaire actuel, entrez dans le sondage en cliquant le bouton ci-dessous.",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Vous avez partagé le sondage {pollTitle} avec l'équipe {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} a partagé le sondage {pollTitle} avec l'équipe {sharee}",
    "You have shared this poll with team {sharee}" : "Vous avez partagé ce sondage avec l'équipe {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} a partagé ce sondage avec l'équipe {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Vous avez supprimé le partage avec l'équipe {sharee} du sondage {pollTitle}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} a supprimé le partage avec l'équipe {sharee} du sondage {pollTitle}",
    "You have deleted the share for team {sharee}" : "Vous avez supprimé le partage avec l'équipe {sharee}",
    "{actor} has deleted the share for team {sharee}" : "{actor} a supprimé le partage avec l'équipe {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Vous avez restauré le partage avec l'équipe {sharee} du sondage {pollTitle}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} a restauré le partage avec l'équipe {sharee} du sondage {pollTitle}",
    "You have restored the share for team {sharee}" : "Vous avez restauré le partage avec l'équipe {sharee}",
    "{actor} has restored the share for team {sharee}" : "{actor} a restauré le partage avec l'équipe {sharee}",
    ...
    "Select timezone to apply" : "Choisir le fuseau horaire à appliquer",
    "Use original timezone ({pollTimezone})" : "Utiliser le fuseau horaire original ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Utiliser votre fuseau horaire ({localTimezone})",
    ...
    "Allow download of poll results" : "Autoriser le téléchargement des résultats du sondage",
    ...
    "Error restoring poll." : "Erreur lors de la restauration du sondage.",
    "Error archiving poll." : "Erreur lors de l'archivage du sondage.",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Cela supprimera définitivement le sondage et {username} sera notifié.",
    "This will irreversibly delete the poll." : "Cela supprimera définitivement le sondage.",
    "OK" : "OK",
    ...
    "Expand options" : "Étendre les options.",
    ...
    "Submit" : "Soumettre",
    "_%n repetition_::_Last of %n repetitions_" : ["%n occurrence","Dernière des %n occurrences","Dernière des %n occurrences"],
    ...
    "Closing: {dateTime}" : "Fermeture : {dateTime}",
    "Closing: {dateRelative}" : "Fermeture {dateRelative}",
    "Current timezone: {timezoneString}" : "Fuseau horaire actuel : {timezoneString}",
    "Original timezone: {timezoneString}" : "Fuseau horaire original : {timezoneString}",
    ...
    "Expired {dateTime}" : "Expiré {dateTime}",
    "Last activity {dateTime}" : "Dernière activité {dateTime}",
    ...
    "Open poll, accessible to all users of this instance and invited participants" : "Sondage ouvert, accessible à tous les utilisateurs de cette instance et aux participants invités",
    ...
    "Register to this poll" : "S'inscrire à ce sondage",
    ...
    "Days after which archived polls should be permanently deleted" : "Jours après lesquels les sondages archivés seront supprimés définitivement",
    ...
    "Sends out pending automatic reminders." : "Envoyer automatiquement les rappels d'attente de réponses",
    "Cleans up old or irrelevant data from the system to maintain optimal performance and organization." : "Nettoyez les données obsolètes du système pour maintenir des performances optimales et une bonne organisation.",
    "Sends out pending notifications about poll updates." : "Envoyer automatiquement les rappels d'attente de réponses pour les sondages mis à jours.",
    "Description is missing." : "Description manquante.",
    "Execution failed" : "L'exécution a échoué",
    "The last execution of this job has failed. Please check the logs for more details." : "La dernière exécution de cette tâche a échoué. Merci de vérifier les journaux pour plus de détails.",
    "Not run yet" : "Pas encore lancé",
    "This job has never been run yet." : "Ce job n'a jamais été lancé encore.",
    "{jobName} has been executed." : "{jobName} à été exécuté ",
    "Start {jobName} manually." : "{jobName} a démarré normalement",
    "{jobName} does not support manually run." : "{jobName} lancement manuel non supporté",
    "Request Execution" : "Demander l’exécution ",
    "Request job execution" : "Demander l’exécution du job",
    ...
    "Use the default terms for public polls" : "Utiliser les mentions par défaut pour les sondages publics",
    ...
    "Resolve contact group first!" : "Résolvez d'abord le groupe de contacts !",
    "Resolve this team first!" : "Résolvez d'abord cette équipe !",
    ...
    "Error sending invitations" : "Erreur à l'envoi des invitations",
    ...
    "Forced display mode" : "Forcer le mode d'affichage",
    "Set default timezone for this poll" : "Définir le fuseau horaire par défaut pour ce sondage",
    ...
    "Type to start searching …" : "Saisissez du texte pour lancer la recherche…",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Ou [link]Identifiant[/link] si vous êtes membre de ce site.",
    ...
    "Access" : "Accès",
    "Sort by access level" : "Trier par niveau d'accès",
    "Owner" : "Propriétaire",
    "Sort by name of the owner" : "Trier par nom du propriétaire",
    "Expiration" : "Expiration",
    "Sort by expiration date" : "Trier par date d'expiration",
    "Sort by activity" : "Trier par activité",
    "Relevant" : "Me concernant",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "Sondage pertinents qui sont pertinents pour vous, parce que vous êtes participant, propriétaire ou invité. Seuls les sondages créés, dont la dernière activité, expirés ou dont la dernière option (pour les sondages de date) date de moins de 100 jours sont pertinents.",
