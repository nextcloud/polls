OC.L10N.register(
    ...
    "%s changed the deleted status of your poll" : "%s a changé le statut de suppression de votre sondage",
    ...
    "never" : "jamais",
    "Beta - watch for updated polls in realtime" : "Bêta - Voir les sondages mis à jour en temps réel",
    "All changes to the current poll, done by other users, will be recognized in realtime." : "Toutes les modifications apportées au sondage en cours, effectuées par d’autres utilisateurs, seront reconnues en temps réel.",
