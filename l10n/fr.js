OC.L10N.register(
    ...
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Votre adresse email est obligatoire. Après l'inscription, votre lien privé vers le sondage vous sera envoyé à cette adresse.",
    ...
    "Access for all users of this site is disabled" : "L'accès pour tous les utilisateurs de ce site est désactivé",
    "Access for all users of this site is enabled" : "L'accès pour tous les utilisateurs de ce site est activé",
