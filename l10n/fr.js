OC.L10N.register(
    ...
    "%s is the new owner of your poll. " : "%s est le nouveau propriétaire de votre sondage",
    ...
    "Edit poll group" : "Éditer le groupe de sondage",
    "Add some!" : "Ajoutez-en !",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduces your vote quota._" : ["%n vote orphelin réduit votre quota de vote.","%n votes orphelins réduisent votre quota de vote.","%n votes orphelins réduisent votre quota de vote."],
    ...
    "Choose a more meaningful title for the overview page" : "Choisissez un titre plus explicite pour la page récapitulative",
    "Choose a description for the overview page" : "Choisissez un description pour la page récapitulative",
    "Note: Changing the title, also changes the URL" : "Note : Changer le titre change également l'URL",
    "Error updating PollGroup" : "Erreur à la mise à jour du groupe de sondage",
    "Extended title" : "Titre étendu",
    "Enter extended Title" : "Saisir un titre complet",
    ...
    "Check this for more poll information in the overview." : "Cocher ici pour plus d'information sur les sondages dans la liste.",
    ...
    "Use fixed table headers" : "Utiliser des entêtes de tableau fixes",
    ...
    "Type to start searching ..." : "Taper pour commencer à chercher...",
    ...
    "Group without title" : "Groupe sans titre",
    ...
    "Group without description" : "Groupe sans description",
