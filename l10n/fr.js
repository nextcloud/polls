OC.L10N.register(
    ...
    "{user} took over your poll \"%s\" and is the new owner." : "{user} a repris votre sondage \"%s\" et en est le nouveau propriétaire.",
    "%s permanently deleted your poll" : "%s a définitivement supprimé votre sondage",
    "{user} permanently deleted your poll \"%s\"." : "{user} a définitivement supprimé votre sondage \"%s\".",
    "%s changed the deleted status of your poll." : "%sa changé le status supprimé de votre sondage.",
    "{user} changed the deleted status of your poll \"%s\"." : "{user} a changé le statut de suppression de votre sondage \"%s\".",
    "- %s voted." : "- %s a voté.",
    ...
    "Allow \"maybe\" vote" : "Autoriser à voter \"peut-être\"",
    ...
    "Add some!" : "Ajoutez-en!",
    "Add new date option" : "Ajouter un choix de date",
    "Add" : "Ajouter",
    "Added" : "Ajouté",
    ...
    "Add new text option" : "Ajouter un choix textuel",
    ...
    "Option proposals allowed" : "Propositions acceptées",
    "Option proposal term ends {timeRelative}" : "Fin des propositions {timeRelative}",
    "Option proposal term ended {timeRelative}" : "Les propositions sont closes {timeRelative}",
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "Ajouter les paramètres 'name=' et/ou 'email=' à l'URL pour prédéfinir le nom et l'e-mail. Par exemple : https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org",
    "Error adding share" : "Erreur lors de l'ajout du partage",
