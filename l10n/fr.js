OC.L10N.register(
    ...
    "403 - You are not allowed to access this poll" : "403 - Vous n'êtes pas autorisé à accéder à ce sondage",
    ...
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Les sondages me concernant sont ceux où vous êtes participant, le propriétaire ou ceux où vous êtes invités. Seuls les sondages dont la date de création, d'expiration, de dernière interaction ou de dernière option (pour les sondage de type date) a moins de 100 jours sont visibles.",
