OC.L10N.register(
    ...
    "Share for user {displayName} unlocked" : "Partage pour l'utilisateur {displayName} débloqué",
    "Share for user {displayName} locked" : "Partage pour l'utilisateur {displayName} verrouillé",
    "Error while changing lock status for user {displayName}" : "Erreur lors du changement de l'état de verrouillage pour l'utilisateur {displayName}",
    "Share and votes for {displayName} deleted" : "Partages et votes pour {displayName} supprimés",
    "Share for user {displayName} deleted" : "Partage pour l'utilisateur {displayName} supprimé",
    "Error deleting share for user {displayName}" : "Erreur lors de la suppression du partage pour l'utilisateur {displayName}",
