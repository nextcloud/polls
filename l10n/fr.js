OC.L10N.register(
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "Vous avez supprimé l'option {optionTitle} du sondage {pollTitle}",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor} a supprimé l'option {optionTitle} du sondage {pollTitle}",
    ...
    "Send confirmation emails" : "Envoyer des e-mails de confirmation",
    "Sent emails to:" : "E-mails envoyés à :",
    "Emails could not be sent:" : "Les e-mails n'ont pas pu être envoyés :",
    ...
    "Confirmation sent to {participant} ({emailAddress})" : "Confirmation envoyée à {participant} ({emailAddress})",
    "Confirmation could not be sent to {participant} ({emailAddress})" : "La confirmation ne peut pas être envoyée à {participant} ({emailAddress})",
    "_Confirmations sent to {count} recipient_::_Confirmations sent to {count} recipients_" : ["Confirmation envoyée à {count} destinataire","Confirmations envoyées à {count} destinataires","Confirmations envoyées à {count} destinataires"],
    ...
    "Styles" : "Styles",
    "User is only able to see the votes." : "L'utilisateur peut seulement voir les votes.",
    "Has voted" : "A voté",
    ...
    "Re-Revoke share" : "Révoquer le partage à nouveau",
    ...
    "Share for user {displayName} revoked" : "Partage pour l'utilisateur {displayName} révoqué",
    "Deleted share for user {displayName}" : "Le partage pour l'utilisateur {displayName} a été supprimé",
    "Error deleting or revoking share for user {displayName}" : "Erreur à la suppression ou la révocation du partage pour l'utilisateur  {displayName}",
    ...
    "Shares" : "Partages",
    "Revoked shares" : "Partages révoqués",
    ...
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Tous les sondages qui sont pertinents ou importants pour vous, parce que vous êtes soit un participant, soit le propriétaire, soit y avez été invité.",
