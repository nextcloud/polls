OC.L10N.register(
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "Merci de ne les utiliser que si cela est absolument nécessaire (par exemple si vos tâches planifiées ne fonctionnent pas correctement) ou pour tester.",
    ...
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "L'information de temps affiche la dernière tache planifiée (Cron), pas les taches lancées manuellement.",
