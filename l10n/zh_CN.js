OC.L10N.register(
    ...
    "_%n person participated in this poll until now. _::_%n persons participated in this poll until now. _" : ["至今已有 %n 人参加此投票。"],
    "New comment …" : "新评论...",
    "Your comment was added" : "您的注释已添加",
    "You can place your vote until %n. " : "您可以投票直到 %n。 ",
    "Error while saving comment" : "保存注释时错误",
    "Voting is no more possible, because this poll expired since %n. " : "无法投票，因为此投票已经在 %n 到期。",
    "Comments" : "评论",
    "Delete comment" : "删除评论",
    ...
    "Delete poll" : "删除投票",
    "Restore poll as admin" : "以管理员身份恢复投票",
    "Restore poll" : "恢复投票",
    "Delete poll permanently as admin" : "以管理员身份永久删除投票",
    ...
    "To participate, enter a username with at least 3 characters." : "要参加，请输入有至少 3 个字符的用户名。",
    "Enter your name" : "输入你的名字",
    "Username is not valid. Please enter at least 3 characters." : "用户名无效。 请输入至少 3 个字符。",
    "This username is not valid, i.e. because it is already in use." : "该用户名无效，也许因为该用户名已被使用。",
