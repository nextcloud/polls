OC.L10N.register(
    ...
    "%s changed the deleted status of your poll" : "%s 更改了你的民意测验的删除状态",
    ...
    "The following link is your personal access to this poll. You can reenter this poll at any time, change your vote and leave comments." : "以下链接是你个人访问这个民意调查的途径。你可以在任何时候重新进入这个投票，改变你的投票和留下评论。",
    "This poll is closed since {dateString}. The confirmed options are marked below." : "该民意测验自 {dateString} 起关闭。确认的选项标注如下。",
    "This poll is closed since {dateString}, but there are no confirmed options until now." : "该民意测验自 {dateString} 起关闭，但直到现在还没有确认的选项。",
    "You can confirm your favorites now in the options tab in the sidebar." : "你现在可以在工具条的选项卡中确认你的偏好。",
    "You can place your vote until {dateString}." : "您可以投票直到 {dateString}。 ",
    "This is an anonymous poll. Except to the poll owner, participants names are hidden." : "这是一次匿名投票。除了投票所有人，别人看不到参与者的名字。",
    "You reached the maximum number of allowed votes." : "你达到了允许的最大票数。",
    "This is an exclusive vote, where only one user is allowed to vote for an option." : "这是一个排他性投票，只有一个用户被允许为一个选项投票。",
    ...
    "If vote limits are used, 'maybe' shouldn't be allowed." : "如果使用了投票限制，那么“也许”不应该被允许。",
    "Anonymous poll" : "匿名投票",
    ...
    "Switch to mobile view" : "切换到移动视图",
    "Switch to desktop view" : "切换到桌面视图",
    "Date order" : "日期顺序",
    "Original order" : "初始顺序",
    "Ranked order" : "排名顺序",
    "Minute" : "分钟",
