OC.L10N.register(
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "你从 {pollTitle} 投票中删除了 {optionTitle} 选项",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor} 从 {pollTitle} 投票中删除了 {optionTitle} 选项",
    ...
    "{sharee} has changed his email address" : "{sharee} 已更改其电子邮件地址",
    ...
    "{actor} has did something indescribable with poll {pollTitle}" : "{actor} 对 {pollTitle} 投票做了莫名其妙的事情",
    ...
    "You have removed option {optionTitle}" : "你删除了 {optionTitle} 选项",
    "{actor} has removed option {optionTitle}" : "{actor} 删除了 {optionTitle} 选项",
    ...
    "{sharee}'s email address has been changed" : "{sharee} 的电邮地址已更改",
    ...
    "You have deleted {sharee}'s share" : "你删除了 {sharee} 的分享",
