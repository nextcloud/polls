OC.L10N.register(
    ...
    "Adding proposals ends {timeRelative}." : "添加提议结束 {timeRelative}",
    "Adding proposals ended {timeRelative}." : "添加提议结束于 {timeRelative}",
    "Clone option" : "复制选项",
    ...
    "Option proposals allowed" : "已允许选项提案",
    "Option proposal term ends {timeRelative}" : "选项提案期限结束 {timeRelative}",
    "Option proposal term ended {timeRelative}" : "选项提案期限结束于 {timeRelative} ",
    ...
    "_%n yes vote_::_%n yes votes_" : ["%n 赞成票"],
