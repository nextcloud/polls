OC.L10N.register(
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "添加 URL 参数 'name=' and/or 'email=' 到预定义名称和电子邮件地址。样例：https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org",
