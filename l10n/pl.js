OC.L10N.register(
    ...
    "Participants names are hidden, because this is an anoymous poll" : "Nazwy uczestników są ukryte, ponieważ jest to anonimowa sonda.",
    "The names of other participants is hidden, as this is a anonymous poll. " : "Nazwy innych uczestników są ukryte, ponieważ jest to anonimowa sonda.",
    "%n voters participated in this poll until now." : "%n głosujących uczestniczyło w tej sondzie do tej pory.",
    "Deleted" : "Usunięto",
    "Group" : "Grupa",
    ...
    "Voting is no more possible, because this poll expired since %n" : "Głosowanie nie jest już możliwe, ponieważ sonda wygasła od %n.",
