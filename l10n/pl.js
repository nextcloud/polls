OC.L10N.register(
    ...
    "A user" : "Użytkownik",
    "%s has voted." : "%s głosował.",
    "Updated poll configuration. Please check your votes." : "Zaktualizowano konfigurację sondy. Sprawdź swoje głosy.",
    "The poll has been deleted." : "Sonda została usunięta.",
    "The poll has been restored." : "Sonda została przywrócona.",
    "The poll has been closed." : "Sonda została zamknięta.",
    ...
    "The poll owner has been changed." : "Zmieniono właściciela sondy.",
    ...
    "You commented poll {pollTitle}" : "Skomentowałeś w sondzie {pollTitle}",
    "{actor} commented poll {pollTitle}" : "{actor} skomentował w sondzie {pollTitle}",
    "You deleted a commented from poll {pollTitle}" : "Usunąłeś komentarz z sondy {pollTitle}",
    "{actor} deleted a commented from poll {pollTitle}" : "{actor} usunął komentarz z sondy {pollTitle}",
    "You added an option to poll {pollTitle}" : "Dodano opcję sondy {pollTitle}",
    "{actor} added an option to poll {pollTitle}" : "{actor} dodał opcję sondy {pollTitle}",
    "You changed an option of poll {pollTitle}" : "Zmieniłeś opcję sondy {pollTitle}",
    "{actor} changed an option of poll {pollTitle}" : "{actor} zmienił opcję sondy {pollTitle}",
    "You confirmed option {optionTitle} of poll {pollTitle}" : "Potwierdziłeś opcję {optionTitle} sondy {pollTitle}",
    "{actor} confirmed option {optionTitle} of poll {pollTitle}" : "{actor} potwierdził opcję {optionTitle} sondy {pollTitle}",
    "You unconfirmed option {optionTitle} of poll {pollTitle}" : "Nie potwierdziłeś opcji {optionTitle} sondy {pollTitle}",
    "{actor} unconfirmed option {optionTitle} of poll {pollTitle}" : "{actor} nie potwierdził opcji {optionTitle} sondy {pollTitle}",
    "You removed option {optionTitle} from poll {pollTitle}" : "Usunąłeś opcję {optionTitle} z sondy {pollTitle}",
    "{actor} removed option {optionTitle} from poll {pollTitle}" : "{actor} usunął opcję {optionTitle} z sondy {pollTitle}",
    "You added poll {pollTitle}" : "Dodałeś sondę {pollTitle}",
    "{actor} added poll {pollTitle}" : "{actor} dodał sondę {pollTitle}",
    "You changed the configuration of poll {pollTitle}" : "Zmieniłeś konfigurację sondy {pollTitle}",
    "{actor} changed the configuration of poll {pollTitle}" : "{actor} zmienił konfigurację sondy {pollTitle}",
    "You archived poll {pollTitle}" : "Zarchiwizowałeś sondę {pollTitle}",
    "{actor} archived poll {pollTitle}" : "{actor} zarchiwizował sondę {pollTitle}",
    "You restored poll {pollTitle}" : "Przywróciłeś sondę {pollTitle}",
    "{actor} restored poll {pollTitle}" : "{actor} przywrócił sondę {pollTitle}",
    "Poll {pollTitle} was closed" : "Sonda {pollTitle} została zamknięta",
    "You changed the owner of poll {pollTitle}" : "Zmieniłeś właściciela sondy {pollTitle}",
    "{actor} changed the owner of poll {pollTitle}" : "{actor} zmienił właściciela sondy {pollTitle}",
    "You reordered the options of poll {pollTitle}" : "Zmieniłeś kolejność opcji sondy {pollTitle}",
    "{actor} reordered the options of poll {pollTitle}" : "{actor} zmienił kolejność opcji sondy {pollTitle}",
    "You added a public share to poll {pollTitle}" : "Dodałeś udostępnienie publiczne do sondy {pollTitle}",
    "{actor} added a public share to poll {pollTitle}" : "{actor} dodał udostępnienie publiczne do sondy {pollTitle}",
    "You shared poll {pollTitle} with group {sharee}" : "Udostępniłeś sondę {pollTitle} grupie {sharee}",
    "{actor} You shared poll {pollTitle} with group {sharee}" : "{actor} udostępnił sondę {pollTitle} grupie {sharee}",
    "You shared poll {pollTitle} with circle {sharee}" : "Udostępniłeś sondę {pollTitle} kręgowi {sharee}",
    "{actor} shared poll {pollTitle} with circle {sharee}" : "{actor} udostępnił sondę {pollTitle} kręgowi {sharee}",
    "You shared poll {pollTitle} with contact group {sharee}" : "Udostępniłeś sondę {pollTitle} grupie kontaktów {sharee}",
    "{actor} shared poll {pollTitle} with contact group {sharee}" : "{actor} udostępnił sondę {pollTitle} grupie kontaktów {sharee}",
    "You shared poll {pollTitle} with {sharee}" : "Udostępniłeś sondę {pollTitle} z {sharee}",
    "{actor} shared poll {pollTitle} with {sharee}" : "{actor} udostępnił sondę {pollTitle} z {sharee}",
    "You changed your email address" : "Zmieniłeś swój adres e-mail",
    "{actor} changed his email address" : "{actor} zmienił swój adres e-mail",
    "You changed the share type" : "Zmieniłeś typ udostępnienia",
    "{actor} changed the share type" : "{actor} zmienił typ udostępnienia",
    "You changed the registration constraints for share {sharee}" : "Zmieniłeś ograniczenia rejestracji dla udostępnienia {sharee}",
    "{actor} changed the registration constraints for share {sharee}" : "{actor} zmienił ograniczenia rejestracji dla udostępnienia {sharee}",
    "You registered to poll {pollTitle}" : "Zarejestrowałeś się do sondy {pollTitle}",
    "{sharee} registered to poll {pollTitle}" : "{sharee} zarejestrował się do sondy {pollTitle}",
    "You deleted a public share from poll {pollTitle}" : "Usunąłeś udostępnienie publiczne z sondy {pollTitle}",
    "{actor} deleted a public share from poll {pollTitle}" : "{actor} usunął udostępnienie publiczne z sondy {pollTitle}",
    "You deleted the share for group {sharee} from poll {pollTitle}" : "Usunąłeś udostępnienie dla grupy {sharee} z sondy {pollTitle}",
    "{actor} deleted the share for group {sharee} from poll {pollTitle}" : "{actor} usunął udostępnienie dla grupy {sharee} z sondy {pollTitle}",
    "You deleted the share for {sharee} from poll {pollTitle}" : "Usunąłeś udostępnienie dla {sharee} z sondy {pollTitle}",
    "{actor} deleted the share for {sharee} from poll {pollTitle}" : "{actor} usunął udostępnienie dla {sharee} z sondy {pollTitle}",
    "You deleted the share for circle {sharee} from poll {pollTitle}" : "Usunąłeś udostępnienie dla kręgu {sharee} z sondy {pollTitle}",
    "{actor} deleted the share for circle {sharee} from poll {pollTitle}" : "{actor} usunął udostępnienie dla kręgu {sharee} z sondy {pollTitle}",
    "You deleted the share for contact group {sharee} from poll {pollTitle}" : "Usunąłeś udostępnienie dla grupy kontaktów {sharee} z sondy {pollTitle}",
    "{actor} deleted the share for contact group {sharee} from poll {pollTitle}" : "{actor} usunął udostępnienie dla grupy kontaktów {sharee} z sondy {pollTitle}",
    "You deleted a share from poll {pollTitle}" : "Usunąłeś udostępnienie z sondy {pollTitle}",
    "{actor} deleted a share from poll {pollTitle}" : "{actor} usunął udostępnienie z sondy {pollTitle}",
    "You voted in poll {pollTitle}" : "Zagłosowałeś w sondzie {pollTitle}",
    "{actor} voted in poll {pollTitle}" : "{actor} zagłosował w sondzie {pollTitle}",
    "You did something indescribable with poll {pollTitle}" : "Zrobiłeś coś nie do opisania z sondą {pollTitle}",
    "{actor} did something indescribable with poll {pollTitle}" : "{actor} zrobił coś nie do opisania z sondą {pollTitle}",
    "You commented" : "Skomentowałeś",
    "{actor} commented" : "{actor} skomentował",
    "You deleted a commented" : "Usunąłeś komentarz",
    "{actor} deleted a commented" : "{actor} usunął komentarz",
    "You added an option" : "Dodałeś opcję",
    "{actor} added an option" : "{actor} dodał opcję",
    "You changed an option" : "Zmieniłeś opcję",
    "{actor} changed an option" : "{actor} zmienił opcję",
    "You confirmed option {optionTitle}" : "Potwierdziłeś opcję {optionTitle}",
    "{actor} confirmed option {optionTitle}" : "{actor} potwierdził opcję {optionTitle}",
    "You unconfirmed option {optionTitle}" : "Nie potwierdziłeś opcji {optionTitle}",
    "{actor} unconfirmed option {optionTitle}" : "{actor} nie potwierdził opcji {optionTitle}",
    "You removed option {optionTitle}" : "Usunąłeś opcję {optionTitle}",
    "{actor} removed option {optionTitle}" : "{actor} usunął opcję {optionTitle}",
    "You created this poll" : "Utworzyłeś tę sondę",
    "{actor} created this poll" : "{actor} utworzył tę sondę",
    "You changed the configuration" : "Zmieniłeś konfigurację",
    "{actor} changed the configuration" : "{actor} zmienił konfigurację",
    "You archived this poll" : "Zarchiwizowałeś tę sondę",
    "{actor} archived this poll" : "{actor} zarchiwizował tę sondę",
    "You restored this poll" : "Przywróciłeś tę sondę",
    "{actor} restored this poll" : "{actor} przywrócił tę sondę",
    "This poll was closed" : "Ta sonda została zamknięta",
    "You changed the poll owner" : "Zmieniłeś właściciela sondy",
    "{actor} changed the poll owner" : "{actor} zmienił właściciela sondy",
    "You reordered the options" : "Zmieniłeś kolejność opcji",
    "{actor} reordered the options" : "{actor} zmienił kolejność opcji",
    "You added a public share" : "Dodałeś udostępnienie publiczne",
    "{actor} added a public share" : "{actor} dodał udostępnienie publiczne",
    "You shared this poll with group {sharee}" : "Udostępniłeś tę sondę grupie {sharee}",
    "{actor} You shared this poll with group {sharee}" : "{actor} udostępnił tę sondę grupie {sharee}",
    "You shared this poll with circle {sharee}" : "Udostępniłeś tę sondę kręgowi {sharee}",
    "{actor} shared this poll with circle {sharee}" : "{actor} udostępnił tę sondę kręgowi {sharee}",
    "You shared this poll with contact group {sharee}" : "Udostępniłeś tę sondę grupie kontaktów {sharee}",
    "{actor} shared this poll with contact group {sharee}" : "{actor} udostępnił tę sondę grupie kontaktów {sharee}",
    "You shared this poll with {sharee}" : "Udostępniłeś tę sondę {sharee}",
    "{actor} shared this poll with {sharee}" : "{actor} udostępnił tę sondę {sharee}",
    "{actor}'s email address was changed" : "Adres e-mail {actor} został zmieniony",
    "You registered" : "Zarejestrowałeś się",
    "{sharee} registered" : "{sharee} zarejestrował się",
    "You deleted a public share" : "Usunąłeś udostępnienie publiczne",
    "{actor} deleted a public share" : "{actor} usunął udostępnienie publiczne",
    "You deleted the share for group {sharee}" : "Usunąłeś udostępnienie dla grupy {sharee}",
    "{actor} deleted the share for group {sharee}" : "{actor} usunął udostępnienie dla grupy {sharee}",
    "You deleted the share for circle {sharee}" : "Usunąłeś udostępnienie dla kręgu {sharee}",
    "{actor} deleted the share for circle {sharee}" : "{actor} usunął udostępnienie dla kręgu {sharee}",
    "You deleted the share for contact group {sharee}" : "Usunąłeś udostępnienie dla grupy kontaktów {sharee}",
    "{actor} deleted the share for contact group {sharee}" : "{actor} usunął udostępnienie dla grupy kontaktów {sharee}",
    "You deleted {sharee}'s share" : "Usunąłeś udostępnienie {sharee}",
    "{actor} deleted a share" : "{actor} usunął udostępnienie",
    "You voted" : "Zagłosowałeś",
    "{actor} voted" : "{aktor} zagłosował",
    "You did something indescribable with this poll" : "Zrobiłeś coś nie do opisania z tą sondą",
    "{actor} did something indescribable with this poll" : "{actor} zrobił coś nie do opisania z tą sondą",
    "Events happening inside of a <strong>poll</strong>" : "Wydarzenia dziejące się w <strong>sondzie</strong>",
    "Someone votes inside a <strong>poll</strong>" : "Ktoś zagłosował w <strong>sondzie</strong>",
    ...
    "For polls with expiration:" : "Dla sond z wygaśnięciem:",
    ...
    "48 hours before the first date option, if the poll is created more than 5 days before the first date option." : "48 godzin przed pierwszą opcją daty, jeśli sonda została utworzona więcej niż 5 dni przed opcją pierwszej daty.",
    "36 hours before the first date option, if the poll is created more than 2 and less than 5 days before the first date option." : "36 godzin przed pierwszą opcją daty, jeśli sonda została utworzona więcej niż 2 i mniej niż 5 dni przed opcją pierwszej daty.",
    ...
    "Limit \"Yes\" votes per user" : "Ogranicz głosy \"Tak\" na użytkownika",
    "Title" : "Tytuł",
    ...
    "Propose a date" : "Zaproponuj datę",
    ...
    "Proposals are allowed" : "Propozycje są dozwolone",
    ...
    "No proposals are allowed" : "Propozycje nie są dozwolone",
    ...
    "A poll from {name}" : "Sonda od {name}",
    "Currently no users have access to this poll" : "Obecnie żaden użytkownik nie ma dostępu do tej sondy",
    ...
    "Archive closed polls automatically" : "Archiwizuj zamknięte sondy automatycznie",
    "After how many days are the closed polls to be archived:" : "Po ilu dniach zamknięte sondy mają zostać zarchiwizowane:",
    ...
    "Activate long polling for instant updates" : "Aktywuj długie odpytywanie, aby uzyskać natychmiastowe aktualizacje",
    "Activate periodic polling of updates from the client" : "Aktywuj okresowe odpytywanie aktualizacji od klienta",
    "Disable automatic updates (reload app for updates)" : "Wyłącz automatyczne aktualizacje (przeładuj aplikację, aby uzyskać aktualizacje)",
    "Disallow poll creation for all users" : "Nie zezwalaj na tworzenie sondy dla wszystkich użytkowników",
    "Allow poll creation for the following groups" : "Zezwalaj na tworzenie sondy dla następujących grup",
    "Leave empty to disallow for all." : "Pozostaw puste, aby zabronić wszystkim.",
    ...
    "Use background color" : "Użyj koloru tła",
    ...
    "Withdraw poll admin access" : "Cofnij dostęp administratorowi do sondy",
    ...
    "Do not ask for email address" : "Nie pytaj o adres e-mail",
    ...
    "Is granted admin rights for this poll" : "Udziel uprawnienia administratora do tej sondy",
    "Add a new public link" : "Dodaj nowy link publiczny",
    "Token: {token}" : "Token: {token}",
    "Access for all users of this site is disabled" : "Dostęp dla wszystkich użytkowników tej witryny jest wyłączony",
    "Access for all users of this site is enabled" : "Dostęp dla wszystkich użytkowników tej witryny jest włączony",
    ...
    "Your votes are reset" : "Twoje głosy zostały zresetowane",
    "Error while resetting votes" : "Błąd podczas resetowania głosów",
