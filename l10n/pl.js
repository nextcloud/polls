OC.L10N.register(
    ...
    "{actor} has did something indescribable with poll {pollTitle}" : "{actor} zrobił coś nie do opisania z sondą {pollTitle}",
    ...
    "{sharee}'s email address has been changed" : "Adres e-mail {sharee} został zmieniony",
    ...
    "You have deleted {sharee}'s share" : "Usunąłeś udostępnienie {sharee}",
