OC.L10N.register(
    ...
    "_You have only one vote left._::_You have %n votes left._" : ["Został Tobie tylko jeden głos.","Pozostały Tobie %n głosy.","Pozostało Tobie %n głosów.","Pozostało Tobie %n głosów."],
    "_This is an exclusive vote, where only one user is allowed to vote for an option._::_Only %n votes per option are permitted._" : ["Jest to głosowanie na wyłączność, w którym tylko jeden użytkownik może głosować na opcję.","Jest to głosowanie na wyłączność, w którym tylko jeden użytkownik może głosować na opcję.","Jest to głosowanie na wyłączność, w którym tylko jeden użytkownik może głosować na opcję.","Dozwolonych jest tylko %n głosów na opcję."],
    ...
    "If vote limits are used, \"maybe\" should be not be allowed." : "Jeśli używane są limity głosów, \"może\" nie powinno być dozwolone.",
