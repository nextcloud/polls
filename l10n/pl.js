OC.L10N.register(
    ...
    "_This is an exclusive vote, where only one user is allowed to vote for an option._::_Only %n votes per option are permitted._" : ["Jest to głosowanie na wyłączność, w którym tylko jeden użytkownik może głosować na opcję.","Dozwolone są tylko %n głosy na opcję.","Dozwolonych jest tylko %n głosów na opcję.","Dozwolonych jest tylko %n głosów na opcję."],
