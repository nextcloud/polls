OC.L10N.register(
    ...
    "This are your polls (where you are the owner)." : "To są Twoje sondy (gdzie jesteś właścicielem).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "To są wszystkie sondy, które są dla Ciebie istotne lub ważne, ponieważ jesteś uczestnikiem, właścicielem lub zostałeś zaproszony. Bez wygasłych sond.",
    ...
    "These are all hidden polls, to which you have access." : "Są to wszystkie ukryte sondy, do których masz dostęp.",
    "This is simply the trash bin." : "To jest po prostu kosz na śmieci.",
