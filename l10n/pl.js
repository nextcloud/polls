OC.L10N.register(
    ...
    "started this poll on {dateString}." : "rozpoczął sondę w {dateString}.",
    ...
    "Your are only allowed to vote for one option." : "Możesz głosować tylko na jedną opcję.",
    "You reached the maximum number of allowed votes." : "Osiągnąłeś maksymalną liczbę głosów.",
    "You have only one vote left." : "Został Tobie tylko jeden głos.",
    "This is an exclusive vote, where only one user is allowed to vote for an option." : "Jest to głosowanie na wyłączność, w którym tylko jeden użytkownik może głosować na opcję.",
    "_You have %n vote left._::_You have %n votes left._" : ["Został Tobie %n głos.","Zostały Tobie %n głosy.","Pozostało Tobie %n głosów.","Pozostało Tobie %n głosów."],
    ...
    "Do you want to login?" : "Chcesz się zalogować?",
    "Login" : "Zaloguj",
    "Participate in public poll!" : "Weź udział w sondzie publicznej!",
    ...
    "never" : "nigdy",
    "Beta - watch for updated polls in realtime" : "Beta - obserwuj zaktualizowane sondy w czasie rzeczywistym",
    "All changes to the current poll, done by other users, will be recognized in realtime." : "Wszystkie zmiany w bieżącej sondzie, wprowadzone przez innych użytkowników, zostaną uznane w czasie rzeczywistym.",
    ...
    "Allow 'maybe' vote" : "Zezwól na głosowanie 'może'",
