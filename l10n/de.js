OC.L10N.register(
    ...
    "{user} invited you to take part in the poll \"{title}\"" : "{user} hat dich eingeladen, um an der Umfrage \"{title}\" teilzunehmen",
    ...
    "This user name can not be chosen." : "Dieser Benutzername kann nicht gewählt werden.",
