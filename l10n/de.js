OC.L10N.register(
    ...
    "{actor} took over your poll \"%s\" and is the new owner." : "\"%s\"  hat Deine Umfrage übernommen",
    ...
    "Proposal closing date" : "Vorschlag für den Endetermin der Umfrage",
    ...
    "Delete vote when switched to \"no\"" : "Lösche die Stimme, wenn zu \"nein\" gewechselt wird.",
    ...
    "Add new date option" : "Datumsoption hinzufügen",
    ...
    "Add new text option" : "Textoption hinzufügen",
    ...
    "Option proposal term ends {timeRelative}" : "Die Vorschlagsfrist endet {timeRelative}.",
    "Option proposal term ended {timeRelative}" : "Die Vorschlagsfrist endete {timeRelative}.",
    ...
    "Name must be at least 3 characters." : "Der Name muss mindestens drei Buchstaben lang sein.",
