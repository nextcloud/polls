OC.L10N.register(
    ...
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Standardmäßig werden die in der Design-App konfigurierten Links verwendet. Für öffentliche Umfragen können diese durch individuelle Nutzungsbedingungen überschrieben werden.",
    ...
    "Allow creating open polls for the following groups" : "Erstellen von offenen Umfragen für folgende Gruppen erlauben",
    ...
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Die Standardlinks Deiner Website mit Deinen Nutzungsbedingungen überschreiben. Leer lassen, um die Links zu verwenden, die in der Design-App konfiguriert sind.",
    ...
    "A complete list with all open polls on this site, regardless who is the owner." : "Eine vollständige Liste mit allen offenen Umfragen, unabhängig vom Inhaber.",
