OC.L10N.register(
    ...
    "Confirmation sent to {participant} ({emailAddress})" : "Confirmation sent to {participant} ({emailAddress})",
    "Confirmation could not be sent to {participant} ({emailAddress})" : "Confirmation could not be sent to {participant} ({emailAddress})",
    "_Confirmations sent to {count} recipient_::_Confirmations sent to {count} recipients_" : ["Confirmations sent to {count} recipient","Confirmations sent to {count} recipients"],
    ...
    "Styles" : "Styles",
    "User is only able to see the votes." : "User is only able to see the votes.",
    "Has voted" : "Has voted",
    ...
    "Re-Revoke share" : "Re-Revoke share",
    "Delete share and remove user from poll" : "Delete share and remove user from poll",
    "Revoke share" : "Revoke share",
    "Delete share" : "Delete share",
    "Deleted share and votes for {displayName}" : "Deleted share and votes for {displayName}",
    "Share for user {displayName} revoked" : "Share for user {displayName} revoked",
    "Deleted share for user {displayName}" : "Deleted share for user {displayName}",
    "Error deleting or revoking share for user {displayName}" : "Error deleting or revoking share for user {displayName}",
