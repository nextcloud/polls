OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below.",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "You have shared poll {pollTitle} with team {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} has shared poll {pollTitle} with team {sharee}",
    "You have shared this poll with team {sharee}" : "You have shared this poll with team {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} has shared this poll with team {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "You have deleted the share for team {sharee} from poll {pollTitle}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} has deleted the share for team {sharee} from poll {pollTitle}",
    "You have deleted the share for team {sharee}" : "You have deleted the share for team {sharee}",
    "{actor} has deleted the share for team {sharee}" : "{actor} has deleted the share for team {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "You have restored the share for team {sharee} from poll {pollTitle}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} has restored the share for team {sharee} from poll {pollTitle}",
    "You have restored the share for team {sharee}" : "You have restored the share for team {sharee}",
    "{actor} has restored the share for team {sharee}" : "{actor} has restored the share for team {sharee}",
    ...
    "Select timezone to apply" : "Select time zone to apply",
    "Use original timezone ({pollTimezone})" : "Use original time zone ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Use your time zone ({localTimezone})",
    ...
    "Allow download of poll results" : "Allow download of poll results",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "This will irreversibly delete the poll and {username} will get notified.",
    "This will irreversibly delete the poll." : "This will irreversibly delete the poll.",
    "OK" : "OK",
    ...
    "Closing: {dateTime}" : "Closing: {dateTime}",
    "Closing: {dateRelative}" : "Closing: {dateRelative}",
    "Current timezone: {timezoneString}" : "Current time zone: {timezoneString}",
    "Original timezone: {timezoneString}" : "Original time zone: {timezoneString}",
    ...
    "Last activity {dateTime}" : "Last activity {dateTime}",
    "No access" : "No access",
    ...
    "Open poll, accessible to all users of this instance and invited participants" : "Open poll, accessible to all users of this instance and invited participants",
    ...
    "Register to this poll" : "Register to this poll",
    ...
    "Days after which archived polls should be permanently deleted" : "Days after which archived polls should be permanently deleted",
    ...
    "Sends out pending automatic reminders." : "Sends out pending automatic reminders.",
    "Cleans up old or irrelevant data from the system to maintain optimal performance and organization." : "Cleans up old or irrelevant data from the system to maintain optimal performance and organisation.",
    "Sends out pending notifications about poll updates." : "Sends out pending notifications about poll updates.",
    ...
    "This job has never been run yet." : "This job has never been run yet.",
    "{jobName} has been executed." : "{jobName} has been executed.",
    "Start {jobName} manually." : "Start {jobName} manually.",
    "{jobName} does not support manually run." : "{jobName} does not support manually run.",
    "Request Execution" : "Request Execution",
    "Request job execution" : "Request job execution",
    ...
    "Use the default terms for public polls" : "Use the default terms for public polls",
    ...
    "Error sending invitations" : "Error sending invitations",
    ...
    "Forced display mode" : "Forced display mode",
    "Set default timezone for this poll" : "Set default time zone for this poll",
    ...
    "Your timezone: ({timezone})" : "Your time zone: ({timezone})",
    "Poll timezone: ({timezone})" : "Poll time zone: ({timezone})",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Or [link]login[/link] if you are a member of this site.",
