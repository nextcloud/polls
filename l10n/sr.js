OC.L10N.register(
    ...
    "This link gives you personal access to the poll named above. </br> Press the button above or copy the following link and add it in your browser's location bar: " : "Ова веза Вам даје лични приступ гласању наведеном изнад. </br> Притисните дугме изнад или копирајте следећу везу и додајте је на траку адреса у веб читачу:",
    ...
    "- %s voted." : "- %s гласао/ла.",
    "- %s updated the poll configuration. Please check your votes." : "- %s је ажурирао/ла конфигурацију гласања. Проверите Ваше гласове.",
    "- %s deleted the poll." : "- %s обрисао/ла гласање.",
    "- %s restored the poll." : "- %s повратио/ла гласање.",
    "- The poll expired." : "- Гласање истекло.",
    ...
    "_%n person participated in this poll until now._::_%n persons participated in this poll until now._" : ["%n особа је до сада учествовала у гласању.","%n особе су до сада учествовале у гласању.","%n особа је до сада учествовало у гласању."],
    ...
    "Voting is no more possible, because this poll expired since %n." : "Гласање више није могуће, пошто је истекло од %n",
    "Comments" : "Коментари",
    ...
    "Restore poll as admin" : "Поврати гласање као администратор",
    "Restore poll" : "Поврати гласање",
    "Delete poll permanently as admin" : "Обриши гласање заувек као администратор",
    ...
    "To participate, you need to enter a valid username with at least 3 characters." : "Да бисте учествовали, морате унети исправно корисничко име са бар 3 карактера.",
    "Enter your name" : "Унесите Ваше име",
    "Username is not valid. Please enter at least 3 characters." : "Корисничко име није исправно. Унесите бар 3 карактера.",
    "This username is not valid, i.e. because it is already in use." : "Ово корисничко име није исправно, нпр. зато што је већ у употреби.",
    ...
    "This are your polls (where you are the owner)." : "Ово су Ваша гласања (где сте Ви власник).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Ово су сва гласања која су Вам релевантна или битна, зато што сте или учесник или власник или сте позвани на гласање. Без истеклих гласања.",
    ...
    "These are all hidden polls, to which you have access." : "Ово су скривена гласања, којима имате приступ.",
    "This is simply the trash bin." : "Ово је просто канта за ђубре.",
    ...
    "Switch view" : "Промени приказ",
    "Toggle Sidebar" : "Укључи/искључи бочну траку",
    "Deleted" : "Обрисано",
    "There are no vote options, add some in the options section of the right side bar." : "Нема опција за гласање, додајте неку у одељку опција у траци са десне стране.",
