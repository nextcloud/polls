OC.L10N.register(
    ...
    "Description" : "Опис",
    "Owner" : "Власник",
    "Configuration is locked. Changing options may result in unwanted behaviour, but you can unlock it anyway." : "Конфигурација је закључана. Промена опција може да заврши са нежељеним понашањем, али свеједно је можете откључати.",
