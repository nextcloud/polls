OC.L10N.register(
    ...
    "{user} invited you to take part in the poll \"{title}\"" : "{user} Вас је позвао да учествујете у гласању „{title}“",
    ...
    "textPoll" : "текстуално гласање",
    "datePoll" : "гласање за датуме",
    ...
    "Details" : "Детаљи",
    "Comments" : "Коментари",
    "Date options" : "Опције датума",
    "Text options" : "Опције текста",
    ...
    "No expiration date set" : "Нема постављеног датума истека",
    "Enter a valid username, to participate in this poll." : "Унесите исправно корисничко име, да бисте учествовали у овом гласању.",
