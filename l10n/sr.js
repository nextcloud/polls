OC.L10N.register(
    ...
    "Preview" : "Претпреглед",
    "_%n repetition until_::_%n repetitions until_" : ["%n понављање до","%n понављања до","%n понављања до"],
    ...
    "Error loading polls list for admins" : "Грешка приликом учитавања листе гласања за админе",
