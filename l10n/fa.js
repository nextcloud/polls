OC.L10N.register(
    ...
    "This email is sent to you, because you are invited to vote in this poll by the poll owner." : "این ایمیل برای شما ارسال شده است ، زیرا از طرف صاحب نظرسنجی برای رای گیری در این نظرسنجی دعوت شده اید.",
    ...
    "Deleted" : "حذف شده",
    "Group" : "گروه",
    "Place your votes until %n" : "آرای خود را تا زمان %n",
    "New comment …" : "توضیح جدید ...",
    "Your comment was added" : "توضیح شما اضافه شد",
    "Expired since %n" : "منقضی شده است %n",
    "Error while saving comment" : "هنگام ذخیره توضیح خطایی رخ داد",
    "You can place your vote until %n. " : "شما می توانید رأی خود را تا زمانی تنظیم کنید%n. ",
    "Comments" : "نظرات",
    "Delete comment" : "حذف توضیح",
    "No comments yet. Be the first." : "هنوز نظری ارائه نشده است اولین نفر باشید",
    "Comment deleted" : "توضیح حذف",
    "Voting is no more possible, because this poll expired since %n." : "رای گیری دیگر امکان پذیر نیست ، زیرا این نظرسنجی از آن زمان منقضی شده است %n.",
    ...
    "Delete poll as admin" : "نظرسنجی را به عنوان مدیر حذف کنید",
    "Delete poll" : "نظرسنجی را حذف کنید",
    "Restore poll as admin" : "بازگرداندن نظرسنجی به عنوان مدیر",
    ...
    "Invitations" : "دعوت ها",
    "Invited users will get informed immediately via eMail!" : "کاربران دعوت شده بلافاصله از طریق e-mail مطلع می شوند!",
    ...
    "To participate, you need to enter a valid username with at least 3 characters. " : "برای مشارکت ، باید یک نام کاربری معتبر با حداقل 3 کاراکتر وارد کنید.",
    "Enter your name" : "اسمت را وارد کن",
    "Username is not valid. Please enter at least 3 characters." : "نام کاربری معتبر نیست لطفا حداقل 3 کاراکتر را وارد کنید.",
    "This username is not valid, i.e. because it is already in use." : "این نام کاربری معتبر نیست ، به این دلیل که قبلاً در حال استفاده است.",
    "OK" : "تایید",
