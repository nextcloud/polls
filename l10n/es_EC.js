OC.L10N.register(
    ...
    "Sent emails to:" : "Correos enviados a:",
    "Emails could not be sent:" : "Los correos no se pudieron enviar:",
    "Send information about confirmed options by email" : "Enviar información sobre opciones confirmadas por correo electrónico",
    "Inform your participants about the confirmed options" : "Informar a tus participantes sobre las opciones confirmadas",
    "Confirmations processed" : "Confirmaciones procesadas",
    "Confirmation sent to ${confirmation}" : "Confirmación enviada a ${confirmation}",
    "Confirmation could not be sent to ${confirmation}" : "Confirmación no pudo ser enviada a ${confirmation}",
    ...
    "Limit \"Yes\" votes per user" : "Límite de votos \"Sí\" por usuario",
    "Title" : "Título",
    ...
    "Shifting dates is disabled to prevent shifting of other user's proposals." : "La modificación de fechas está desactivada para evitar cambios en las propuestas de otros usuarios.",
    "Submit" : "Enviar",
    ...
    "Invite users via the share tab in the sidebar" : "Invita a usuarios a través de la pestaña \"Compartir\" en la barra lateral",
    ...
    "Openly accessible and relevant poll" : "Encuesta de acceso público y relevante",
    ...
    "As a regular user of this site, you can participate with your internal identity after logging in." : "Como usuario regular de este sitio, puedes participar con tu identidad interna después de iniciar sesión.",
    "Otherwise participate as a guest user." : "De lo contrario, participa como usuario invitado.",
    ...
    "Deactivate combo view for all users" : "Desactivar vista combinada para todos los usuarios",
    "Allow combo view for the following groups" : "Permitir vista combinada para los siguientes grupos",
    "Leave empty to disallow for all." : "Dejar vacío para desactivar para todos.",
    ...
    "Hide email addresses of internal users" : "Ocultar direcciones de correo electrónico de los usuarios internos",
    "Show email addresses of internal users to members of the following groups" : "Mostrar direcciones de correo electrónico de los usuarios internos a los miembros de los siguientes grupos",
    "The privacy link and the legal notice link are automatically added to the registration dialog of public polls." : "El enlace de privacidad y el enlace de aviso legal se agregan automáticamente al diálogo de registro de las encuestas públicas.",
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Por defecto se utilizan los enlaces configurados en la aplicación de personalización. Para encuestas públicas, estos pueden ser reemplazados por términos individuales.",
    ...
    "Track activities" : "Seguir actividades",
    "Hide login option in public polls" : "Ocultar opción de inicio de sesión en encuestas públicas",
    "Archive closed polls automatically" : "Archivar encuestas cerradas automáticamente",
    "After how many days are closed polls to be archived:" : "Después de cuántos días se archivarán las encuestas cerradas:",
    "Activate long polling for instant updates" : "Activar encuesta larga para actualizaciones instantáneas",
    "Activate periodic polling of updates from the client" : "Activar encuesta periódica de actualizaciones desde el cliente",
    "Disable automatic updates (reload app for updates)" : "Deshabilitar actualizaciones automáticas (recargar la aplicación para obtener actualizaciones)",
    "Disallow poll creation for all users" : "Prohibir la creación de encuestas para todos los usuarios",
    "Allow poll creation for the following groups" : "Permitir la creación de encuestas para los siguientes grupos",
    "Disallow poll download" : "Prohibir la descarga de encuestas",
    "Allow poll download for the following groups" : "Permitir la descarga de encuestas para los siguientes grupos",
    "Disallow public shares" : "Prohibir intercambios públicos",
    "Allow public shares for the following groups" : "Permitir intercambios públicos para los siguientes grupos",
    "Disallow openly accessible polls" : "Prohibir encuestas de acceso abierto",
    "Allow creating openly accessible polls for the following groups" : "Permitir la creación de encuestas de acceso abierto para los siguientes grupos",
    ...
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Si este umbral se supera, solo se mostrará el usuario actual para evitar un colapso del rendimiento.",
    ...
    "Share restrictions" : "Restricciones de compartición",
    "Restrict the share actions globally or on a group base" : "Restringe las acciones de compartición de forma global o basada en grupos",
    "Poll creation restrictions" : "Restricciones de creación de encuestas",
    "Restrict the creation of new polls globally or on a group base" : "Restringe la creación de nuevas encuestas de forma global o basada en grupos",
    "Legal terms for public poll registration" : "Términos legales para el registro público de la encuesta",
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Sobrescribe los enlaces predeterminados de tu sitio con tus términos legales. Deja vacío para usar los enlaces que están configurados en la aplicación de tematización.",
    ...
    "Activate or disable individual features." : "Activa o desactiva características individuales.",
    ...
    "Manage polls of other users. You can take over the ownership or delete polls." : "Gestiona encuestas de otros usuarios. Puedes tomar el control o eliminar encuestas.",
    ...
    "Polls user settings" : "Configuraciones de usuario de encuestas",
    ...
    "Allow proposals" : "Permitir propuestas",
    "Relevant" : "Relevante",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Todas las encuestas que son relevantes o importantes para ti, porque eres un participante, el propietario o has sido invitado.",
