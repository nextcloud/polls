OC.L10N.register(
    ...
    "This link gives you personal access to the poll named above. </br> Press the button above or copy the following link and add it in your browser's location bar: " : "Эта ссылка предоставляет индивидуальный в вход для участия в опросе, указанном выше. </br> Нажмите на кнопку, расположенную выше или откройте в браузере следующую ссылку:",
    ...
    "_%n person participated in this poll until now._::_%n persons participated in this poll until now._" : ["На данный момент проголосовал %n участник.","На данный момент проголосовали %n участника.","На данный момент проголосовали %n участников.","На данный момент проголосовали %n участника."],
    "New comment …" : "Текст комментария…",
    "Your comment was added" : "Комментарий добавлен",
    "You can place your vote until %n. " : "Проголосуйте до %n.",
    "Error while saving comment" : "При сохранении комментария произошла ошибка",
    "Voting is no more possible, because this poll expired since %n." : "Голоса более не принимаются, голосование завершилось %n.",
    ...
    "This are your polls (where you are the owner)." : "Это ваши опросы (где вы владелец).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Это все опросы, которые актуальны или важны для вас, потому что вы являетесь участником или владельцем или вас приглашают. Без истекших опросов.",
    ...
    "These are all hidden polls, to which you have access." : "Это все скрытые опросы, к которым у вас есть доступ.",
    "This is simply the trash bin." : "Это просто корзина.",
    ...
    "Place your votes until %n" : "Проголосуйте до %n",
    "Expired since %n" : "Завершён %n",
