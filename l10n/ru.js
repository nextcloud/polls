OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{sharee} изменил свой адрес электронной почты",
    ...
    "Public participation" : "Участвовать в общедоступных опросах",
    ...
    "You are a registered user of this site?" : "Вы зарегистрированы на этом сайте?",
    "Login" : "Вход",
    ...
    "Otherwise participate publicly." : "В противном случае будут доступны только общедоступные опросы.",
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Необходимо указать адрес электронной почты. Индивидуальная ссылка для прохождения опроса будет направлена в письме.",
    "With your email address you can subscribe to notifications and you will receive your personal link to this poll." : "С помощью адреса электронной почты вы можете подписаться на уведомления, затем вы получите персональную ссылку на этот опрос.",
