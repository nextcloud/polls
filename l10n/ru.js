OC.L10N.register(
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "Вы удалили вариант {optionTitle} из опроса {pollTitle}",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor} удалил опцию {optionTitle} из опроса {pollTitle}",
    "You have removed option {optionTitle}" : "Вы удалили опцию {optionTitle}",
    "{actor} has removed option {optionTitle}" : "{actor} удалил опцию {optionTitle}",
    ...
    "Send confirmation emails" : "Отправить письмо с подтверждением",
    "Sent emails to:" : "Отправил эл. письма на адрес:",
    "Emails could not be sent:" : "Не удалось отправить эл. письмо:",
    "Send information about confirmed options by email" : "Отправлять информацию о подтвержденных опциях по электронной почте",
    "Inform your participants about the confirmed options" : "Сообщите участникам о подтвержденных вариантах",
    "Confirmation sent to {participant} ({emailAddress})" : "Подтверждение отправлено пользователю {participant} ({emailAddress})",
    "Confirmation could not be sent to {participant} ({emailAddress})" : "Не удалось отправить подтверждение пользователю {participant} ({emailAddress})",
    ...
    "Limit \"Yes\" votes per user" : "Ограничить количество голосов \"За\" на одного пользователя",
    "Title" : "Название",
    ...
    "Shifting dates is disabled to prevent shifting of other user's proposals." : "Перенос дат отключен, чтобы предотвратить перенос заявок других пользователей.",
    ...
    "Login" : "Вход",
    "As a regular user of this site, you can participate with your internal identity after logging in." : "Если вы зарегистрированы на этом сайте, то после входа в систему вы можете участвовать в опросах под своим именем.",
    ...
    "Deactivate combo view for all users" : "Отключить комбинированный режим просмотра для всех",
    "Allow combo view for the following groups" : "Разрешить комбинированный режим просмотра участникам групп",
    "Leave empty to disallow for all." : "Чтобы запретить всем, оставьте поле пустым.",
    ...
    "Hide email addresses of internal users" : "Скрывать адреса эл. почты от внутренних пользователей",
    "Show email addresses of internal users to members of the following groups" : "Показывать адреса эл. почты участникам групп",
    "Track activities" : "Отслеживать события",
    "Hide login option in public polls" : "Скрывать параметры входа в общедоступных опросах",
    "Archive closed polls automatically" : "Архивировать закрытые опросы",
    "After how many days are closed polls to be archived:" : "Количество дней для перемещения закрытых опросов в архив:",
    "Activate long polling for instant updates" : "Включить длительный опрос для мгновенных обновлений",
    "Activate periodic polling of updates from the client" : "Включить периодический опрос обновлений от клиента",
    "Disable automatic updates (reload app for updates)" : "Отключить автоматические обновления (перезагрузить приложение для применения изменений)",
    "Disallow poll creation for all users" : "Запретить создание опросов",
    "Allow poll creation for the following groups" : "Разрешить создание опросов участникам групп",
    "Disallow poll download" : "Запретить скачивание опросов",
    "Allow poll download for the following groups" : "Разрешить скачивание опросов участникам групп",
    "Disallow public shares" : "Запретить создавать общедоступные ссылки",
    "Allow public shares for the following groups" : "Разрешить создавать общедоступные ссылки участникам групп",
    ...
    "Allow proposals from users" : "Разрешить пользователям вносить предложения",
    ...
    "Share restrictions" : "Ограничения публикации",
    "Poll creation restrictions" : "Ограничения создания опросов",
    "Restrict the creation of new polls globally or on a group base" : "Ограничить создание опросов глобально или на основе группы",
    ...
    "Manage polls of other users. You can take over the ownership or delete polls." : "Управляйте опросами других пользователей. Вы можете взять на себя управление опросами или удалить их.",
    ...
    "Polls user settings" : "Параметры голосований",
    ...
    "_%n of {maximalVotes} vote left._::_%n of {maximalVotes} votes left._" : ["%n из {maximalVotes} голосов.","%n из {maximalVotes} голосов.","%n из {maximalVotes} голосов.","%n из {maximalVotes} голосов."],
    "Minute" : "Минута",
    "Hour" : "Час",
    "Day" : "День",
    "Month" : "Месяц",
