OC.L10N.register(
    ...
    "{user} invited you to take part in the poll \"{title}\"" : "{user} vas vabi k izpolnjevanju ankete»{title}«.",
    ...
    "textPoll" : "besedilna anketa",
    "datePoll" : "datumska anketa",
