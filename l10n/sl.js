OC.L10N.register(
    ...
    "This is an anonymous poll. Except to the poll owner, participants names are hidden." : "To je anonimna anketa. Razen lastnika ankete, so vsa imena udeležencev skrita.",
    ...
    "Text polls default to list view" : "Besedilne ankete so privzeto prikazane v seznamskem pogledu",
    "Date polls default to list view" : "Datumske ankete so privzeto prikazane v seznamskem pogledu",
    "Try experimental styles" : "Uporabi preizkusne sloge",
    "Use background image" : "Uporabi sliko ozadja",
    "Glassy navigation" : "Stekleni krmilniki",
    "Glassy sidebar" : "Stekleno bočno okno",
    ...
    "Hide results until poll is expired" : "Skrij odzive, dokler anketa ne poteče",
    ...
    "There are no vote options specified." : "Ni določenih možnosti ankete.",
    ...
    "Resolve contact group into individual invitations" : "Razreši skupine v osebna vabila k izpolnjevanju",
    ...
    "Receive notification email on activity to {emailAddress}" : "Pošlji obvestilo o dejavnosti na anketi na elektronski naslov {emailAddress}",
    ...
    "No existing polls." : "Ni obstoječih anket.",
    ...
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Izpisane so ankete, ki so vam pomembne, saj ste jih ustvarili (ali vam je dodeljeno lastništvo) oziroma ste anketo že izpolnjevali. Potečenih anket ni na  seznamu.",
    ...
    "Polls which reached their expiry date." : "Ankete, ki so presegle datum veljave.",
    "All polls, where you have access to." : "Vse ankete, do katerih imate dostop",
    "Toggle Sidebar" : "Preklopi bočno okno",
    "Deleted" : "Izbrisano",
    "There are no vote options, add some in the options section of the right sidebar." : "Ni še dodanih vprašanj. Dodati jih je mogoče iz izbire v desnem bočnem oknu.",
    "There are no vote options. Maybe the owner did not provide some until now." : "Ni še dodanih možnosti. Morda jih avtor še ni uspel dodati.",
