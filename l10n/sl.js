OC.L10N.register(
    ...
    "never" : "nikoli",
    "Beta - watch for updated polls in realtime" : "Preizkusno – posodobitev anket spremljaj v stvarnem času",
    "All changes to the current poll, done by other users, will be recognized in realtime." : "Vse spremembe trenutne ankete, ki jih sproži katerikoli uporabnik, bodo posodobljene v stvarnem času.",
    ...
    "Add a background image to the main area." : "Sliko doda kot ozadjea glavnega polja ankete.",
    ...
    "The trash bin." : "Ankete, ki čakajo na dokončno odstranitev.",
