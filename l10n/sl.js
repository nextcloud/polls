OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{sharee} spremeni elektronski naslov",
    ...
    "A polls app, similar to Doodle/Dudle with the possibility to restrict access." : "Program Ankete (Polls), podoben spletnemu programu Doodle/Dudle z možnostjo omejevanja dostopa.",
    "A polls app, similar to Doodle/Dudle with the possibility to restrict access (members, certain groups/users, hidden and public)." : "Program Ankete (Polls), podoben spletnemu programu Doodle/Dudle z možnostjo omejevanja dostopa (za člane, skupine ali uporabnike, skrite ankete in javno zbiranje odziva).",
    ...
    "Openly accessible and relevant poll" : "Prosto dostopne in pomembne ankete",
    ...
    "By clicking the \"OK\" button you accept our {privacyPolicy}." : "S potrditvijo soglašate z določili {privacyPolicy}.",
    "privacy policy" : "zasebnosti",
    ...
    "Preview" : "Predogled",
    "The privacy link and the legal notice link are automatically added to the registration dialog of public polls." : "Povezavi do določil zasebnosti in pravnega obvestila sta samodejno dodani k prijavi za sodelovanje v javnih anketah.",
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Privzeto se uporabljajo povezave, nastavljene v programu za oblikovanje. Pri javnih anketah je mogoča razveljavitev posameznih pogojev.",
    ...
    "Track activities" : "Sledi dejavnosti",
    ...
    "After how many days are closed polls to be archived:" : "Po koliko dneh naj se zaprte ankete arhivirajo:",
    ...
    "Disallow openly accessible polls" : "Ne dovoli prosto dostopnih anket",
    "Allow creating openly accessible polls for the following groups" : "Dovoli ustvarjanje prosto dostopnih anket le navedenim skupinam",
    ...
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Če je prag presežen, bo za izogibanje motnjam v delovanju pokazan le trenutni uporabnik.",
    ...
    "Use background color" : "Uporabi barvo ozadja po meri",
    "Use background image" : "Uporabi novo sliko ozadja",
    "Enter the URL of your favorite background image." : "Vpis naslova URL priljubljene slike ozadja",
    "Dark picture" : "Temna slika",
    "Translucent foreground elements" : "Omogoči prosojnost predmetov v ospredju",
    "Add a translucent effect on foreground elements like sidebar and poll table (Does not work with all browsers)." : "Doda učinek prosojnosti za predmete v ospredju, kot so bočna vrstica, razpredelnica ankete in drugo (možnost ne deluje v vseh brskalnikih).",
    ...
    "Restrict the creation of new polls globally or on a group base" : "Omeji možnost ustvarjanja novih anket na splošni ravni oziroma na osnovi skupine",
    "Email options" : "Možnosti elektronske pošte",
    "Other settings" : "Druge nastavitve",
    "Administrative poll management" : "Skrbniško urejanje anket",
    "Manage polls of other users. You can take over the ownership or delete polls." : "Upravljanje anket drugih uporabnikov. Mogoče je prevzeti lastništvo anket oziroma jih izbrisati.",
    ...
    "Take over" : "Prevzemi",
    "Do you want to take over this poll?" : "Ali želite prevzeti to anketo?",
    "Yes" : "Da",
    ...
    "No polls found" : "Ni najdenih anket",
    "Select poll" : "Izbor ankete",
    "Link to a poll" : "Povezava do ankete",
    "Details" : "Podrobnosti",
    ...
    "A complete list with all openly accessible polls on this site, regardless who is the owner." : "Celoten seznam prosto dostopnih javnih anket na spletišču, neupoštevajoč lastništvo.",
