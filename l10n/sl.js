OC.L10N.register(
    ...
    "Hide email address" : "Skrij elektronski naslov",
    ...
    "You are asked to propose more poll options." : "Pozvani ste k posredovanju predlogov za dodatne možnosti ankete.",
    ...
    "Access for all users" : "Dostop za vse uporabnike",
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "Dodaj parametra naslova URL »name=« in/ali »email=« kot določili imena in elektronskega naslova, na primer: https://primer.si/s/aUubZAvweQ6PaX2?name=Marko Skače&email=marko.skace@email.si",
