OC.L10N.register(
    ...
    "- %s updated the poll configuration. Please check your votes." : "- %s erabiltzaileak bozketaren konfigurazioa eguneratu du. Egiaztatu zure bozkak.",
    "- %s deleted the poll." : "- %s erabiltzaileak bozketa ezabatu du.",
    "- %s restored the poll." : "- %s erabiltzaileak bozketa berrezarri du.",
    "- The poll expired." : "- Bozketa iraungi da.",
