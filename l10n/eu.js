OC.L10N.register(
    ...
    "You commented poll {pollTitle}" : "{pollTitle} bozketan iruzkina egin duzu",
    "{actor} commented poll {pollTitle}" : "{actor}(e)k {pollTitle} iruzkindu du",
    "You deleted a commented from poll {pollTitle}" : "{pollTitle} bozketan iruzkin bat ezabatu duzu",
    "{actor} deleted a commented from poll {pollTitle}" : "{actor}-(e)k iruzkin bat ezabatu du {pollTitle} bozketan",
    "You added an option to poll {pollTitle}" : "Aukera bat gehitu duzu {pollTitle} bozketan",
