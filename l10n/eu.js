OC.L10N.register(
    ...
    "Limit yes votes per option" : "Aukera bakoitzeko botoak mugatu",
    ...
    "Limit yes votes per user" : "Mugatu baiezko botoak erabiltzaile bakoitzeko",
    "Title" : "Izenburua",
    ...
    "_%n yes vote_::_%n yes votes_" : ["%n baiezko boto","%nbaiezko boto"],
    "_%n no vote_::_%n no votes_" : ["%n","%n ezezko botoak"],
    "_%n maybe vote_::_%n maybe votes_" : ["%nboto, agian","%nboto, gian"],
    ...
    "Closed {relativeTimeAgo}" : "Itxita {relativeTimeAgo}",
