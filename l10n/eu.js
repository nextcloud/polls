OC.L10N.register(
    ...
    "You have shared poll {pollTitle} with contact group {sharee}" : "Galdeketa {pollTitle} partekatu duzu {sharee} kontaktu taldearekin",
    "{actor} has shared poll {pollTitle} with contact group {sharee}" : "{actor}-(e)k galdeketa {pollTitle} partekatu du {sharee} kontaktu taldearekin",
    "You have shared poll {pollTitle} with {sharee}" : "Galdeketa {poll Title} {saree}-rekin partekatu duzu",
    "{actor} has shared poll {pollTitle} with {sharee}" : "{actor}-k galdeketa {poll Title} partekatu du {saree}-rekin",
    ...
    "You have deleted the share for {sharee} from poll {pollTitle}" : "{sharee}-ren partekatzea ezabatu duzu {pollTitle} galdetetatik",
    "{actor} has deleted the share for {sharee} from poll {pollTitle}" : "{actor}-k {sharee}-ren partekatzea ezabatu du {pollTitle} galdeketatik",
