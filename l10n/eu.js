OC.L10N.register(
    ...
    "Polls App - New Activity" : "Galdeketak aplikazioa - Jarduera berria",
    ...
    "The poll has been reopened." : "Galdeketa berriz ireki da.",
    ...
    "Reminder for poll \"%s\"" : "\"%s\" galdeketarentzako gogorarazpena",
    ...
    "{owner} sends you this reminder to make sure, your votes are set." : "{owner}(e)k ziurtatzeko bidaltzen dizu gogorarazpen hau, zure botoak ondo emanda daude.",
    "Contact" : "Kontaktua",
    ...
    "You have closed this poll" : "Galdeketa hau itxi duzu",
    "{actor} has closed this poll" : "{actor}(e)k galdeketa hau itxi du",
    ...
    "A polls app, similar to Doodle/Dudle with the possibility to restrict access." : "Galdeketak egiteko aplikazioa, Doodle/Dudle-ren modukoa, sarbidea mugatzeko aukerarekin.",
    "A polls app, similar to Doodle/Dudle with the possibility to restrict access (members, certain groups/users, hidden and public)." : "Galdeketak egiteko aplikazioa, Doodle/Dudle-ren modukoa, sarbidea mugatzeko aukerarekin (kideak, zenbait talde/erabiltzaile, ezkutukoa eta publikoa).",
    ...
    "For polls with expiration:" : "Iraungitzea duten galdeketentzat:",
    ...
    "For date polls without expiration:" : "Iraungitzerik gabeko data-galdetegientzat:",
    "48 hours before the first date option, if the poll is created more than 5 days before the first date option." : "Lehen data-aukera baino 48 ordu lehenago, galdeketa lehen data-aukera baino 5 egun lehenago sortzen bada.",
    "36 hours before the first date option, if the poll is created more than 2 and less than 5 days before the first date option." : "Lehen data-aukera baino 36 ordu lehenago, galdeketa lehen data-aukera baino 2 eta 5 egun lehenago artean sortzen bada.",
    "No reminder is sent:" : "Ez da gogorarazpenik bidali:",
    "For text polls without expiration." : "Iraungitzerik gabeko testu-galdeketentzat.",
    "For polls created less than 2 days before the expiration." : "Iraungitze-data baino 2 egun sortutako galdeketentzat.",
    ...
    "Reopen poll" : "Ireki berriz galdeketa",
    "Close poll" : "Itxi galdeketa",
    ...
    "Poll type" : "Galdeketa mota",
    "Cancel" : "Utzi",
    "Apply" : "Aplikatu",
    "Date poll" : "Data-galdeketa",
    "Text poll" : "Testu-galdeketa",
    ...
    "A private poll from {name}" : "{name}-(r)en galdeketa pribatua",
    "An openly accessible poll from {name}" : "{name}-(r)en galdeketa modu irekian eskuragarria",
    ...
    "Error registering to poll" : "Errore bat gertatu da galdeketan erregistratzean",
    ...
    "Text polls default to list view" : "Testu-galdeketak zerrenda ikuspegian lehenetsi",
    ...
    "Date polls default to list view" : "Data-galdeketak zerrenda ikuspegian lehenetsi",
    ...
    "As an admin you may edit this poll" : "Galdeketa hau editatu dezakezu administratzaile gisa",
    "Description" : "Deskripzioa",
    "Poll configurations" : "Galdeketare konfigurazioak",
    "Poll closing status" : "Galdeketaren itxiera egoera",
    "Result display" : "Emaitzen pantaila",
    "Error deleting poll." : "Errorea galdeketa ezabatzean.",
    ...
    "Poll settings" : "Galdeketaren ezarpenak",
    ...
    "Administrative poll management" : "Galdeketaren kudeaketa administratiboa",
    ...
    "Error loading poll list" : "Errorea galdeketa zerrenda kargatzean",
    ...
    "404 - poll not found" : "404 - ez da galdeketa aurkitu",
    ...
    "Error writing poll" : "Errorea galdeketa idazterakoan",
    "Disallow proposals" : "Ez onartu proposamenak",
    "Allow proposals" : "Onartu proposamenak",
    "Relevant" : "Beharrezkoa",
    "My polls" : "Nire galdeketak",
    ...
    "All polls, where you placed a vote." : "Botoa eman duzun galdeketa guztiak.",
    ...
    "All polls" : "Galdeketa guztiak",
    "All polls, where you have access to." : "Sarbidea duzun galdeketa guztiak.",
    "Closed polls" : "Itxitako galdeketak",
