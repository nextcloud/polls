OC.L10N.register(
    ...
    "Updated poll configuration. Please check your votes." : "Galdeketaren konfigurazioa eguneratu da. Mesedez egiaztatu zuen botoak.",
    "The poll has been deleted." : "Galdeketa ezabatu da.",
    "The poll has been restored." : "Galdeketa berezarri da.",
    "The poll has been closed." : "Galdeketa itxi da.",
    ...
    "The poll owner has been changed." : "Galdeketaren jabea aldatu da.",
    "%s created the poll." : " %s erabiltzaileak galdeketa sortu du.",
    ...
    "Reminder for poll \"%s\"" : "\"%s\" galdeketarentzako abisua",
    ...
    "%s took over your poll" : "%s zure galdeketaren kontrola hartu du",
    "{actor} took over your poll \"%s\" and is the new owner." : "{actor}-(e)k zure \"%s\" galdeketa hartu du eta jabe berria da.",
    "%s deleted your poll" : "%s-(e)k zure galdeketa ezabatu du",
    ...
    "You have deleted a comment from poll {pollTitle}" : "{pollTitle} galdeketatik iruzkin bat ezabatu duzu",
    "{actor} has deleted a comment from poll {pollTitle}" : "{actor}-(e)k iruzkin bat ezabatu du {pollTitle} galdeketatik",
    "You have added an option to poll {pollTitle}" : "{pollTitle} galdeketan aukera gehitu duzu",
    "{actor} has added an option to poll {pollTitle}" : "{actor}-(e)k aukera bat gehitu du {pollTitle} galdeketan",
    "You have changed an option of poll {pollTitle}" : "Galdeketaren aukera bat aldatu duzu {pollTitle}",
    "{actor} has changed an option of poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketaren aukera bat aldatu du",
    "You have confirmed option {optionTitle} of poll {pollTitle}" : "{pollTitle} galdeketaren {optionTitle} aukera berretsi duzu",
    "{actor} has confirmed option {optionTitle} of poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketaren {optionTitle} aukera berretsi du",
    "You have unconfirmed option {optionTitle} of poll {pollTitle}" : "{pollTitle} galdeketaren {optionTitle} aukera baieztatu gabe duzu",
    "{actor} has unconfirmed option {optionTitle} of poll {pollTitle}" : "{actor}-(e)k berretsi gabeko {pollTitle} galdeketaren {optionTitle} aukera du",
    "You have removed option {optionTitle} from poll {pollTitle}" : "{optionTitle} aukera kendu duzu {pollTitle} galdeketatik",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor}-(e)k {optionTitle} aukera kendu du {pollTitle} galdeketatik",
    "You have added poll {pollTitle}" : "{pollTitle} galdektea gehitu duzu",
    "{actor} has added poll {pollTitle}" : "{actor}-(e)k gehitu du {pollTitle} galdeketa",
    "You have changed the configuration of poll {pollTitle}" : " {pollTitle} galdeketaren konfigurazioa aldatu duzu",
    "{actor} has changed the configuration of poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketaren konfigurazioa aldatu du ",
    "You have archived poll {pollTitle}" : " {pollTitle} galdeketa artxibatu duzu",
    "{actor} has archived poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketa artxibatu du",
    "You have restored poll {pollTitle}" : "{pollTitle} galdeketa berezarri duzu",
    "{actor} has restored poll {pollTitle}" : "{actor}-(e)k {pollTitle} berezarri du",
    "Poll {pollTitle} has been closed" : "{pollTitle} galdeketa itxi da",
    "You have changed the owner of poll {pollTitle}" : "{pollTitle} galdeketaren jabea aldatu duzu",
    "{actor} has changed the owner of poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketaren jabea aldatu du",
    "You have reordered the options of poll {pollTitle}" : "{pollTitle} galdeketaren aukerak berrordenatu dituzu",
    "{actor} has reordered the options of poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketaren aukerak berrordenatu ditu",
    "You have added a public share to poll {pollTitle}" : "{pollTitle} galdeketa publikoki partekatu duzu",
    "{actor} has added a public share to poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketa publikoki partekatu du",
    "You have shared poll {pollTitle} with group {sharee}" : "{pollTitle} galdeketa {sharee} taldearekin partekatu duzu",
    "{actor} has shared poll {pollTitle} with group {sharee}" : "{actor}-(e)k {pollTitle} galdeketa partekatu du {sharee} taldearekin",
    "You have shared poll {pollTitle} with circle {sharee}" : "{pollTitle} gakdeketa {sharee} zirkuluarekin partekatu duzu",
    "{actor} has shared poll {pollTitle} with circle {sharee}" : "{actor}-(e)k {pollTitle} galdeketa partekatu du {sharee} zirkuluarekin",
    "You have shared poll {pollTitle} with contact group {sharee}" : "{pollTitle} galdeketa partekatu duzu {sharee} kontaktu taldearekin",
    "{actor} has shared poll {pollTitle} with contact group {sharee}" : "{actor}-(e)k {pollTitle} galdeketa partekatu du {sharee} kontaktu-taldearekin",
    "You have shared poll {pollTitle} with {sharee}" : "Galdeketa {poll Title} {saree}-rekin partekatu duzu",
    "{actor} has shared poll {pollTitle} with {sharee}" : "{actor}-(e)k {pollTitle} galdeketa partekatu du {sharee}-r()ekin",
    "You have changed your email address" : "Zure helbide elektronikoa aldatu duzu",
    "{sharee} has changed his email address" : "{sharee} bere helbide elektronikoa aldatu du",
    "You have changed your name" : "Zure izena aldatu duzu",
    "{sharee} has changed his name" : "{sharee} -(e)k bere izena aldatu du",
    ...
    "You have changed the registration constraints for share {sharee}" : "{sharee} partekatzeko erregistratzeko mugak aldatu dituzu",
    "{actor} has changed the registration constraints for share {sharee}" : "{actor}-(e)k aldatu ditu partekatzeko {sharee} erregistratzeko mugak ",
    "You have registered to poll {pollTitle}" : "{pollTitle} galdeketan erregistratu zara",
    "{sharee} registered to poll {pollTitle}" : "{sharee} {pollTitle} galdeketan erregistratu da",
    "You have deleted a public share from poll {pollTitle}" : "{pollTitle} galdeketaren partekatze publiko bat ezabatu duzu",
    "{actor} has deleted a public share from poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketaren partekatze publiko bat ezabatu du",
    "You have deleted the share for group {sharee} from poll {pollTitle}" : "{sharee} taldearen partekatzea ezabatu duzu {pollTitle} galdeketatik",
    "{actor} has deleted the share for group {sharee} from poll {pollTitle}" : "{actor}-(e)k {sharee} taldearen partekatzea ezabatu du {pollTitle} galdeketatik",
    "You have deleted the share for {sharee} from poll {pollTitle}" : "{sharee}-(r)en partekatzea ezabatu duzu {pollTitle} galdetetatik",
    "{actor} has deleted the share for {sharee} from poll {pollTitle}" : "{actor}-(e)k {sharee}-(r)en partekatzea ezabatu du {pollTitle} galdeketatik",
    "You have deleted the share for circle {sharee} from poll {pollTitle}" : "{sharee} zirkuluaren partekatzea ezabatu duzu {pollTitle} galdeketatik",
    "{actor} has deleted the share for circle {sharee} from poll {pollTitle}" : "{actor}-(e)k {sharee} zirkuluaren partekatzea ezabatu du {pollTitle} galdeketatik",
    "You have deleted the share for contact group {sharee} from poll {pollTitle}" : "{sharee} kontaktu-taldearen partekatzea ezabatu duzu {pollTitle} galdeketatik",
    "{actor} has deleted the share for contact group {sharee} from poll {pollTitle}" : "{actor}-(e)k {sharee} kontaktu-taldearen partekatzea ezabatu du {pollTitle} galdeketatik",
    "You have deleted a share from poll {pollTitle}" : "{pollTitle} galdeketatik partekatze bat ezabatu duzu",
    "{actor} has deleted a share from poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketatik partekatze bat ezabatu du",
    "You have voted in poll {pollTitle}" : "{pollTitle} galdeketan bozkatu duzu",
    "{actor} has voted in poll {pollTitle}" : "{actor}-(e)k {pollTitle} galdeketan bozkatu du",
    "You have done something indescribable with poll {pollTitle}" : "Zerbait deskribaezina egin duzu {pollTitle} galdeketarekin",
    "{actor} has done something indescribable with poll {pollTitle}" : "{actor}-(e)k zerbait deskribaezina egin du {pollTitle} galdeketarekin",
    ...
    "You have removed option {optionTitle}" : "{optionTitle} aukera kendu duzu",
    "{actor} has removed option {optionTitle}" : "{actor}-(e)k {optionTitle} aukera kendu du",
    "You have created this poll" : "Galdeketa hau sortu duzu",
    "{actor} has created this poll" : "{actor}-(e)k galdeketa hau sortu du",
    ...
    "You have archived this poll" : "Galdeketa hau artxibatu duzu",
    "{actor} has archived this poll" : "{actor}-(e)k galdeketa hau artxibatu du",
    "You have restored this poll" : "Galdeketa hau berezarri duzu",
    "{actor} has restored this poll" : "{actor}-(e)k galdeketa hau berezarri du",
    "This poll has been closed" : "Galdeketa hau itxi da.",
    "You have changed the poll owner" : "Galdeketaren jabea aldatu duzu",
    "{actor} has changed the poll owner" : "{actor}-(e)k galdeketaren jabea aldatu du",
    ...
    "You have shared this poll with group {sharee}" : "Galdeketa hau {sharee} taldearekin partekatu duzu",
    "{actor} has shared this poll with group {sharee}" : "{actor}-(e)k galdeketa hau partekatu du {sharee} taldearekin",
    "You have shared this poll with circle {sharee}" : "Galdeketa hau {sharee} zirkuluarekin partekatu duzu",
    "{actor} has shared this poll with circle {sharee}" : "{actor}-(e)k galdeketa hau partekatu du {sharee} zirkuluarekin",
    "You have shared this poll with contact group {sharee}" : "Galdeketa hau {sharee} kontaktu-taldearekin partekatu duzu",
    "{actor} has shared this poll with contact group {sharee}" : "{actor}-(e)k galdeketa hau partekatu du {sharee} kontaktu-taldearekin",
    "You have shared this poll with {sharee}" : "Galdeketa hau {sharee}-(r)ekin partekatu duzu",
    "{actor} has shared this poll with {sharee}" : "{actor}-(e)k galdeketa hau partekatu du {sharee}-(r)ekin",
    "Email address of {sharee} has been changed" : "{sharee} helbide elektronikoa aldatu da",
    ...
    "Someone voted inside a <strong>poll</strong>" : "Norbaitek <strong>galdeketa</strong> batean botoa eman du",
    ...
    "Poll closing date" : "Galdeketaren ixte-data",
    ...
    "You subscribed to this poll" : "Galdeketa honetara harpidetu zara",
    "Proposals are allowed" : "Proposamenak onartzen dira",
    "No proposals are allowed" : "Ez da onartzen proposamenik",
    "Results are hidden until closing poll" : "Emaitzak ezkutatuta daude galdeketa itxi arte",
    "Results are visible since closing poll" : "Emaitzak ikusgai daude galdeketa itxi geroztik",
    ...
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Zure e-posta helbidea beharrezkoa da. Izena eman ondoren galdeketara zure esteka pertsonala bidaliko da helbide honetara.",
    ...
    "By clicking the \"OK\" button you accept our {privacyPolicy}." : "\"Ados\" botoian klik eginez gure {PrivacyPolicy} onartzen duzu.",
    "privacy policy" : "pribatutasun politika",
    ...
    "Deactivate combo view for all users" : "Desaktibatu konbinazio-ikuspegia erabiltzaile guztientzat",
    "Allow combo view for the following groups" : "Baimendu konbo ikuspegia talde hauei",
    ...
    "Preview" : "Aurrebista",
    "Hide email addresses of internal users" : "Ezkutatu barne erabiltzaileen helbide elektronikoak",
    "Show email addresses of internal users to members of the following groups" : "Erakutsi barne erabiltzaileen helbide elektronikoak talde hauetako kideei",
    "The privacy link and the legal notice link are automatically added to the registration dialog of public polls." : "Pribatutasun-esteka eta lege-oharraren esteka automatikoki gehitzen dira herri galdeketetan erregistratzeko elkarrizketa-koadroan.",
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Modu lehenetsian, gaien aplikazioan konfiguratutako estekak erabiltzen dira. Galdeketa publikoetarako,  esteka horiek banakako terminoek baliogabetu ditzakete.",
    ...
    "Track activities" : "Jarraitu jarduerak",
    ...
    "After how many days are closed polls to be archived:" : "Zenbat egunen buruan itxita dauden galdeketak artxibatzeko:",
    ...
    "Disallow poll download" : "Ez onartu galdeketaren deskarga",
    "Allow poll download for the following groups" : "Baimendu galdeketa deskargatzea talde hauei",
    ...
    "Disallow openly accessible polls" : "Ez baimendu modu irekian galdeketa eskuragarriak",
    "Allow creating openly accessible polls for the following groups" : "Baimendu ondoko talde hauetarako modu irekian galdeketa eskuragarriak sortzea ",
    ...
    "Text polls default to list view" : "Modu lehenetsian, testu galdeketak mahai ikuspegian",
    ...
    "Date polls default to list view" : "Modu lehenetsian. data galdeketak zerrenda ikuspegian",
    ...
    "A poll with many options and voters can have a heavy impact on client performance." : "Aukera eta boto asko dituen galdeketa batek eragin handia izan dezake bezeroen errendimenduan.",
    "Set the amount of voting cells (options x participants) up to which all voting cells should be displayed." : "Ezarri itzazu boto-kaxak (aukerak x parte-hartzaileak) zenbat erakutsi beharko liratekeen arte.",
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Atalase hau gainditzen bada uneko erabiltzailea soilik erakutsiko da, errendimendu galera saihesteko.",
    "The default threshold of 1000 should be a good and safe value." : "1000-ko atalase lehenetsia balio segurua izan beharko litzake.",
    ...
    "Add a translucent effect on foreground elements like sidebar and poll table (Does not work with all browsers)." : "Gehitu efektu transluzido bat aurreko elementuentzat, alboko barra eta galdeketa-taula bezalakoentzat (ez du nabigatzaile guztiekin funtzionatzen).",
    "Calendar check" : "Egutegiaren egiaztapena",
    ...
    "Withdraw poll admin access" : "Kendu galdeketaren administratzaile sarbidea",
    ...
    "This poll is private" : "Galdeketa hau pribatua da",
    "This is an openly accessible poll" : "Galdeketa hau modu irekikoa da",
    ...
    "Restrict the share actions globally or on a group base" : "Murriztu partekatze ekintzak denontzat edo taldeka",
    "Poll creation restrictions" : "Galdeketak sortzeko murrizketak",
    "Restrict the creation of new polls globally or on a group base" : "Murriztu galdeketa berrien sorketa denontzat edo taldeka",
    "Legal terms for public poll registration" : "Galdeketa erregistro publikoen termino legalak",
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Gainidatzi zure gunearen termino legalen lotura lehenetsiak. Hutsik utzi estekak erabiltzeko, horiek tematizazio aplikazioan konfiguratzen baitira.",
    ...
    "Activate or disable individual features." : "Gaitu edo desgaitu ezaugarri indibidualak.",
    ...
    "Administrative poll management" : "Galdeketa kudeaketa administratiboa",
    ...
    "Do you want to take over this poll?" : "Galdeketa honen jabetza hartu nahi duzu?",
    "{username} will get notified." : "{username} jakinaraziko da.",
    "Yes" : "Bai",
    ...
    "Error overtaking poll." : "Errorea galdeketaren kontrola hartzerakoan.",
    "Select polls by clicking on them in the right sidebar!" : "Hautatu galdeketak eskuineko alboko barran klik eginez!",
    "No polls selected" : "Ez da galdeketarik hautatu",
    "Combined polls" : "Batutako galdeketak",
    ...
    "No polls found" : "Ez da galdeketarik aurkitu",
    "Select poll" : "Hautatu galdeketa",
    "Link to a poll" : "Lotu galdeketa batera",
    "Details" : "Xehetasunak",
    ...
    "Comments" : "Iruzkinak",
    "Activity" : "Jarduera",
    "Select polls to combine" : "Hautatu batzeko galdeketak",
    "Search for conflicting calendar entries" : "Bilatu gatazkan dauden egutegiko sarrera kº",
    "Polls user settings" : "Galdeketak erabiltzaile-ezarpenak",
    "Set your personal preferences for the polls app" : "Ezarri zure hobespenak galdeketen aplikaziorako",
    ...
    "All private polls, to which you have access." : "Sarbidea duzun galdeketa pribatu guztiak.",
    "Participated" : "Parte hartu da",
    "All polls, where you placed a vote." : "Botoa eman duzun bozketa guztiak.",
    "Openly accessible polls" : "Modu irekiko galdeketak",
    "A complete list with all openly accessible polls on this site, regardless who is the owner." : "Webgune honetako bozketa publiko guztien zerrenda, jabea edonor dela ere.",
