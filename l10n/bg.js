OC.L10N.register(
    ...
    "Relevant for all users" : "Приложимо за всички потребители ",
    "Only invited users" : "Само поканени потребители",
    ...
    "Hide email address" : "Скриване на имейл адреса",
    ...
    "Access for all users" : "Достъп за всички потребители",
    ...
    "A poll from {name}" : "Анкета от {name}",
    "Archived" : "Архивирано",
    ...
    "Enter a name to participate." : "Въведете име, за да участвате.",
    ...
    "Disallow publishing poll to all users" : "Забранете публикуването на анкета за всички потребители",
    "Allow poll sharing to all users for the following groups" : "Разрешете споделянето на анкети за всички потребители за следните групи",
    ...
    "Public link ({token})" : "Публична връзка ({token})",
    "Effective shares" : "Ефективни споделяния",
    ...
    "Public shares" : "Публични споделяния",
    "Add a public link" : "Добавяне на публична връзка",
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "Добавете URL параметри 'name=' и/или 'email=', за да дефинирате предварително име и имейл адрес. Например: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org",
    "Error adding share" : "Грешка при добавяне на споделяне",
    ...
    "Add Shares" : "Добавяне на споделяния",
    ...
    "Enter a name to start the search" : "Въведете име, за да започне търсенето",
    ...
    "Manage polls" : "Управление на анкети",
    ...
    "Do you want to take over this poll from {username} and change the ownership?" : "Искате ли да поемете тази анкета от {username} и да промените собствеността?",
    "The original owner will be notified." : "Първоначалният собственик ще бъде уведомен.",
    "No" : "Не",
    "Yes" : "Да",
    ...
    "Your app settings" : "Настройките на вашето приложение",
    ...
    "Hidden polls" : "Скрити анкети",
    "All hidden polls, to which you have access." : "Всички скрити анкети, до които имате достъп.",
    "Participated" : "В които сте участвали",
    "All polls, where you placed a vote." : "Всички анкети, в които сте гласували.",
    "Public polls" : "Публични анкети",
    "A complete list with all public polls on this site, regardless who is the owner." : "Пълен списък с всички обществени анкети на този сайт, независимо кой е собственикът.",
