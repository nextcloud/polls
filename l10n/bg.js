OC.L10N.register(
    ...
    "Number of items to create:" : "Брой елементи за създаване:",
    "OK" : "ОК",
    "Week" : "Седмица",
    ...
    "{username} is invalid or reserved." : "{username} е невалидно или запазено.",
    "{username} is valid." : "{username} е валиден.",
    "Valid email address." : "Валиден имейл адрес.",
    ...
    "After how many days are the closed polls to be archived:" : "След колко дни затворените анкети трябва да бъдат архивирани:",
    ...
    "Use calendar lookup" : "Използвайте търсене в календар",
    "Check, if an option in a date poll is conflicting with or near an entry in your calendar." : "Проверете дали дадена опция в анкета за дата е в конфликт със или близо до запис във вашия календар.",
    "Opt in to the calendars, which should be checked." : "Включете се в календарите, които трябва да бъдат отметнати.",
