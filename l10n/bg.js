OC.L10N.register(
    ...
    "{sharee} has changed his name" : "{sharee} си промени името",
    ...
    "Sent emails to:" : "Изпращане на имейли до:",
    "Emails could not be sent:" : "Имейлите не можаха да бъдат изпратени:",
    "Send information about confirmed options by email" : "Изпращане на информация за потвърдените опции по имейл",
    "Inform your participants about the confirmed options" : "Информирайте вашите участници за потвърдените опции",
    "Confirmations processed" : "Обработени потвърждения",
    "Confirmation sent to ${confirmation}" : "Потвърждението е изпратено до ${confirmation}",
    "Confirmation could not be sent to ${confirmation}" : "Потвърждението не можа да бъде изпратено до ${confirmation}",
    ...
    "Title" : "Име",
    "Enter Title" : "Въвеждане на заглавие",
    ...
    "Openly accessible and relevant poll" : "Публично достъпна и съответстваща анкета",
    ...
    "_Only %n vote per option._::_Only %n votes per option._" : ["Само%n гласа за опция.","Само %n гласа за опция."],
    ...
    "Otherwise participate publicly." : "В противен случай участвайте публично.",
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Вашият имейл адрес е нужен. След регистрацията вашата лична връзка към анкетата ще бъде изпратена на този адрес.",
    "With your email address you can subscribe to notifications and you will receive your personal link to this poll." : "С вашия имейл адрес можете да се абонирате за известия и ще получите личната си връзка към тази анкета.",
    ...
    "Deactivate combo view for all users" : "Деактивиране на комбинирания изглед за всички потребители",
    "Allow combo view for the following groups" : "Разрешете комбинирания изглед за следните групи",
    "Leave empty to disallow for all." : "Оставете празно, за да забраните за всички.",
    ...
    "Track activities" : "Проследяване на активности",
    "Hide login option in public polls" : "Скриване на опцията за влизане в публични анкети",
    "Archive closed polls automatically" : "Автоматично архивиране на затворените анкети",
    "After how many days are closed polls to be archived:" : "След колко дни затворените анкети трябва да бъдат архивирани:",
    "Activate long polling for instant updates" : "Активиране на дълга анкета за незабавни актуализации",
    "Activate periodic polling of updates from the client" : "Активиране на периодично запитване за актуализации от клиента",
    "Disable automatic updates (reload app for updates)" : "Изключване на автоматичните актуализации (презаредете приложението за актуализации)",
    "Disallow poll creation for all users" : "Забранете създаването на анкета за всички потребители",
    "Allow poll creation for the following groups" : "Разрешете създаването на анкета за следните групи",
    "Disallow poll download" : "Забрана за изтеглянето на анкета",
    "Allow poll download for the following groups" : "Разрешете изтеглянето на анкети за следните групи",
    "Disallow public shares" : "Забранете публичните споделяния",
    "Allow public shares for the following groups" : "Разрешете публични споделяния за следните групи",
    "Disallow openly accessible polls" : "Забранете публично достъпните анкети",
    "Allow creating openly accessible polls for the following groups" : "Позволете създаването на публично достъпни анкети за следните групи",
    ...
    "Use background color" : "Използвайте цвят на фона",
    "Use background image" : "Използвайте фоново изображение",
    "Enter the URL of your favorite background image." : "Въведете URL адреса на любимото си фоново изображение.",
    ...
    "Grant poll admin access" : "Предоставяне на администраторски достъп до анкетата",
    "Withdraw poll admin access" : "Оттегляне на администраторски достъп до анкетата",
    ...
    "Poll configurations" : "Конфигурации на анкети",
    ...
    "Delete votes" : "Изтриване на гласуването",
    "User {userId} removed" : "Потребител {userId} е премахнат ",
    "Share restrictions" : "Ограничения за споделяне",
    "Restrict the share actions globally or on a group base" : "Ограничете действията за глобално споделяне или на групова база",
    "Poll creation restrictions" : "Ограничения за създаване на анкети",
    ...
    "Activate or disable individual features." : "Активирайте или деактивирайте отделни функции.",
    ...
    "Yes" : "Да",
    "Do you want to delete this poll?" : "Искате ли да изтриете тази анкета?",
    "This action cannot be reverted." : "Това действие не може да бъде отменено.",
    ...
    "Goto Nextcloud" : "Отидете до Nextcloud ",
    "Error loading poll" : "Грешка при зареждане на анкета",
    "No polls found" : "Няма намерени анкети",
    "Select poll" : "Изберете анкета",
    "Link to a poll" : "Връзка към анкета",
    "Details" : "Подробности",
    ...
    "Polls user settings" : "Анкета на потребителските настройки",
    ...
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without polls closed more than five days ago." : "Всички анкети, които са подходящи или важни за вас, защото сте участник или собственик или сте поканени. Без избирателни секции затворени преди повече от пет дни.",
    "My polls" : "Моите анкети",
    "Your polls (in which you are the owner)." : "Вашите анкети (в които сте собственик).",
    ...
    "All polls, where you placed a vote." : "Всички анкети, в които сте гласували.",
