OC.L10N.register(
    ...
    "Grant access" : "Разрешаване на достъп",
    "A poll from {name}" : "Анкета от {name}",
    "Currently no users have access to this poll" : "В момента няма потребители с достъп до тази анкета",
    "Archived" : "Архивирано",
    ...
    "Access for all users of this site is disabled" : "Достъпът за всички потребители на този сайт е деактивиран",
    "Access for all users of this site is enabled" : "Достъпът за всички потребители на този сайт е активиран",
