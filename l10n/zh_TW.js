OC.L10N.register(
    ...
    "You have restored the share for circle {sharee} from poll {pollTitle}" : "您已從投票 {pollTitle} 中還原小圈圈 {sharee} 的分享",
    "{actor} has restored the share for circle {sharee} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 中還原小圈圈 {sharee} 的分享",
