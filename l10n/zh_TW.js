OC.L10N.register(
    ...
    "Option proposals allowed" : "允許選項提案",
    "Option proposal term ends {timeRelative}" : "選項提案期限結束於 {timeRelative}",
    "Option proposal term ended {timeRelative}" : "選項提案期限已結束於 {timeRelative}",
    ...
    "_%n yes vote_::_%n yes votes_" : ["%n 個贊成投票"],
    ...
    "Enter amount of maximal allowed vote boxes." : "輸入允許的最大投票框數量。",
    "User Settings" : "使用者設定",
