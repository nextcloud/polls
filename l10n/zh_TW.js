OC.L10N.register(
    ...
    "Due to possible performance issues {countHiddenParticipants} voters are hidden." : "由於效能問題，隱藏了 {countHiddenParticipants} 個投票者。",
    ...
    "Use fixed table headers" : "使用固定的表格標題",
    ...
    "Type to start searching ..." : "要開始搜尋的類型……",
    "Select users" : "選取使用者",
    "Vote saved" : "投票已儲存",
