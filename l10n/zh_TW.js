OC.L10N.register(
    ...
    "You commented poll {pollTitle}" : "您對投票 {pollTitle} 發表了評論",
    "{actor} commented poll {pollTitle}" : "{actor} 對投票 {pollTitle} 發表了評論",
    "You deleted a commented from poll {pollTitle}" : "您刪除了投票 {pollTitle} 中的一則評論",
    "{actor} deleted a commented from poll {pollTitle}" : "{actor} 刪除了投票 {pollTitle} 中的一則評論",
    "You added an option to poll {pollTitle}" : "您在 {pollTitle} 中新增了一個選項",
    "{actor} added an option to poll {pollTitle}" : "{actor} 在 {pollTitle} 中新增了一個選項",
    "You changed an option of poll {pollTitle}" : "您在 {pollTitle} 中變更了一個選項",
    "{actor} changed an option of poll {pollTitle}" : "{actor} 在 {pollTitle} 中變更了一個選項",
    "You confirmed option {optionTitle} of poll {pollTitle}" : "您確認了投票 {pollTitle} 的選項 {optionTitle}",
    "{actor} confirmed option {optionTitle} of poll {pollTitle}" : "{actor} 確認了投票 {pollTitle} 的選項 {optionTitle}",
    "You unconfirmed option {optionTitle} of poll {pollTitle}" : "您取消了投票 {pollTitle} 選項 {optionTitle} 的確認",
    "{actor} unconfirmed option {optionTitle} of poll {pollTitle}" : "{actor} 取消了投票 {pollTitle} 選項 {optionTitle} 的確認",
    "You removed option {optionTitle} from poll {pollTitle}" : "您從投票 {pollTitle} 中移除了選項 {optionTitle}",
    "{actor} removed option {optionTitle} from poll {pollTitle}" : "{actor} 從投票 {pollTitle} 中移除了選項 {optionTitle}",
    "You added poll {pollTitle}" : "您新增了投票 {pollTitle}",
    "{actor} added poll {pollTitle}" : "{actor} 新增了投票 {pollTitle}",
    "You changed the configuration of poll {pollTitle}" : "您變更了投票 {pollTitle} 的設定",
    "{actor} changed the configuration of poll {pollTitle}" : "{actor} 變更了投票 {pollTitle} 的設定",
    "You archived poll {pollTitle}" : "您封存了投票 {pollTitle}",
    "{actor} archived poll {pollTitle}" : "{actor} 封存了投票 {pollTitle}",
    "You restored poll {pollTitle}" : "您還原了投票 {pollTitle}",
    "{actor} restored poll {pollTitle}" : "{actor} 還原了投票 {pollTitle}",
    "Poll {pollTitle} was closed" : "投票 {pollTitle} 已關閉",
    "You changed the owner of poll {pollTitle}" : "您變更了投票 {pollTitle} 的擁有者",
    "{actor} changed the owner of poll {pollTitle}" : "{actor} 變更了投票 {pollTitle} 的擁有者",
    "You reordered the options of poll {pollTitle}" : "您重新排列了投票 {pollTitle} 選項的順序",
    "{actor} reordered the options of poll {pollTitle}" : "{actor} 重新排列了投票 {pollTitle} 選項的順序",
    "You added a public share to poll {pollTitle}" : "您對投票 {pollTitle} 新增了公開分享",
    "{actor} added a public share to poll {pollTitle}" : "{actor} 對投票 {pollTitle} 新增了公開分享",
    "You shared poll {pollTitle} with group {sharee}" : "您與群組 {sharee} 分享了投票 {pollTitle}",
    "{actor} You shared poll {pollTitle} with group {sharee}" : "{actor} 與群組 {sharee} 分享了投票 {pollTitle}",
    "You shared poll {pollTitle} with circle {sharee}" : "您與小圈圈 {sharee} 分享了投票 {pollTitle}",
    "{actor} shared poll {pollTitle} with circle {sharee}" : "{actor} 與小圈圈 {sharee} 分享了投票 {pollTitle}",
    "You shared poll {pollTitle} with contact group {sharee}" : "您與聯絡人群組 {sharee} 分享了投票 {pollTitle}",
    "{actor} shared poll {pollTitle} with contact group {sharee}" : "{actor} 與聯絡人群組 {sharee} 分享了投票 {pollTitle}",
    "You shared poll {pollTitle} with {sharee}" : "您與 {sharee} 分享了投票 {pollTitle}",
    "{actor} shared poll {pollTitle} with {sharee}" : "{actor} 與 {sharee} 分享了投票 {pollTitle}",
    "You changed your email address" : "您變更了您的電子郵件地址",
    "{actor} changed his email address" : "{actor} 變更了他的電子郵件地址",
    "You changed the share type" : "您變更了分享類型",
    "{actor} changed the share type" : "{actor} 變更了分享類型",
    "You changed the registration constraints for share {sharee}" : "您變更了分享 {sharee} 的註冊限制",
    "{actor} changed the registration constraints for share {sharee}" : "{actor} 變更了分享 {sharee} 的註冊限制",
    "You registered to poll {pollTitle}" : "您註冊了投票 {pollTitle}",
    "{sharee} registered to poll {pollTitle}" : "{sharee} 註冊了投票 {pollTitle}",
    "You deleted a public share from poll {pollTitle}" : "您已從投票 {pollTitle} 刪除公開分享",
    "{actor} deleted a public share from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 刪除公開分享",
    "You deleted the share for group {sharee} from poll {pollTitle}" : "您從投票 {pollTitle} 中刪除了群組 {sharee} 的分享",
    "{actor} deleted the share for group {sharee} from poll {pollTitle}" : "{actor} 從投票 {pollTitle} 中刪除了群組 {sharee} 的分享",
    "You deleted the share for {sharee} from poll {pollTitle}" : "您從投票 {pollTitle} 刪除了 {sharee} 的分享",
    "{actor} deleted the share for {sharee} from poll {pollTitle}" : "{actor} 從投票 {pollTitle} 刪除了 {sharee} 的分享",
    "You deleted the share for circle {sharee} from poll {pollTitle}" : "您從投票 {pollTitle} 刪除了小圈圈 {sharee} 的分享",
    "{actor} deleted the share for circle {sharee} from poll {pollTitle}" : "{actor} 從投票 {pollTitle} 刪除了小圈圈 {sharee} 的分享",
    "You deleted the share for contact group {sharee} from poll {pollTitle}" : "您從投票 {pollTitle} 刪除了聯絡人群組 {sharee} 的分享",
    "{actor} deleted the share for contact group {sharee} from poll {pollTitle}" : "{actor} 從投票 {pollTitle} 刪除了聯絡人群組 {sharee} 的分享",
    "You deleted a share from poll {pollTitle}" : "您從投票 {pollTitle} 刪除了分享",
    "{actor} deleted a share from poll {pollTitle}" : "{actor} 從投票 {pollTitle} 刪除了分享",
    "You voted in poll {pollTitle}" : "您已在投票 {pollTitle} 中投票",
    "{actor} voted in poll {pollTitle}" : "{actor} 已在投票 {pollTitle} 中投票",
    "You did something indescribable with poll {pollTitle}" : "您對投票 {pollTitle} 做了一些莫名其妙的事情",
    "{actor} did something indescribable with poll {pollTitle}" : "{actor} 對投票 {pollTitle} 做了一些莫名其妙的事情",
    "You commented" : "您已評論",
    "{actor} commented" : "{actor} 已評論",
    "You deleted a commented" : "您已刪除評論",
    "{actor} deleted a commented" : "{actor} 已刪除評論",
    "You added an option" : "您已新增了選項",
    "{actor} added an option" : "{actor} 已新增了選項",
    "You changed an option" : "您變更了選項",
    "{actor} changed an option" : "{actor} 變更了選項",
    "You confirmed option {optionTitle}" : "您確認了選項 {optionTitle}",
    "{actor} confirmed option {optionTitle}" : "{actor} 確認了選項 {optionTitle}",
    "You unconfirmed option {optionTitle}" : "您取消了選項 {optionTitle} 的確認",
    "{actor} unconfirmed option {optionTitle}" : "{actor} 取消了選項 {optionTitle} 的確認",
    "You removed option {optionTitle}" : "您移除了選項 {optionTitle}",
    "{actor} removed option {optionTitle}" : "{actor} 移除了選項 {optionTitle}",
    "You created this poll" : "您建立了此投票",
    "{actor} created this poll" : "{actor} 建立了此投票",
    "You changed the configuration" : "您變更了設定",
    "{actor} changed the configuration" : "{actor} 變更了設定",
    "You archived this poll" : "您已封存此投票",
    "{actor} archived this poll" : "{actor} 已封存此投票",
    "You restored this poll" : "您已還原此投票",
    "{actor} restored this poll" : "{actor} 已還原此投票",
    "This poll was closed" : "此投票已關閉",
    "You changed the poll owner" : "您變更了投票擁有者",
    "{actor} changed the poll owner" : "{actor} 變更了投票擁有者",
    "You reordered the options" : "您重新排列了選項",
    "{actor} reordered the options" : "{actor} 重新排列了選項",
    "You added a public share" : "您已新增公開分享",
    "{actor} added a public share" : "{actor} 已新增公開分享",
    "You shared this poll with group {sharee}" : "您已與群組 {sharee} 分享此投票",
    "{actor} You shared this poll with group {sharee}" : "{actor} 已與群組 {sharee} 分享此投票",
    "You shared this poll with circle {sharee}" : "您已與小圈圈 {sharee} 分享此投票",
    "{actor} shared this poll with circle {sharee}" : "{actor} 已與小圈圈 {sharee} 分享此投票",
    "You shared this poll with contact group {sharee}" : "您已與聯絡人群組 {sharee} 分享此投票",
    "{actor} shared this poll with contact group {sharee}" : "{actor} 已與聯絡人群組 {sharee} 分享此投票",
    "You shared this poll with {sharee}" : "您已與 {sharee} 分享此投票",
    "{actor} shared this poll with {sharee}" : "{actor} 已與 {sharee} 分享此投票",
    "{actor}'s email address was changed" : "{actor} 的電子郵件地址已變更",
    "You registered" : "您已註冊",
    "{sharee} registered" : "{sharee} 已註冊",
    "You deleted a public share" : "您刪除了公開分享",
    "{actor} deleted a public share" : "{actor} 刪除了公開分享",
    ...
    "You deleted the share for circle {sharee}" : "您刪除了與小圈圈 {sharee} 的分享",
    "{actor} deleted the share for circle {sharee}" : "{actor} 刪除了與小圈圈 {sharee} 的分享",
    ...
    "You deleted {sharee}'s share" : "您刪除了 {sharee} 的分享",
    "{actor} deleted a share" : "{actor} 刪除了分享",
    "You voted" : "您已投票",
    "{actor} voted" : "{actor} 已投票",
    "You did something indescribable with this poll" : "您對此投票做了一些莫名其妙的事情",
    "{actor} did something indescribable with this poll" : "{actor} 對此投票做了一些莫名其妙的事情",
    "Events happening inside of a <strong>poll</strong>" : "<strong>投票</strong>中發生的事件 ",
    "Someone votes inside a <strong>poll</strong>" : "有人在<strong>投票</strong>中投票了",
    ...
    "Access for all users" : "所有使用者均可存取",
    ...
    "Currently no users have access to this poll" : "目前沒有使用者可以存取此投票",
    "Archived" : "已封存",
    ...
    "{username} is invalid or reserved." : "{username} 無效或已保留。",
    "{username} is valid." : "{username} 有效。",
    "Valid email address." : "有效的電子郵件地址。",
    "Email could not be sent to {emailAddress}" : "電子郵件無法傳送至 {emailAddress}",
    "Error saving name" : "儲存名稱時發生錯誤",
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "需要您的電子郵件地址。在註冊後，您的個人投票連結將會寄送至此地址。",
    ...
    "After how many days are the closed polls to be archived:" : "已關閉的投票要在多少天後封存：",
    ...
    "Access for all users of this site is disabled" : "已停用此網站所有使用者的存取權限",
    "Access for all users of this site is enabled" : "已啟用此網站所有使用者的存取權限",
