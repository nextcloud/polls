OC.L10N.register(
    ...
    "{actor} has did something indescribable with poll {pollTitle}" : "{actor} 對投票 {pollTitle} 做了一些莫名其妙的事情",
    ...
    "{sharee}'s email address has been changed" : "{sharee} 的電子郵件地址已變更",
    ...
    "You have deleted {sharee}'s share" : "您已刪除 {sharee} 的分享",
