OC.L10N.register(
    ...
    "The poll has been reopened." : "投票已重新開啟。",
    ...
    "%s is the new owner of your poll." : "%s 是您投票的新擁有者。",
    "{actor} transfered your poll \"%s\" to {newOwner}. You are no more the owner." : "{actor} 將您的投票「%s」轉移給 {newOwner}。您不再是擁有者。",
    ...
    "This poll does not exist (anymore)." : "此投票已不存在。",
    "No one." : "沒有人。",
    "Access denied" : "拒絕存取",
    "You have no access to this poll. Contact %s if you think this is a mistake." : "您無權存取此投票。若您認為這是錯誤，請聯絡 %s。",
    ...
    "You have restored a comment from poll {pollTitle}" : "您已還原投票 {pollTitle} 中的一則留言",
    "{actor} has restored a comment from poll {pollTitle}" : "{actor} 已還原投票 {pollTitle} 中的一則留言",
    ...
    "You have deleted option {optionTitle} from poll {pollTitle}" : "您已從投票 {pollTitle} 中刪除選項 {optionTitle}",
    "{actor} has deleted option {optionTitle} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 中刪除選項 {optionTitle}",
    "You have deleted option {optionTitle}" : "您已刪除選項 {optionTitle}",
    "{actor} has deleted option {optionTitle}" : "{actor} 已刪除選項 {optionTitle}",
    "You have restored option {optionTitle} from poll {pollTitle}" : "您已從投票 {pollTitle} 中還原選項 {optionTitle}",
    "{actor} has restored option {optionTitle} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 中還原選項 {optionTitle}",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "您已與團隊 {sharee} 分享了投票 {pollTitle}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} 已與團隊 {sharee} 分享投票 {pollTitle}",
    "You have shared this poll with team {sharee}" : "您已與團隊 {sharee} 分享此投票",
    "{actor} has shared this poll with team {sharee}" : "{actor} 已與團隊 {sharee} 分享此投票",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "您從已投票 {pollTitle} 中刪除團隊 {sharee} 的分享",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 刪除團隊 {sharee} 的分享",
    "You have deleted the share for team {sharee}" : "您已刪除與團隊 {sharee} 的分享",
    "{actor} has deleted the share for team {sharee}" : "{actor} 已刪除與團隊 {sharee} 的分享",
    ...
    "You have restored the share for {sharee} from poll {pollTitle}" : "您已從投票 {pollTitle} 中還原 {sharee} 的分享",
    "{actor} has restored the share for {sharee} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 中還原 {sharee} 的分享",
    "You have restored share of {sharee}" : "您已還原 {sharee} 的分享",
    "{actor} has restored a share" : "{actor} 已還原分享",
    "You have restored a public share from poll {pollTitle}" : "您已從投票 {pollTitle} 還原公開分享",
    "{actor} has restored a public share from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 還原公開分享",
    "You have restored a public share" : "您還原了公開分享",
    "{actor} has restored a public share" : "{actor} 還原了公開分享",
    "You have restored the share for group {sharee} from poll {pollTitle}" : "您已從投票 {pollTitle} 中還原群組 {sharee} 的分享",
    "{actor} has restored the share for group {sharee} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 中還原群組 {sharee} 的分享",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "您從已投票 {pollTitle} 中還原團隊 {sharee} 的分享",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 還原團隊 {sharee} 的分享",
    "You have restored the share for team {sharee}" : "您已還原與團隊 {sharee} 的分享",
    "{actor} has restored the share for team {sharee}" : "{actor} 已還原與團隊 {sharee} 的分享",
    "You have restored the share for contact group {sharee} from poll {pollTitle}" : "您已從投票 {pollTitle} 還原聯絡人群組 {sharee} 的分享",
    "{actor} has restored the share for contact group {sharee} from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 還原聯絡人群組 {sharee} 的分享",
    ...
    "You have restored a share from poll {pollTitle}" : "您已從投票 {pollTitle} 還原分享",
    "{actor} has restored a share from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 還原分享",
    ...
    "Someone voted in a <strong>poll</strong>" : "某人已在<strong>投票</strong>中投票",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access." : "類似於 Doodle/DuD-Poll 的投票應用程式，可限制存取權限。",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access (members, certain groups/users, hidden and public)." : "類似於 Doodle/DuD-Poll 的投票應用程式，可限制存取權限（成員、特定群組或使用者、隱藏與公開）。",
    "Loading…" : "正在載入……",
    "Add option" : "新增選項",
    "Add poll" : "新增投票",
    "\"{pollTitle}\" has been successfully created." : "已成功建立「{pollTitle}」。",
    "Poll created" : "已建立投票",
    "Add another poll" : "新增其他投票",
    ...
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "本投票為匿名投票，所有人都可參與，包括投票的擁有者。本投票已停用匿名投票。",
    "But be aware that your name is not stored in an encrypted or obfuscated way." : "但請注意，您的姓名不會以加密或混淆的方式儲存。",
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll administration." : "此投票對所有人都是匿名投票，除了投票擁有者與委派的投票管理員。",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll administration." : "擁有者與授權的投票管理員可以隨時移除此投票的匿名化。",
    ...
    "Voting is locked and you have just read access to this poll." : "投票已鎖定，只有您可以讀取此投票。",
    ...
    "Select timezone to apply" : "選取要套用的時區",
    "Use original timezone ({pollTimezone})" : "使用原始時區 ({pollTimezone})",
    ...
    "For polls with expiration" : "有截止日期的投票",
    ...
    "For date polls without expiration" : "沒有截止日期的日期投票",
    ...
    "Anonymize poll irrevocably" : "不可撤銷地匿名化投票",
    "Cancel" : "取消",
    "Ok" : "尚可",
    "Anonymous poll" : "匿名投票",
    ...
    "Enter title" : "輸入標題",
    "Poll type" : "投票類型",
    "\"{pollTitle}\" has been added" : "已新增「{pollTitle}」",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "這將會不可逆轉地刪除投票，並將會通知 {username}。",
    "This will irreversibly delete the poll." : "這將會不可逆轉地刪除投票。",
    "OK" : "確定",
    ...
    "Transfering a poll to another user may result in loss of access to this poll." : "將投票轉移給其他使用者可能會導致無法存取此投票。",
    ...
    "Open poll, accessible to all users of this instance and invited participants" : "公開投票，此站台的所有使用者與受邀的參與者皆可存取",
    "{count} participants" : "{count} 個參與者",
    "Open poll, accessible to all users of this instance" : "公開投票，此站台的所有使用者皆可存取",
    "You have been granted administrative rights" : "您已取得管理權限",
    "You participated" : "您已參與",
    "never" : "從未",
    "Poll owner: {ownerName}" : "投票擁有者：{ownerName}",
    "Take over poll?" : "接管投票？",
    "You will become the new owner and {username} will get notified." : "您將會變成新擁有者，並將會通知 {username}。",
    "The poll group was deleted by removing the last member." : "移除最後一位成員後，投票群組已被刪除。",
    ...
    "Back" : "返回",
    "Take over" : "接管",
    "Transfer poll ownership" : "轉移投票所有權",
    ...
    "Days after which archived polls should be permanently deleted" : "已封存的投票會在幾天後永久刪除",
    ...
    "The last execution of this job has failed. Please check the logs for more details." : "此工作上次執行失敗。請檢查紀錄檔以取得更多資訊。",
    "Not run yet" : "尚未執行",
    "This job has never been run yet." : "這項工作從未執行。",
    "{jobName} has been executed." : "已執行 {jobName}。",
    "Start {jobName} manually." : "手動開始 {jobName}。",
    "{jobName} does not support manually run." : "{jobName} 不支援手動執行。",
    "Request Execution" : "請求執行",
    "Request job execution" : "請求執行工作",
    "Enter the URL of your privacy policy" : "輸入您隱私權政策的 URL",
    "Enter the URL of your legal notice" : "輸入您法律聲明的 URL",
    "Use the default terms for public polls" : "使用公開投票的預設條款",
    ...
    "Anonymizing a poll of a restricted owner means that this poll is anonymous for everyone, including the owner." : "對受限制的擁有者匿名化投票，代表此投票對所有人都是匿名的，包括擁有者。",
    "Deleting and changing votes of participants is not possible" : "無法刪除與變更參與者投票",
    ...
    "Check this for more poll information in the overview." : "在概覽中檢查此處以取得更多投票的資訊。",
    ...
    "Resolve this team first!" : "先解決此團隊！",
    "Share label" : "分享標籤",
    "Has voted" : "已投票",
    "Has not voted" : "尚未投票",
    ...
    "Be the first." : "成為第一個。",
    "Configuration" : "設定",
    "Comments are disabled, except for owner and delegated poll administration." : "已停用留言，僅限擁有者與被授權的投票管理員可以發表留言。",
    "You have been granted administrative rights." : "您已取得管理權限。",
    "Changes may affect existing votes." : "變更可能會影響現有的投票。",
    "Poll configuration" : "投票設定",
    "Poll closing status" : "投票關閉狀態",
    "Result display" : "結果顯示",
    "Forced display mode" : "強制顯示模式",
    "Set default timezone for this poll" : "設定此投票的預設時區",
    "Deletion and owner" : "刪除與擁有者",
    ...
    "Available options" : "可用的選項",
    "No vote options" : "無投票選項",
    "Add a date" : "新增日期",
    "Shares for a poll group grant voting access to the polls contained in the poll group." : "投票群組的分享權限可讓成員對該群組內的投票進行投票。",
    ...
    "No answer" : "沒有答案",
    "Vote saved" : "投票已儲存",
    "Vote already booked out" : "投票已經預約滿了",
    ...
    "403 - You are not allowed to access this poll" : "403 - 您無權存取此投票",
    ...
    "Or [link]login[/link] if you are a member of this site." : "若您是本站會員，請點選[link]登入[/link]。",
    ...
    "Relevant" : "相關",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "與您相關的投票，因為您是參與者、擁有者或受邀者。系統僅顯示自建立、最後活動、到期日或最新選項（針對日期投票）起算，未超過 100 天的投票。",
    "My polls" : "我的投票",
    "These are all polls where you are the owner." : "這些都是您為擁有者的投票。",
    "Private polls" : "私人投票",
    "All private polls, to which you have access." : "您可以存取的所有私人投票。",
    "Participated" : "已參與",
    "All polls in which you participated." : "您參與的所有投票。",
    "Openly accessible polls" : "開放可存取的投票",
    "A complete list with all openly accessible polls on this site." : "包含此網站上所有可公開存取的投票的完整清單。",
    "All polls" : "所有投票",
