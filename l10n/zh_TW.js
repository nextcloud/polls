OC.L10N.register(
    ...
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll admins." : "此投票對所有人都是匿名投票，除了投票擁有者與委派的投票管理員。",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll admins." : "擁有者與授權的投票管理員可以隨時移除此投票的匿名化。",
    ...
    "Once enabled the anonymous setting can not be reverted anymore." : "匿名設定一旦啟用就無法撤銷。",
    ...
    "Deletion and changing votes of participants is not possible" : "無法刪除與變更參與者投票",
    ...
    "My polls" : "我的投票",
    "This are all polls, where you are the owner." : "這些都是您為擁有者的投票。",
    "Private polls" : "私人投票",
