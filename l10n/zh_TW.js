OC.L10N.register(
    ...
    "Activate all calendars to consult for the search of conflicting events." : "啟用所有行事曆以搜尋相互衝突的事件。",
    "Set the time interval in hours, a calendar event must be finished before a date option, to get accounted to the conflict check." : "以小時為單位設定時間間隔，行事曆事件必須在日期選項之前完成，才能計入衝突檢查。",
    "Set the time interval in hours, a calendar event must start after a date option, to get accounted to the conflict check." : "以小時為單位設定時間間隔，行事曆事件必須在日期選項之後開始，才能計入衝突檢查。",
