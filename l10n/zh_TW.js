OC.L10N.register(
    ...
    "- The poll got closed." : "- 投票關閉。",
    "- A vote option was added." : "- 已新增投票選項。",
    "- A vote option changed." : "- 投票選項變更。",
    "- A vote option got confirmed." : "- 投票選項確認。",
    ...
    "You are asked to propose more poll options." : "您被要求提出更多投票選項。",
    "Clone option" : "再製選項",
