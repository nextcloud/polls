OC.L10N.register(
    ...
    "_%n vote is allowed per user._::_%n votes are allowed per user._" : ["每個使用者允許 %n 票。"],
    ...
    "Your share is locked and you have just read access to this poll." : "您的分享已鎖定，您只有對此投票的讀取權限。",
    ...
    "Error while changing lock status of user {displayName}" : "變更使用者 {displayName} 的鎖定狀態失敗",
