OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{sharee} 已變更他的電子郵件地址",
    ...
    "An open accessible poll from {name}" : "來自 {name} 的開放可存取投票",
    ...
    "Private poll" : "私人投票",
    "Open accessible and relevant poll" : "開放可存取且相關的投票",
    "Open accessible poll" : "開放可存取得的投票",
    ...
    "Disallow open accessible polls" : "取消允許開放可存取的投票",
    "Allow creating open accessible polls for the following groups" : "允許以下群組建立開放可存取得投票",
    ...
    "This is an open accessible poll" : "這是開放可存取的投票",
    ...
    "No polls found" : "找不到投票",
    "Select poll" : "選取投票",
    "Link to a poll" : "連結至投票",
    "Details" : "詳細資料",
    "Configuration" : "設定",
    "Options" : "選項",
    "Sharing" : "分享",
    ...
    "Open accessible polls" : "開放可存取的投票",
    "A complete list with all open accessible polls on this site, regardless who is the owner." : "此網站上的所有開放可存取的投票的完整列表，無論誰是所有者。",
    "All polls" : "所有投票",
