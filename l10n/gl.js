OC.L10N.register(
    ...
    "Confirmation could not be sent to {participant} ({emailAddress})" : "Non foi posíbel enviar a confirmación a {participant} ({emailAddress})",
    "_Confirmations sent to {count} recipient_::_Confirmations sent to {count} recipients_" : ["Enviáronse as confirmacións a {count} destinatario","Enviáronse as confirmacións a {count} destinatarios"],
    ...
    "A name is required." : "Precisase un nome.",
    "The name {username} is invalid or reserved." : "O nome {username} non é válido ou está reservado.",
    "An email address is required." : "Precisase un enderezo de correo",
    ...
    "Email address is mandatory" : "Precisase do enderezo de correo",
