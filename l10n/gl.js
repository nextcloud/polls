OC.L10N.register(
    ...
    "Notifications will be" : "As notificacións serán",
    "sent to {emailAddress}" : "enviadas a {emailAddress}",
    "Add your email Address," : "Engada o seu enderezo de correo-e.",
    "if you want to subscribe or receive your personal link via email." : "se quere subscribirse ou recibir a súa ligazón persoal por correo-e.",
