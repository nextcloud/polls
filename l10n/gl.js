OC.L10N.register(
    ...
    "Transfering a poll to another user may result in loss of access to this poll." : "A transferencia dunha enquisa a outro usuario pode provocar a perda de acceso a esta enquisa.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "A transferencia dunha enquisa a {user} pode provocar a perda de acceso a esta enquisa.",
    ...
    "Relevant" : "Relevante",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Enquisas relevantes que sexan relevantes para Vde., sexa porque é participante, propietario ou foi convidado. Só se amosan as enquisas non teñan máis de 100 días desde a súa creación, última interacción, caducidade ou última opción (para enquisas con data).",
