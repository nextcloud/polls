OC.L10N.register(
    ...
    "The first poll option is away less than {leftPeriod} hours ({dateTime}, {timezone})." : "A primeira opción de enquisa está a menos de {leftPeriod} horas ({dateTime}, {timezone}).",
    ...
    "{owner} sends you this reminder to make sure, your votes are set." : "{owner} envíalle este lembrete para asegurarlle de que os seus votos foron aplicados",
    "Contact" : "Contacto",
    ...
    "%s is the new owner of your poll." : "%s é o novo propietario da enquisa.",
    "{actor} transfered your poll \"%s\" to {newOwner}. You are no more the owner." : "{actor} transferiulle a enquisa «%s» a {newOwner}. Vde. xa non é o propietario.",
    ...
    "This poll does not exist (anymore)." : "Esta enquisa xa non existe.",
    "No one." : "Ninguén.",
    "Access denied" : "Acceso denegado",
    "You have no access to this poll. Contact %s if you think this is a mistake." : "Vde. non ten acceso a esta enquisa. Contacte con %s se cree que se trata dun erro.",
    ...
    "You have reopened the poll \"{pollTitle}\"" : "Vde. volveu abrir a enquisa «{pollTitle}»",
    "{actor} has reopened the poll \"{pollTitle}\"" : "{actor} volveu abrir a enquisa «{pollTitle}» ",
    "You have reopened this poll" : "Vde. volveu abrir esta enquisa",
    "{actor} has reopened this poll" : "{actor} volveu abrir esta enquisa",
    ...
    "One or more orphaned votes heve been deleted from {pollTitle}" : "Un ou máis votos orfos foron eliminados de {pollTitle}",
    "{actor} has deleted your orphaned polls from poll {pollTitle}" : "{actor} eliminou os votos orfos da enquisa {pollTitle}",
    "Orphaned votes deleted" : "Os votos orfos foron eliminados",
    "{actor} deleted orphaned votes" : "{actor} eliminou os votos orfos",
    ...
    "Someone voted in a <strong>poll</strong>" : "Alguén votou nunha <strong>enquisa</strong>",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access." : "Unha aplicación de enquisas, semellante a Doodle//DuD-Poll, coa posibilidade de restrinxir o acceso.",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access (members, certain groups/users, hidden and public)." : "Unha aplicación de enquisas, semellante a Doodle//DuD-Poll, coa posibilidade de restrinxir o acceso (membros, determinados grupos/usuarios, agochados e públicos).",
    "Add option" : "Engadir opción",
    "Add poll" : "Engadir unha enquisa",
    "\"{pollTitle}\" has been successfully created." : "«{pollTitle}» foi creada satisfactoriamente",
    "Poll created" : "Enquisa creada",
    "Add another poll" : "Engadir outra enquisa",
    "Open poll now" : "Abrir agora a enquisa",
    ...
    "plus" : "máis",
    "Please wait…" : "Agarde...",
    "Possibly affected calendar events" : "Eventos de calendario posibelmente afectados",
    "Add" : "Engadir",
    ...
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "Esta é unha enquisa anónima para todos, incluído o propietario. A desanonimización está desactivada para esta enquisa.",
    ...
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll administration." : "Esta é unha enquisa anónima para todos, agás para o propietario e a administración delegada da enquisa.",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll administration." : "A anonimización desta enquisa pode ser retirada en calquera momento polo propietario e a administración delegada da enquisa.",
    "This poll is closed." : "Esta enquisa está pechada.",
    "No further action is possible." : "Non hai ningunha acción posíbel.",
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduce your vote quota._" : ["%n votos orfo reduce a súa cota de voto.","%n votos orfos reducen a súa cota de voto."],
    ...
    "You have no votes left." : "Xa non lle quedan votos.",
    "_You have %n vote left out of {maxVotes}._::_You have %n votes left out of {maxVotes}._" : ["Aínda dispón de %n voto de {maxVotes}","Aínda dispón de %n votos de {maxVotes}"],
    ...
    "Anonymize poll irrevocably" : "Anonimizar a enquisa de xeito irrevogábel",
    "Cancel" : "Cancelar",
    "Ok" : "Aceptar",
    ...
    "Transfer poll" : "Transferir enquisa",
    ...
    "User preference" : "Preferencias do usuario",
    ...
    "Use explicit \"No\" votes" : "Usar votos «Non» explícitos",
    ...
    "\"{pollTitle}\" has been added" : "«{pollTitle}» foi engadida",
    "Choose a meaningful title for your poll" : "Escolla un título significativo para a enquisa",
    "Close" : "Pechar",
    "Yes" : "Si",
    "No" : "Non",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Isto eliminará de xeito irreversíbel a enquisa e {username} será notificado.",
    "This will irreversibly delete the poll." : "Isto eliminará de xeito irreversíbel a enquisa.",
    "OK" : "Aceptar",
    ...
    "Transfered poll to {user}." : "Enquisa transferida a {user}.",
    "Error transfering poll." : "Produciuse un erro ao transferir a enquisa.",
    "Transfering a poll to another user may result in loss of access to this poll." : "A transferencia dunha enquisa a outro usuario pode provocar a perda de acceso a esa enquisa.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "A transferencia dunha enquisa a {user} pode provocar a perda de acceso a esa enquisa.",
    "You are not the owner of this poll. {owner} will get informed about this action." : "Vostede non é o dono desta enquisa. {owner} vai ser informado sobre esta acción.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "Vostede non é o dono desta enquisa. {owner} vai ser informado sobre a transferencia a {newUser}.",
    ...
    "Poll information" : "Información da enquisa",
    "Archived" : "Arquivado",
    ...
    "Created {dateTime}" : "Creada o {dateTime}",
    "Created {dateRelative}" : "Creada o {dateRelative}",
    "Closing: {dateTime}" : "Pechada: {dateTime}",
    ...
    "Enter extended title" : "Introduza o título ampliado",
    ...
    "Error updating poll group" : "Produciuse un erro ao actualizar o grupo de enquisa",
    "Extended title" : "Título ampliado",
    "Description" : "Descrición",
    "No access" : "Sen acceso",
    "No access to this poll of {ownerName}." : "Non hai acceso a esta enquisa de {ownerName}.",
    "Archived poll" : "Enquisa arquivada",
    "Archived {relativeTime}" : "Arquivado ás {relativeTime}",
    "Private poll, only invited participants have access" : "Enquisa privada, só os participantes convidados teñen acceso",
    "Open poll, accessible to all users of this instance and invited participants" : "Enquisa aberta, accesíbel para todos os usuarios desta instancia e para os participantes convidados",
    "{count} participants" : "{count} participantes",
    "Open poll, accessible to all users of this instance" : "Enquisa aberta, accesíbel para todos os usuarios desta instancia",
    "You have been granted administrative rights" : "Concedéronlle dereitos administrativos",
    "You participated" : "Vde. participou",
    "Poll owner: {ownerName}" : "Propietario da enquisa: {ownerName}",
    "never" : "nunca",
    "Take over poll?" : "Tomar o control da enquisa?",
    "You will become the new owner and {username} will get notified." : "Vde. srá o novo propietario e {username} recibirá unha notificación.",
    "The poll group was deleted by removing the last member." : "O grupo de enquisa foi eliminado ao retirar o último membro.",
    "Error removing poll from group." : "Produciuse un erro ao retirar o grupo de enquisa",
    "Error creating new poll group." : "Produciuse un erro ao crear un novo grupo de enquisa.",
    ...
    "Error taking over poll." : "Produciuse un erro ao tomar o control da enquisa.",
    "Back" : "Atrás",
    "Take over" : "Tomar o control",
    "Transfer poll ownership" : "Transferir a propiedade da enquisa",
    ...
    "Enable the automatic deletion of archived polls" : "Activar a eliminación automática de enquisas arquivadas",
    "Days after which archived polls should be permanently deleted" : "Días após os cales as enquisas arquivadas deberían ser eliminadas definitivamente",
    ...
    "Sends out pending automatic reminders." : "Envía lembretes automáticos pendentes.",
    "Cleans up old or irrelevant data from the system to maintain optimal performance and organization." : "Limpa datos antigos ou irrelevantes do sistema para manter un rendemento e unha organización óptimos.",
    "Sends out pending notifications about poll updates." : "Envía notificacións pendentes sobre as actualizacións das enquisas.",
    "Description is missing." : "Falta a descrición.",
    "Execution failed" : "Produciuse un fallo na execución",
    "The last execution of this job has failed. Please check the logs for more details." : "Produciuse un fallo na última execución deste traballo Consulte os rexistros para máis detalles.",
    "Not run yet" : "Aínda non foi executado",
    "This job has never been run yet." : "Este traballo non foi executado nunca.",
    "{jobName} has been executed." : "{jobName} foi executado.",
    "Start {jobName} manually." : "Iniciar {jobName} manualmente.",
    "{jobName} does not support manually run." : "{jobName} non admite a execución manual.",
    "Request Execution" : "Solicitar a execución",
    "Request job execution" : "Solicitar a execución do traballo",
    ...
    "Use the default terms for public polls and enable the default footer" : "Usar os termos predeterminados para as enquisas públicas e activar o rodapé predeterminado",
    "If you want to use different terms for public polls, enter them below." : "Se quere usar termos diferentes para as enquisas públicas, introdúzaos a continuación.",
    ...
    "Enable the poll creation globally" : "Activar a creación de enquisas de xeito global",
    "Enable the spreadsheet download of polls globally" : "Activar a descarga da folla de cálculo das enquisas de xeito global",
    "Load polls into the navigation." : "Cargar as enquisas na navegación.",
    "Enable the creation of openly accessible polls globally" : "Activar a creación de enquisas de acceso aberto de xeito global",
    "Enable public shares of polls globally" : "Activar a compartición pública das enquisas de xeito global",
    ...
    "Anonymizing a poll of a restricted owner means that this poll is anonymous for everyone, including the owner." : "Anonimizar unha enquisa dun propietario restrinxido significa que esta enquisa é anónima para todos, incluído o propietario.",
    "Deleting and changing votes of participants is not possible" : "Non é posíbel eliminar nin modificar os votos dos participantes",
    ...
    "Verbose poll list" : "Lista detallada de enquisas",
    "Check this for more poll information in the overview." : "Marque isto para obter máis información sobre a enquisa no resumo",
    "Enter the amount of days, polls without activity stay in the relevant list:" : "Introduza o número de días que as enquisas sen actividade permanecen na lista de relevantes:",
    ...
    "Poll group access" : "Acceso ao grupo de enquisa",
    "(deleted)" : "(eliminado)",
    "(locked)" : "(bloqueado)",
    ...
    "Resolving of {name} is not possible. The circles app is not enabled." : "Non é posíbel resolver {name}. A aplicación de círculos non está activada.",
    "Error resolving {name}." : "Produciuse un erro ao resolver {name}.",
    "Grant administrative poll access" : "Conceder acceso administrativo á enquisa",
    "Withdraw administrative poll access" : "Retirar o acceso administrativo á enquisa",
    ...
    "Comments are disabled, except for owner and delegated poll administration." : "Os comentarios están desactivados, agás para o propietario e a administración delegada da enquisa.",
    "You have been granted administrative rights." : "Concedéronlle dereitos administrativos.",
    "Changes may affect existing votes." : "Os cambios poden afectar aos votos existentes.",
    "Poll configuration" : "Configuración da enquisa",
    "Poll closing status" : "Estado das enquisas pechadas",
    "Result display" : "Amosar os resultados",
    "Forced display mode" : "Modo de vista forzado",
    "Deletion and owner" : "Eliminación e propietario",
    ...
    "Shares for a poll group grant voting access to the polls contained in the poll group." : "As accións dun grupo de enquisas outorgan o acceso ao voto ás enquisas contidas no grupo de enquisas.",
    ...
    "Add public link" : "Engadir unha ligazón pública",
    ...
    "Click to vote with {nextAnswer} for option {option}" : "Prema para votar con {nextAnswer} pola opción {option}",
    "Participant {userId} has been removed" : "O participante {userId} foi retirado",
    "Remove votes of {displayName}" : "Retirar os votos de {displayName}",
    "Click to sort by name" : "Prema para ordenar por nome",
    "Click to remove sorting" : "Prema para retirar a ordenación",
    "No voters" : "Non hai votantes",
    "more" : "máis",
    ...
    "Select polls by clicking on them in the right sidebar!" : "Seleccione as enquisas premendo nelas na barra lateral dereita.",
    ...
    "403 - You are not allowed to access this poll" : "403 — Vde. non ten permiso para acceder a esta enquisa",
    ...
    "Fetching polls…" : "Obtendo as enquisas…",
    ...
    "Loading poll…" : "Cargando a enquisa…",
    "Fetching configuration…" : "Obtendo a configuración…",
    "Collecting elements…" : "Recollendo elementos...",
    "This seems to be a huge poll, please be patient…" : "Isto semella ser unha enquisa moi grande, teña paciencia…",
    ...
    "Error loading more participants" : "Produciuse un erro ao cargar máis participantes",
    ...
    "Poll updated" : "Enquisa actualizada",
    ...
    "Relevant" : "Relevante",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Enquisas relevantes que sexan relevantes para Vde., sexa porque é participante, propietario ou foi convidado. Só se amosan as enquisas que non teñan máis de 100 días desde a súa creación, última interacción, caducidade ou última opción (para enquisas con data).",
    "My polls" : "As miñas enquisas",
    "These are all polls where you are the owner." : "Estas son todas as enquisas nas que Vde. é o propietario.",
    ...
    "Participated" : "Participou",
    "All polls in which you participated." : "Todas as enquisas nas que Vde. participou.",
    "Openly accessible polls" : "Enquisas de libre acceso",
    "A complete list with all openly accessible polls on this site." : "Unha lista completa con todas as enquisas de libre acceso deste sitio.",
