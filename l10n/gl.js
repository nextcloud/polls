OC.L10N.register(
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "Emprégueos só, se é absolutamente necesario (p. ex., se o cron non funciona correctamente) ou para facer probas.",
    ...
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "A información da hora só amosa a última execución de traballo cron regular, non as execucións iniciadas manualmente.",
