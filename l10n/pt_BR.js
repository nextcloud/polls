OC.L10N.register(
    ...
    "Confirmation sent to {participant} ({emailAddress})" : "Confirmação enviada para {participant} ({emailAddress})",
    "Confirmation could not be sent to {participant} ({emailAddress})" : "Não foi possível enviar a confirmação para {participante} ({emailAddress})",
    "_Confirmations sent to {count} recipient_::_Confirmations sent to {count} recipients_" : ["Confirmações enviadas para {count} destinatários","Confirmações enviadas para {count} destinatários","Confirmações enviadas para {count} destinatários"],
    ...
    "Hide login option in public polls" : "Ocultar a opção de login em enquetes públicas",
