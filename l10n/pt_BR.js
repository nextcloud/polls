OC.L10N.register(
    ...
    "This are your polls (where you are the owner)." : "Estas são suas enquetes (onde você é o proprietário).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Todas essas enquetes são relevantes ou importantes porque você é um participante, proprietário ou convidado. Sem enquetes vencidas.",
    ...
    "These are all hidden polls, to which you have access." : "Essas são todas as enquetes ocultas às quais você tem acesso.",
    "This is simply the trash bin." : "Isso é simplesmente a lixeira.",
