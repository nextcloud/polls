OC.L10N.register(
    ...
    "Edit poll group" : "Editar grupo de enquetes",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduces your vote quota._" : ["%n voto órfão reduz sua cota de votos.","%n de votos órfãos reduzem sua cota de votos.","%n votos órfãos reduzem sua cota de votos."],
    ...
    "Choose a more meaningful title for the overview page" : "Escolha um título mais significativo para a página de visão geral",
    "Choose a description for the overview page" : "Escolha uma descrição para a página de visão geral",
    "Note: Changing the title, also changes the URL" : "Observação: A alteração do título também altera o URL",
    "Error updating PollGroup" : "Erro ao atualizar grupo de enquetes",
    ...
    "Use fixed table headers" : "Usar cabeçalhos de tabela fixos",
