OC.L10N.register(
    ...
    "Participants names are hidden, because this is an anoymous poll" : "Os nomes dos participantes estão ocultos, porque esta é uma enquete anônima",
    "The names of other participants is hidden, as this is a anonymous poll. " : "Os nomes dos outros participantes estão ocultos pois esta é uma enquete anônima.",
    "%n voters participated in this poll until now." : "%neleitores participaram desta enquete até agora. ",
    "Deleted" : "Excluído",
    "Group" : "Grupo",
    ...
    "Voting is no more possible, because this poll expired since %n" : "A votação não é mais possível, porque essa enquete expirou em %n",
