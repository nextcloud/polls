OC.L10N.register(
    ...
    "{user} invited you to take part in the poll \"{title}\"" : "{user} convidou você a participar da enquete \"{title}\"",
    ...
    "Delete this poll" : "Excluir esta enquete",
    ...
    "This user name can not be choosed." : "Este nome de usuário não pode ser escolhido.",
    "Error saving user name\"" : "Erro ao salvar nome de usuário\"",
    "there are no vote Options" : "não há opções de voto",
    "Click here to add a poll" : "Clique aqui para adicionar uma enquete",
    "Error loading polls\"" : "Erro carregando enquetes\"",
