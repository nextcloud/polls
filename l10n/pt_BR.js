OC.L10N.register(
    ...
    "{actor} has invited you to the poll \"%s\"." : "{actor} convidou você para a votação  \"%s\".",
    "%s took over your poll" : "%s assumiu sua enquete",
    "{actor} took over your poll \"%s\" and is the new owner." : "{actor} assumiu sua votação  \"%s\" e é o novo proprietário. ",
    ...
    "- The poll got closed." : "- A votação foi encerrada. ",
    ...
    "Results are visible since closing poll" : "Os resultados são visíveis desde o fechamento da enquete ",
