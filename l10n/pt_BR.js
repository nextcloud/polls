OC.L10N.register(
    ...
    "But be aware, that your name is not stored in an encrypted or obfuscated way." : "Mas lembre-se de que seu nome não é armazenado de forma criptografada ou ofuscada.",
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll admins." : "Esta enquete é anônima para todos, exceto para o proprietário e os administradores de enquete delegados.",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll admins." : "O anonimato dessa enquete pode ser removido a qualquer momento pelo proprietário e pelos administradores de enquete delegados.",
    ...
    "Once enabled the anonymous setting can not be reverted anymore." : "Uma vez ativada, a configuração anônima não poderá mais ser revertida.",
    ...
    "Deletion and changing votes of participants is not possible" : "Não é possível excluir ou alterar os votos dos participantes",
    ...
    "Error deleting pollStore." : "Erro ao excluir pollStore.",
    ...
    "This are all polls, where you are the owner." : "Todas essas são enquetes, nas quais você é o proprietário.",
