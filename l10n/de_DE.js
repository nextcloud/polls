OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "Die verwendete Zeitzone ist \"%s\". Um die Zeiten in Ihrer aktuellen Zeitzone anzuzeigen, öffnen Sie die Umfrage, indem Sie auf die Schaltfläche unten klicken.",
    ...
    "%s is the new owner of your poll." : "%s ist neuer Besitzer Ihrer Umfrage.",
    "{actor} transfered your poll \"%s\" to {newOwner}. You are no more the owner." : "{actor} hat Ihre Umfrage \"%s\" an {newOwner} übertragen. Sie sind nicht mehr der Besitzer.",
    ...
    "You have no access to this poll. Contact %s if you think this is a mistake." : "Sie haben keinen Zugang zu dieser Umfrage. Kontaktieren Sie %s, wenn Sie glauben, dass dies ein Fehler ist.",
    ...
    "You have restored a comment from poll {pollTitle}" : "Sie haben einen Kommentar zur Umfrage {pollTitle} wiederhergestellt",
    "{actor} has restored a comment from poll {pollTitle}" : "{actor} hat einen Kommentar zur Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have deleted option {optionTitle} from poll {pollTitle}" : "Sie haben die Option {optionTitle} aus der Umfrage {pollTitle} gelöscht",
    "{actor} has deleted option {optionTitle} from poll {pollTitle}" : "{actor} hat die Option {optionTitle} aus der Umfrage {pollTitle} gelöscht",
    ...
    "You have restored option {optionTitle} from poll {pollTitle}" : "Sie haben die Option {optionTitle} aus der Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have closed the poll \"{pollTitle}\"" : "Sie haben die Umfrage \"{pollTitle}\" geschlossen",
    "{actor} has closed the poll \"{pollTitle}\"" : "{actor} hat die Umfrage \"{pollTitle}\" geschlossen",
    "You have closed this poll" : "Sie haben diese Umfrage geschlossen",
    "{actor} has closed this poll" : "{actor} hat diese Umfrage geschlossen",
    "You have reopened the poll \"{pollTitle}\"" : "Sie haben die Umfrage \"{pollTitle}\" wiedereröffnet",
    "{actor} has reopened the poll \"{pollTitle}\"" : "{actor} hat die Umfrage \"{pollTitle}\" wieder geöffnet",
    "You have reopened this poll" : "Sie haben diese Umfrage wieder geöffnet",
    ...
    "{actor} has deleted your orphaned polls from poll {pollTitle}" : "{actor} hat Ihre verwaisten Umfragen aus der Umfrage {pollTitle} gelöscht",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Sie haben die Umfrage {pollTitle} mit dem Team {sharee} geteilt",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} hat die Umfrage {pollTitle} mit den Team {sharee} geteilt",
    "You have shared this poll with team {sharee}" : "Sie haben diese Umfrage mit dem Team {sharee} geteilt",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für das Team {sharee} der Umfrage {pollTitle} gelöscht",
    ...
    "You have deleted the share for team {sharee}" : "Sie haben die Freigabe für das Team {sharee} gelöscht",
    ...
    "You have restored the share for {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für {sharee} aus der Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have restored a public share from poll {pollTitle}" : "Sie haben eine öffentliche Freigabe aus der Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have restored the share for group {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für die Gruppe {sharee} in der Umfrage {pollTitle} wiederhergestellt",
    "{actor} has restored the share for group {sharee} from poll {pollTitle}" : "{actor} hat die Freigabe für die Gruppe {sharee} in der Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für das Team {sharee} der Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have restored the share for team {sharee}" : "Sie haben die Freigabe für das Team {sharee} wiederhergestellt",
    "{actor} has restored the share for team {sharee}" : "{actor} hat die Freigabe für das Team {sharee} wiederhergestellt",
    "You have restored the share for contact group {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für die Kontaktgruppe {sharee} in der Umfrage {pollTitle} wiederhergestellt",
    ...
    "You have restored a share from poll {pollTitle}" : "Sie haben eine Freigabe aus der Umfrage {pollTitle} wiederhergestellt",
    "{actor} has restored a share from poll {pollTitle}" : "{actor} hat eine Freigabe aus der Umfrage {pollTitle} wiederhergestellt",
    ...
    "Someone voted in a <strong>poll</strong>" : "Jemand hat in einer <strong>Umfrage</strong> abgestimmt",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduce your vote quota._" : ["%n verwaiste Stimme reduziert Ihre Stimmenquote.","%n verwaiste Stimmen reduzieren Ihre Stimmenquote."],
    ...
    "Use your timezone ({localTimezone})" : "Ihre Zeitzone verwenden ({localTimezone})",
    ...
    "You are not the owner of this poll. {owner} will get informed about this action." : "Sie sind nicht der Besitzer dieser Umfrage. {owner} wird über diese Aktion informiert.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "Sie sind nicht der Besitzer dieser Umfrage. {owner} wird über die Übertragung an {newUser} informiert.",
    ...
    "Sort by answers of this option" : "Nach Antworten zu dieser Option sortieren",
    ...
    "Archived poll" : "Archivierte Umfrage",
    ...
    "never" : "nie",
    "Poll owner: {ownerName}" : "Umfrage-Besitzer: {ownerName}",
    "Take over poll?" : "Umfrage übernehmen?",
    "You will become the new owner and {username} will get notified." : "Sie werden der neue Besitzer und {username} wird benachrichtigt.",
    ...
    "Forced display mode" : "Anzeigemodus erzwungen",
    ...
    "Your timezone: ({timezone})" : "Ihre Zeitzone: ({timezone})",
    ...
    "403 - You are not allowed to access this poll" : "403 – Sie dürfen nicht auf diese Umfrage zugreifen",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Oder [link]anmelden[/link], wenn Sie Mitglied dieser Seite sind.",
    ...
    "Participated" : "Teilgenommen",
    "All polls in which you participated." : "Alle Umfragen, an denen Sie teilgenommen haben.",
    ...
    "You can delete, archive and take over polls in this list, but access is still not possible." : "In dieser Liste können Sie Umfragen löschen, archivieren und übernehmen, ein Zugriff ist jedoch weiterhin nicht möglich."
},
