OC.L10N.register(
    ...
    "A voting option has been unconfirmed." : "Die Bestätigung einer Abstimmungsoption wurde zurückgezogen",
    ...
    "You commented poll {pollTitle}" : "Sie haben die Umfrage {pollTitle} kommentiert",
    "{actor} commented poll {pollTitle}" : "{actor} hat die Umfrage {pollTitle} kommentiert",
    "You deleted a commented from poll {pollTitle}" : "Sie haben einen Kommentar zur Umfrage {pollTitle} gelöscht",
    "{actor} deleted a commented from poll {pollTitle}" : "{actor} hat einen Kommentar zur Umfrage {pollTitle} gelöscht",
    "You added an option to poll {pollTitle}" : "Sie haben eine Option zur Umfrage {pollTitle} hinzugefügt",
    "{actor} added an option to poll {pollTitle}" : "{actor} hat eine Option zur Umfrage {pollTitle} hinzugefügt",
    "You changed an option of poll {pollTitle}" : "Sie haben eine Option der Umfrage {pollTitle} geändert",
    "{actor} changed an option of poll {pollTitle}" : "{actor} hat eine Option der Umfrage  {pollTitle} geändert",
    "You confirmed option {optionTitle} of poll {pollTitle}" : "Sie haben die Option {optionTitle} der Umfrage {pollTitle} bestätigt",
    "{actor} confirmed option {optionTitle} of poll {pollTitle}" : "{actor} hat die Option {optionTitle} der Umfrage {pollTitle} bestätigt",
    "You unconfirmed option {optionTitle} of poll {pollTitle}" : "Sie haben die Option {optionTitle} der Umfrage {pollTitle} abgelehnt",
    "{actor} unconfirmed option {optionTitle} of poll {pollTitle}" : "{actor} hat die Option {optionTitle} der Umfrage {pollTitle} abgelehnt",
    "You removed option {optionTitle} from poll {pollTitle}" : "Sie haben die Option {optionTitle} der Umfrage {pollTitle} gelöscht",
    "{actor} removed option {optionTitle} from poll {pollTitle}" : "{actor} hat die Option {optionTitle} der Umfrage {pollTitle} gelöscht",
    "You added poll {pollTitle}" : "Sie haben die Umfrage {pollTitle} hinzugefügt",
    "{actor} added poll {pollTitle}" : "{actor} hat die Umfrage {pollTitle} hinzugefügt",
    "You changed the configuration of poll {pollTitle}" : "Sie haben die Einstellungen der Umfrage {pollTitle} geändert",
    "{actor} changed the configuration of poll {pollTitle}" : "{actor} hat die Umfrage {pollTitle} geändert",
    "You archived poll {pollTitle}" : "Sie haben die Umfrage {pollTitle} archiviert",
    "{actor} archived poll {pollTitle}" : "{actor} hat die Umfrage {pollTitle} archiviert",
    "You restored poll {pollTitle}" : "Sie haben die Umfrage {pollTitle} wiederhergestellt",
    "{actor} restored poll {pollTitle}" : "{actor} hat die Umfrage {pollTitle} wiederhergestellt",
    "Poll {pollTitle} was closed" : "Die Umfrage {pollTitle} wurde geschlossen",
    "You changed the owner of poll {pollTitle}" : "Sie haben den Besitzer der Umfrage {pollTitle} geändert",
    "{actor} changed the owner of poll {pollTitle}" : "{actor} hat den Besitzer der Umfrage {pollTitle} geändert",
    "You reordered the options of poll {pollTitle}" : "Sie haben die Optionen der Umfrage {pollTitle} neu sortiert",
    "{actor} reordered the options of poll {pollTitle}" : "{actor} hat die Optionen der Umfrage {pollTitle} neu sortiert",
    "You added a public share to poll {pollTitle}" : "Sie haben eine öffentliche Freigabe der Umfrage {pollTitle} hinzugefügt",
    "{actor} added a public share to poll {pollTitle}" : "{actor} hat eine öffentliche Freigabe zur Umfrage {pollTitle} hinzugefügt",
    "You shared poll {pollTitle} with group {sharee}" : "Sie haben die Umfrage  {pollTitle} mit der Gruppe {sharee} geteilt",
    "{actor} You shared poll {pollTitle} with group {sharee}" : "{actor} Sie hat die Umfrage {pollTitle} mit der Gruppe {sharee} geteilt",
    "You shared poll {pollTitle} with circle {sharee}" : "Sie haben die Umfrage  {pollTitle} mit dem Kreis {sharee} geteilt",
    "{actor} shared poll {pollTitle} with circle {sharee}" : "{actor} hat die Umfrage {pollTitle} mit dem Kreis {sharee} geteilt",
    "You shared poll {pollTitle} with contact group {sharee}" : "Sie haben die Umfrage  {pollTitle} mit der Kontakt-Gruppe {sharee} geteilt",
    "{actor} shared poll {pollTitle} with contact group {sharee}" : "{actor} hat die Umfrage {pollTitle} mit der Kontakt-Gruppe {sharee} geteilt",
    "You shared poll {pollTitle} with {sharee}" : "Sie haben die Umfrage {pollTitle} mit {sharee} geteilt",
    "{actor} shared poll {pollTitle} with {sharee}" : "{actor} hat die Umfrage {pollTitle} mit {sharee} geteilt",
    "You changed your email address" : "Sie haben Ihre E-Mail-Adresse geändert",
    "{actor} changed his email address" : "{actor} hat seine E-Mail-Adresse geändert",
    "You changed the share type" : "Sie haben den Freigabe-Typ geändert",
    "{actor} changed the share type" : "{actor} hat den Freigabe-Typ geändert",
    "You changed the registration constraints for share {sharee}" : "Sie haben die Registrierungsbeschränkungen für die Freigabe  {sharee} geändert",
    "{actor} changed the registration constraints for share {sharee}" : "{actor} hat die Registrierungsbeschränkungen für die Freigabe  {sharee} geändert ",
    "You registered to poll {pollTitle}" : "Sie haben sich für die Umfrage {pollTitle} registriert",
    "{sharee} registered to poll {pollTitle}" : "{sharee} hat sich für die Umfrage {pollTitle} registriert",
    "You deleted a public share from poll {pollTitle}" : "Sie haben eine öffentliche Freigabe der Umfrage {pollTitle} gelöscht",
    "{actor} deleted a public share from poll {pollTitle}" : "{actor} hat eine öffentliche Freigabe der Umfrage {pollTitle} gelöscht",
    "You deleted the share for group {sharee} from poll {pollTitle}" : "Sie haben eine Freigabe für die Gruppe {sharee} der Umfrage {pollTitle} gelöscht",
    "{actor} deleted the share for group {sharee} from poll {pollTitle}" : "{actor} hat eine Freigabe für die Gruppe {sharee} der Umfrage {pollTitle} gelöscht",
    "You deleted the share for {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für {sharee} der Umfrage {pollTitle} gelöscht",
    "{actor} deleted the share for {sharee} from poll {pollTitle}" : "{actor} hat die Freigabe für {sharee} der Umfrage {pollTitle} gelöscht",
    "You deleted the share for circle {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für den Kreis {sharee} der Umfrage {pollTitle} gelöscht",
    "{actor} deleted the share for circle {sharee} from poll {pollTitle}" : "{actor} hat die Freigabe für den Kreis {sharee} der Umfrage {pollTitle} gelöscht",
    "You deleted the share for contact group {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für die Kontakt-Gruppe {sharee} der Umfrage {pollTitle} gelöscht",
    "{actor} deleted the share for contact group {sharee} from poll {pollTitle}" : "{actor} hat die Freigabe für die Kontakt-Gruppe {sharee} der Umfrage {pollTitle} gelöscht",
    "You deleted a share from poll {pollTitle}" : "Sie haben eine Freigabe der Umfrage {pollTitle} gelöscht",
    "{actor} deleted a share from poll {pollTitle}" : "{actor} hat eine Freigabe der Umfrage {pollTitle} gelöscht",
    "You voted in poll {pollTitle}" : "Sie haben in der Umfrage {pollTitle} abgestimmt",
    "{actor} voted in poll {pollTitle}" : "{actor} hat in der Umfrage {pollTitle} abgestimmt",
    "You did something indescribable with poll {pollTitle}" : "Sie haben mit der Umfrage {pollTitle} etwas Unbeschreibliches getan",
    "{actor} did something indescribable with poll {pollTitle}" : "{actor} hat mit der Umfrage {pollTitle} etwas Unbeschreibliches getan",
    "You commented" : "Sie haben kommentiert",
    "{actor} commented" : "{actor} khat kommentiert",
    "You deleted a commented" : "Sie haben einen Kommentar gelöscht",
    "{actor} deleted a commented" : "{actor} hat einen Kommentar gelöscht",
    "You added an option" : "Sie haben eine Option hinzugefügt",
    "{actor} added an option" : "{actor} hat eine Option hinzugefügt",
    "You changed an option" : "Sie haben eine Option geändert",
    "{actor} changed an option" : "{actor} hat eine Option geändert",
    "You confirmed option {optionTitle}" : "Sie haben die Option {optionTitle} bestätigt",
    "{actor} confirmed option {optionTitle}" : "{actor} hat die Option {optionTitle} bestätigt",
    "You unconfirmed option {optionTitle}" : "Sie haben die Option {optionTitle} abgelehnt",
    "{actor} unconfirmed option {optionTitle}" : "{actor} hat die Option {optionTitle} abgelehnt",
    "You removed option {optionTitle}" : "Sie haben die Option {optionTitle} gelöscht",
    "{actor} removed option {optionTitle}" : "{actor} hat die Option {optionTitle} gelöscht",
    "You created this poll" : "Sie haben diese Umfrage erstellt",
    "{actor} created this poll" : "{actor} hat diese Umfrage erstellt",
    "You changed the configuration" : "Sie haben die Einstellungen geändert",
    "{actor} changed the configuration" : "{actor} hat die Einstellungen geändert",
    "You archived this poll" : "Sie haben diese Umfrage archiviert",
    "{actor} archived this poll" : "{actor} hat diese Umfrage archiviert",
    "You restored this poll" : "Sie haben diese Umfrage wiederhergestellt",
    "{actor} restored this poll" : "{actor} hat diese Umfrage wiederhergestellt",
    "This poll was closed" : "Diese Umfrage wurde geschlossen.",
    "You changed the poll owner" : "Sie haben den Besitzer der Umfrage geändert",
    "{actor} changed the poll owner" : "{actor} hat den Besitzer der Umfrage geändert",
    "You reordered the options" : "Sie haben die Optionen neu sortiert",
    "{actor} reordered the options" : "{actor} hat die Optionen neu sortiert",
    "You added a public share" : "Sie haben eine öffentliche Freigabe hinzugefügt",
    "{actor} added a public share" : "{actor} hat eine öffentliche Freigabe hinzugefügt",
    "You shared this poll with group {sharee}" : "Sie haben diese Umfrage mit der Gruppe {sharee} geteilt",
    "{actor} You shared this poll with group {sharee}" : "{actor} Sie haben diese Umfrage mit der Gruppe {sharee} geteilt",
    "You shared this poll with circle {sharee}" : "Sie haben diese Umfrage mit dem Kreis {sharee} geteilt",
    "{actor} shared this poll with circle {sharee}" : "{actor} hat diese Umfrage mit dem Kreis {sharee} geteilt",
    "You shared this poll with contact group {sharee}" : "Sie haben diese Umfrage mit der Kontakt-Gruppe {sharee} geteilt",
    "{actor} shared this poll with contact group {sharee}" : "{actor} hat diese Umfrage mit dem Kontakt-Gruppe {sharee} geteilt",
    "You shared this poll with {sharee}" : "Sie haben diese Umfrage mit {sharee} geteilt",
    "{actor} shared this poll with {sharee}" : "{actor} hat diese Umfrage mit {sharee} geteilt",
    "{actor}'s email address was changed" : "{actor}s E-Mail Adresse wurde geändert",
    "You registered" : "Sie haben sich registriert",
    "{sharee} registered" : "{sharee} hat sich registriert",
    "You deleted a public share" : "Sie haben eine öffentliche Freigabe gelöscht",
    "{actor} deleted a public share" : "{actor} hat eine öffentliche Freigabe gelöscht",
    "You deleted the share for group {sharee}" : "Sie haben die Freigabe für die Gruppe {sharee} gelöscht",
    "{actor} deleted the share for group {sharee}" : "{actor} hat die Freigabe für die Gruppe {sharee} gelöscht",
    "You deleted the share for circle {sharee}" : "Sie haben die Freigabe für den Kreis {sharee} gelöscht",
    "{actor} deleted the share for circle {sharee}" : "{actor} hat die Freigabe für den Kreis {sharee} gelöscht",
    "You deleted the share for contact group {sharee}" : "Sie haben die Freigabe für die Kontakt-Gruppe {sharee} gelöscht",
    "{actor} deleted the share for contact group {sharee}" : "{actor} hat die Freigabe für die kontakt-Gruppe {sharee} gelöscht",
    "You deleted {sharee}'s share" : "Sie haben die Freigabe von {sharee} gelöscht",
    "{actor} deleted a share" : "{actor} hat ein Freigabe gelöscht",
    "You voted" : "Sie haben abgestimmt",
    "{actor} voted" : "{actor} hat abgestimmt",
    "You did something indescribable with this poll" : "Sie haben mit der Umfrage etwas Unbeschreibliches getan",
    "{actor} did something indescribable with this poll" : "{actor} hat mit der Umfrage etwas Unbeschreibliches getan",
    "Events happening inside of a <strong>poll</strong>" : "Ereignisse, die innerhalb einer <strong>Umfrage</strong> stattfinden",
    "Someone votes inside a <strong>poll</strong>" : "Jemand stimmt in einer <strong>Umfrage</strong> ab",
