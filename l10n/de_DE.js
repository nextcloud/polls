OC.L10N.register(
    ...
    "You have reordered the options of poll {pollTitle}" : "Sie haben die Optionen der Umfrage {pollTitle} neu sortiert",
    "{actor} has reordered the options of poll {pollTitle}" : "{actor} hat die Optionen der Umfrage {pollTitle} neu sortiert",
    ...
    "You have deleted the share for {sharee} from poll {pollTitle}" : "Sie haben eine Freigabe für die Gruppe {sharee} der Umfrage {pollTitle} gelöscht",
    ...
    "{actor} has did something indescribable with poll {pollTitle}" : "{actor} hat mit der Umfrage {pollTitle} etwas Unbeschreibliches getan",
    ...
    "{actor} has shared this poll with contact group {sharee}" : "{actor} hat diese Umfrage mit dem Kontakt-Gruppe {sharee} geteilt",
    ...
    "{sharee}'s email address has been changed" : "E-Mail-Adresse von {sharee} wurde geändert",
    ...
    "You have deleted {sharee}'s share" : "Sie haben die Freigabe von {sharee} gelöscht",
