OC.L10N.register(
    ...
    "Expired polls" : "Abgelaufen Umfragen",
    ...
    "This are your polls (where you are the owner)." : "Dies sind Ihre Umfragen (deren Eigentümer Sie sind).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Dies sind alles Umfragen, die für Sie relevant oder wichtig sind, weil Sie Teilnehmer oder Eigentümer sind oder zu denen Sie eingeladen wurden. Ohne abgelaufene Umfragen.",
    ...
    "These are all hidden polls, to which you have access." : "Dies sind alles versteckte Umfragen, auf die Sie Zugriff haben.",
    "This is simply the trash bin." : "DIes ist der Papierkorb.",
    "All polls, where you placed a vote." : "Alle Umfragen, in denen Sie abgestimmt haben",
