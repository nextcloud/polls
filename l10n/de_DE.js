OC.L10N.register(
    ...
    "%s is the new owner of your poll. " : "%s ist der neue Besitzer Ihrer Umfrage.",
    ...
    "You have reopened the poll \"{pollTitle}\" " : "Sie haben die Umfrage \"{pollTitle}\" wieder geöffnet",
    ...
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access." : "Eine Umfragen-App ähnlich wie Doodle/DuD, mit der Möglichkeit Zugriffe zu beschränken.",
    ...
    "Edit poll group" : "Umfragegruppe bearbeiten",
    ...
    "Choose a more meaningful title for the overview page" : "Einen aussagekräftigeren Titel für die Übersichtsseite wählen",
    "Choose a description for the overview page" : "Eine Beschreibung für die Übersichtsseite wählen",
    "Note: Changing the title, also changes the URL" : "Hinweis: Durch das Ändern des Titels wird auch die URL geändert",
    "Error updating PollGroup" : "Fehler beim Aktualisieren der Umfragegruppe",
    ...
    "Use fixed table headers" : "Feste Tabellenüberschriften verwenden",
    ...
    "Type to start searching ..." : "Geben Sie etwas ein, um die Suche zu starten …",
    ...
    "Group without title" : "Gruppe ohne Titel",
    ...
    "Group without description" : "Gruppe ohne Beschreibung",
