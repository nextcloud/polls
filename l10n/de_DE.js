OC.L10N.register(
    ...
    "But be aware, that your name is not stored in an encrypted or obfuscated way." : "Bitte beachten, dass Ihr Name weder verschlüsselt noch pseudonymisiert gespeichert wird.",
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll admins." : "Diese Umfrage ist für alle anonym, mit Ausnahme des Eigentümers und der delegierten Umfrageadministration.",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll admins." : "Die Anonymisierung dieser Umfrage kann jederzeit vom Eigentümer und der beauftragten Umfrageadministration aufgehoben werden.",
    ...
    "Once enabled the anonymous setting can not be reverted anymore." : "Nach der Aktivierung kann die anonyme Einstellung nicht mehr rückgängig gemacht werden.",
    ...
    "Error taking over poll." : "Fehler bei der Übernahme der Umfrage",
    ...
    "If you use different legal terms and privacy policy for public polls, enter the links below. Leave empty to use your default terms." : "Wenn Sie für öffentliche Umfragen ein anderes Impressum und eine andere Datenschutzerklärung verwenden, geben Sie unten entsprechende Links ein. Lassen Sie das Feld leer, um Ihre Standardbedingungen zu verwenden.",
    ...
    "Deletion and changing votes of participants is not possible" : "Das Löschen und Ändern von Stimmen der Teilnehmer ist nicht möglich",
    ...
    "Use alternative option add dialog" : "Den alternativen Dialog zum Hinzufügen einer Option verwenden",
    "Arrange description and card hints side by side" : "Beschreibung und Kartenhinweise nebeneinander anordnen",
    ...
    "Error deleting pollStore." : "Fehler beim Löschen des pollStores.",
    ...
    "This are all polls, where you are the owner." : "Umfragen, deren Eigentümer Sie sind.",
