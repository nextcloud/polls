OC.L10N.register(
    ...
    "You have restored the share for circle {sharee} from poll {pollTitle}" : "Sie haben die Freigabe für den Kreis {sharee} in der Umfrage {pollTitle} wiederhergestellt",
    ...
    "Error {action} poll." : "Fehler beim {action} der Umfrage.",
    ...
    "This will finally delete the poll and {username} will get notified." : "Dies wird die Umfrage endgültig löschen und {username} wird informiert.",
    "This will finally delete the poll." : "Dies wird die Umfrage endgültig löschen.",
    "OK" : "OK",
    ...
    "Days after which archived polls should be finally deleted" : "Tage, nach denen archivierte Umfragen endgültig gelöscht werden sollen",
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "Diese nur verwenden, wenn es unbedingt notwendig ist (z. B. wenn Ihr Cron nicht richtig funktioniert) oder zu Testzwecken.",
    ...
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "Die Zeitinformationen zeigen nur den letzten regulären Cron-Job-Lauf an, nicht die manuell gestarteten Läufe.",
    ...
    "Use the default terms for public polls and enable the default footer" : "Standardbedingungen für öffentliche Umfragen verwenden und die Standardfußzeile aktivieren",
    ...
    "Relevant" : "Relevant",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Umfragen, die für Sie relevant sind, weil Sie Teilnehmer, Besitzer oder eingeladen sind. Es werden nur Umfragen angezeigt, die Bezüglich der Erstellung, letzten Interaktion, Ablauf oder neuesten Option (bei Datumsumfragen), nicht älter als 100 Tage sind.",
