OC.L10N.register(
    ...
    "Public share" : "公開共有",
    "You added %n." : "%nを追加しました。",
    "Error while adding share" : "共有の追加中にエラーが発生しました",
    "Add a new text option" : "新しいテキスト選択肢を追加",
    "Enter option text and press Enter" : "選択肢を入力してEnterを押してください",
    "Receive notification email on activity" : "アクティビティに関して通知メールを受け取る",
    "Deleted" : "削除済み",
    "Enter a valid username, to participate in this poll." : "この投票に参加するには、有効なユーザー名を入力してください。",
    "Enter a valid username with at least 3 Characters" : "3文字以上の有効なユーザー名を入力してください",
    "You will be redirected to your personal share." : "あなたの個人的な共有にリダイレクトされます。",
    "If you are not redirected to your poll click this link:" : "投票にリダイレクトされない場合は、このリンクをクリックしてください：",
    ...
    "there are no vote Options" : "投票の選択肢がありません",
