OC.L10N.register(
    ...
    "This poll is closed." : "この投票は終了しました。",
    "You have no votes left." : "投票数は残っていません。",
    "Limited votes." : "投票数は制限されています。",
    "Messages sent." : "メッセージが送信されました。",
    ...
    "deleted" : "削除しました",
    "For date polls without expiration" : "有効期限のない日付の投票の場合",
    ...
    "Error exporting file." : "ファイルのエクスポート中にエラーが発生しました。",
    ...
    "This will finally delete the poll." : "これにより、最終的にアンケートが削除されます。",
    "OK" : "OK",
    ...
    "Back" : "戻る",
    "Take over" : "引き継ぐ",
    "Transfer poll ownership" : "投票の所有権を譲渡する",
    ...
    "No answer" : "回答なし",
    "Click to sort by name" : "名前で並べ替えるにはクリックしてください",
    "Other settings" : "他の設定",
    "Performance settings" : "パフォーマンス設定",
    "Email options" : "メールのオプション",
    "Combined polls" : "組み合わせ投票",
    "No polls selected" : "投票が選択されていません",
    "No polls found for this category" : "このカテゴリの投票は見つかりませんでした",
    "Relevant polls" : "関連する投票",
    "Navigation" : "ナビゲーション",
    "Show all" : "全て表示",
    "Combine polls" : "投票を組み合わせる",
    "Polls settings" : "投票設定",
