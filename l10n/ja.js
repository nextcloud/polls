OC.L10N.register(
    ...
    "Copy to clipboard: Ctrl+C, Enter" : "クリップボードにコピー：Ctrl + C、Enter",
    ...
    "Anonymous poll" : "匿名投票",
    "Hide user names for admin" : "管理者にユーザ名を隠す",
    "Expires" : "有効期限",
    "Access" : "アクセス",
    "Registered users only" : "登録ユーザのみ",
    "hidden" : "非公開",
    ...
    "Usernames hidden to Owner" : "オーナーに見えないユーザ名",
    "Usernames visible to Owner" : "オーナーに見えるユーザ名",
    "Group" : "グループ",
    "Share with" : "と共有",
