OC.L10N.register(
    ...
    "Hide results until poll is expired" : "投票の期限まで結果を非表示",
    ...
    "To participate, enter a username with at least 3 characters." : "参加するには少なくとも3文字以上のユーザ名を入力してください。",
    "Enter your name" : "あなたの名前を入力",
    "Username is not valid. Please enter at least 3 characters." : "有効なユーザー名ではありません。少なくとも3文字以上入力してください。",
    "This username is not valid, i.e. because it is already in use." : "このユーザー名は既に存在するため、ユーザー名が無効です",
    "Valid username." : "正当なユーザー名",
    ...
    "Hidden polls" : "非公開の投票",
    "My deleted polls" : "私の削除済み投票",
    "Participated by me" : "私が参加した",
    "Your polls (where you are the owner)." : "あなたの投票（あなたがオーナー）",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "期限切れを除いたあなたに関連性のあるまたは重要な全ての投票です。判断基準はあなたが参加・所有・招待された投票です。",
    ...
    "Polls which reached their expiry date." : "期限日に達した投票",
    ...
    "There are no vote options. Maybe the owner did not provide some until now." : "投票の選択肢がありません。所有者がまだ提供していない可能性があります。",
