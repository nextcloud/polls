OC.L10N.register(
    ...
    "A hidden poll from {name}" : "Μια κρυφή δημοσκόπηση από τον/την {name}",
    "A public poll from {name}" : "Μια δημόσια δημοσκόπηση από τον/την {name}",
    ...
    "This is an open poll" : "Αυτή είναι μια ανοιχτή δημοσκόπηση",
