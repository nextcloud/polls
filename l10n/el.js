OC.L10N.register(
    ...
    "Number of items to create:" : "Αριθμός στοιχείων προς δημιουργία:",
    "OK" : "Εντάξει",
    "Week" : "Εβδομάδα",
    ...
    "After how many days are the closed polls to be archived:" : "Μετά από πόσες ημέρες θα αρχειοθετηθούν οι κλειστές δημοσκοπήσεις:",
    ...
    "Allow creating open polls for the following groups" : "Να επιτρέπεται η δημιουργία ανοιχτών δημοσκοπήσεων για τις ακόλουθες ομάδες",
    ...
    "The style settings are still experimental!" : "Οι ρυθμίσεις στυλ να είναι πειραματικές!",
    "Adopt dashboard style" : "Υιοθέτησε το στυλ του Πίνακα ελέγχου",
    "Set individual styles" : "Ορίστε μεμονωμένα στυλ",
    "Use background color" : "Χρησιμοποιήστε χρώμα φόντου",
    ...
    "Access for all users of this site is disabled" : "Η πρόσβαση για όλους τους χρήστες αυτού του ιστότοπου είναι απενεργοποιημένη ",
    "Access for all users of this site is enabled" : "Η πρόσβαση για όλους τους χρήστες αυτού του ιστότοπου είναι ενεργοποιημένη",
    ...
    "Due to performance concerns {countHiddenParticipants} voters are hidden." : "Λόγω πιθανόν προβλημάτων σχετικά με την απόδοση {countHiddenParticipants} συμμετέχοντες δεν εμφανίζονται.",
    ...
    "Additionally the owner can remove the anonymous flag at any time, which will reveal the participant's names." : "Επιπλέον, ο κάτοχος μπορεί να απενεργοποιήσει την ανωνυμία σημαία ανά πάσα στιγμή, γεγονός που θα αποκαλύψει τα ονόματα των συμμετεχόντων.",
    "Minute" : "Λεπτά",
    "Hour" : "Ώρα",
    "Day" : "Ημέρα",
    "Month" : "Μήνας",
