OC.L10N.register(
    ...
    "This link gives you personal access to the poll named above. </br> Press the button above or copy the following link and add it in your browser's location bar: " : "Ο σύνδεσμος σας δίνει πρόσβαση στην παρακάτω δημοσκόπηση. </br> Πιέστε το κουμπί παρακάτω ή αντιγράψτε τον σύνδεσμο στον περιηγητή σας:",
