OC.L10N.register(
    "polls",
    {
    "Nothing selected!\nClick on cells to turn them green." : "Τίποτα δεν έχει επιλεγεί. Κλικάρετε τα κελιά ώστε να γίνουν πράσινα",
    "You must enter at least a title for the new poll." : "Πρέπει να βάλετε τουλάχιστον έναν τίτλο για την νέα ψηφοφορία",
    "Please select at least one user or group!" : "Παρακαλώ επιλέξτε τουλάχιστον έναν χρήστη ή ομάδα!",
    "Copied!" : "Αντιγράφηκε!",
    "Copy" : "Αντιγραφή",
