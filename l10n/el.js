OC.L10N.register(
    ...
    "Voting is no more possible, because this poll expired since %n. " : "Δεν μπορείτε να ψηφίσετε πλέον, η δημοσκόπηση έληξε στις %n.",
    "Comments" : "Σχόλια",
    ...
    "Delete poll permanently as admin" : "Διαγραφή ψηφοφορίας οριστικά ως διαχειριστής",
    ...
    "To participate, enter a username with at least 3 characters." : "Για συμμετοχή, χρειάζεται όνομα χρήστη με τουλάχιστο 3 χαρακτήρες.",
    ...
    "This are your polls (where you are the owner)." : "Οι δημοσκοπήσεις σας (όπου είστε κάτοχος)",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Αυτές είναι όλες οι δημοσκοπήσεις που είναι σχετικές ή σημαντικές για εσάς, επειδή είστε συμμετέχων ή κάτοχος ή έχετε προσκληθεί. Δημοσκοπήσεις χωρίς λήξη.",
    ...
    "These are all hidden polls, to which you have access." : "Κρυφές δημοσκοπήσεις, στις οποίες έχετε πρόσβαση.",
    "This is simply the trash bin." : "Αυτό είναι απλά ο κάδος.",
