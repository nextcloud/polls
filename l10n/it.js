OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "Il fuso orario utilizzato è\"%s\". Per visualizzare gli orari nel tuo fuso orario attuale, partecipa al sondaggio cliccando sul pulsante qui sotto.",
    ...
    "This poll does not exist (anymore)." : "Questo sondaggio non esiste (più).",
    "No one." : "Nessuno.",
    "Access denied" : "Accesso negato",
    "You have no access to this poll. Contact %s if you think this is a mistake." : "Non hai accesso a questo sondaggio. Contatta %s se pensi che questo sia un errore.",
    ...
    "One or more orphaned votes heve been deleted from {pollTitle}" : "Uno o più voti orfani sono stati eliminati da {pollTitle}",
    "{actor} has deleted your orphaned polls from poll {pollTitle}" : "{actor} ha eliminato i tuoi sondaggi orfani dal sondaggio {pollTitle}",
    "Orphaned votes deleted" : "Voti orfani eliminati",
    "{actor} deleted orphaned votes" : "{actor} ha eliminato voti orfani",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Hai condiviso il sondaggio {pollTitle} con il team {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor}ha condiviso il sondaggio {pollTitle}con il team {sharee}",
    "You have shared this poll with team {sharee}" : "Hai condiviso questo sondaggio con il team {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} ha condiviso questo sondaggio con il team {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Hai eliminato la condivisione per il team {sharee}dal sondaggio {pollTitle}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor}ha eliminato la condivisione per il team {sharee} dal sondaggio {pollTitle}",
    "You have deleted the share for team {sharee}" : "Hai eliminato la condivisione per il team {sharee}",
    "{actor} has deleted the share for team {sharee}" : "{actor}ha eliminato la condivisione per il team {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Hai ripristinato la condivisione per il team {sharee}dal sondaggio {pollTitle}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} ha ripristinato la condivisione per il team {sharee} dal sondaggio{pollTitle}",
    "You have restored the share for team {sharee}" : "Hai ripristinato la condivisione per il team {sharee}",
    "{actor} has restored the share for team {sharee}" : "{actor} ha ripristinato la condivisione per il team {sharee}",
    ...
    "plus" : "+",
    "Please wait…" : "Attendi...",
    "Possibly affected calendar events" : "Calendario potenzialmente interessato da eventi",
    "Add" : "Aggiungi",
    ...
    "Select timezone to apply" : "Seleziona il fuso orario da applicare",
    "Use original timezone ({pollTimezone})" : "Utilizza il fuso orario originale ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Usa il tuo fuso orario ({localTimezone})",
    ...
    "Allow download of poll results" : "Consenti il ​​download dei risultati del sondaggio",
    ...
    "Error restoring poll." : "Errore durante il ripristino del sondaggio.",
    "Error archiving poll." : "Errore durante l'archiviazione del sondaggio.",
    "Restore poll" : "Ripristina sondaggio",
    "Archive poll" : "Archivio sondaggio",
    "Delete poll" : "Elimina sondaggio",
    "Transfer poll" : "Trasferimento del sondaggio",
    ...
    "User preference" : "Preferenze dell'utente",
    "Table view" : "Vista della tabella",
    ...
    "Use explicit \"No\" votes" : "Utilizzare voti \"No\" espliciti",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Ciò eliminerà irreversibilmente il sondaggio e {username} verrà avvisato.",
    "This will irreversibly delete the poll." : "Ciò eliminerà definitivamente il sondaggio.",
    "OK" : "OK",
    ...
    "Transfered poll to {user}." : "Sondaggio trasferito a {user}.",
    "Error transfering poll." : "Errore durante il trasferimento del sondaggio.",
    "Transfering a poll to another user may result in loss of access to this poll." : "Il trasferimento di un sondaggio a un altro utente potrebbe comportare la perdita dell'accesso al sondaggio stesso.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "Trasferendo un sondaggio a {user} potrebbe comportare la perdita dell'accesso a questo sondaggio.",
    "You are not the owner of this poll. {owner} will get informed about this action." : "Non sei il proprietario di questo sondaggio. {owner} verrà informato di questa azione.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "Non sei il proprietario di questo sondaggio. {owner} verrà informato del trasferimento a {newUser}.",
    ...
    "Sort by answers of this option" : "Ordina per risposte di questa opzione",
    "Expand options" : "Espandi le opzioni",
    ...
    "Submit" : "Invia",
    "_%n repetition_::_Last of %n repetitions_" : ["%n ripetizione","Ultimo di %n ripetizioni","Ultimo di %n ripetizioni"],
    ...
    "Poll information" : "Informazioni sul sondaggio",
    "Archived" : "Archiviati",
    ...
    "Created {dateTime}" : "Creato {dateTime}",
    "Created {dateRelative}" : "Creato il {dateRelative}",
    "Closing: {dateTime}" : "Chiusura: {dateTime}",
    "Closing: {dateRelative}" : "Chiuderà il: {dateRelative}",
    "Current timezone: {timezoneString}" : "Fuso orario attuale: {timezoneString}",
    "Original timezone: {timezoneString}" : "Fuso orario originale: {timezoneString}",
    ...
    "Error updating poll group" : "Errore durante l'aggiornamento del gruppo di sondaggi",
    "Extended title" : "Titolo esteso",
    "Description" : "Descrizione",
    "Expired {dateTime}" : "Scaduto {dateTime}",
    "Last activity {dateTime}" : "Ultima attività {dateTime}",
    ...
    "Private poll, only invited participants have access" : "Sondaggio privato, solo i partecipanti invitati hanno accesso",
    "Open poll, accessible to all users of this instance and invited participants" : "Sondaggio aperto, accessibile a tutti gli utenti di questa istanza e ai partecipanti invitati",
    "{count} participants" : "{count} participanti",
    "Open poll, accessible to all users of this instance" : "Sondaggio aperto, accessibile a tutti gli utenti di questa istanza",
    "You have been granted administrative rights" : "Ti sono stati concessi diritti amministrativi",
    "You participated" : "Hai partecipato",
    "never" : "mai",
    "Poll owner: {ownerName}" : "Proprietario del sondaggio: {ownerName}",
    ...
    "The poll group was deleted by removing the last member." : "Il gruppo del sondaggio è stato eliminato rimuovendo l'ultimo membro.",
    "Error removing poll from group." : "Errore durante la rimozione del sondaggio dal gruppo.",
    "Error creating new poll group." : "Errore durante la creazione del nuovo gruppo di sondaggio.",
    ...
    "Back" : "Indietro",
    "Take over" : "Rileva",
    "Transfer poll ownership" : "Trasferisci la proprietà del sondaggio",
    ...
    "Register to this poll" : "Registrati a questo sondaggio",
    ...
    "Days after which archived polls should be permanently deleted" : "Giorni dopo i quali i sondaggi archiviati devono essere eliminati definitivamente",
    ...
    "Sends out pending automatic reminders." : "Invia promemoria automatici in sospeso.",
    "Cleans up old or irrelevant data from the system to maintain optimal performance and organization." : "Elimina i dati vecchi o irrilevanti dal sistema per mantenere prestazioni e organizzazione ottimali.",
    "Sends out pending notifications about poll updates." : "Invia notifiche in sospeso sugli aggiornamenti del sondaggio.",
    "Description is missing." : "Manca la descrizione.",
    "Execution failed" : "Esecuzione fallita",
    "The last execution of this job has failed. Please check the logs for more details." : "L'ultima esecuzione di questo processo non è riuscita. Per maggiori dettagli, consultare i log.",
    "Not run yet" : "Non ancora avviato",
    "This job has never been run yet." : "Questo job non è mai stato avviato.",
    "{jobName} has been executed." : "{jobName} è stato eseguito.",
    "Start {jobName} manually." : "Avvia {jobName} manualmente.",
    "{jobName} does not support manually run." : "{jobName} non supporta l'avvio manuale.",
    "Request Execution" : "Richiesta di esecuzione",
    "Request job execution" : "Richiedi l'esecuzione del job",
    ...
    "Use the default terms for public polls" : "Utilizzare i termini predefiniti per i sondaggi pubblici",
    ...
    "Privacy policy link:" : "Collegamento all'informativa privacy:",
    ...
    "Resolve contact group first!" : "Risolvi prima il gruppo di contatto!",
    "Resolve this team first!" : "Risolvi prima questo team!",
    ...
    "Grant administrative poll access" : "Concedi l'accesso amministrativo al sondaggio ",
    "Withdraw administrative poll access" : "Ritirare l'accesso amministrativo al sondaggio ",
    ...
    "Error sending invitations" : "Errore durante l'invio degli inviti",
    ...
    "Forced display mode" : "Modalità di visualizzazione forzata",
    "Set default timezone for this poll" : "Imposta il fuso orario predefinito per questo sondaggio",
    "Deletion and owner" : "Eliminazione e proprietario",
    ...
    "Shares for a poll group grant voting access to the polls contained in the poll group." : "Condivisioni per un gruppo di sondaggio garantiscono l'accesso al voto nei sondaggi contenuti nel gruppo del sondaggio.",
    ...
    "Your timezone: ({timezone})" : "Il tuo fuso orario: ({timezone})",
    "Poll timezone: ({timezone})" : "Fuso orario del sondaggio: ({timezone})",
    ...
    "Click to vote with {nextAnswer} for option {option}" : "Fai clic per votare con {nextAnswer} per opzione {option}",
    "Participant {userId} has been removed" : "Il partecipante {userId} è stato rimosso",
    "Remove votes of {displayName}" : "Rimuovi i voti di {displayName}",
    "Click to sort by name" : "Fai clic per ordinare per nome",
    "Click to remove sorting" : "Fare clic per rimuovere l'ordinamento",
    "No voters" : "Nessun votante",
    "more" : "altro",
    ...
    "403 - You are not allowed to access this poll" : "403 - Non ti è consentito accedere a questo sondaggio",
    ...
    "Polls settings" : "Impostazioni dei sondaggi",
    "404 - poll not found" : "404 - sondaggio non trovato",
    ...
    "Loading overview…" : "Caricamento della panoramica…",
    "Fetching polls…" : "Recupero dei sondaggi…",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Oppure [link]accedi[/link] se sei un membro di questo sito.",
    ...
    "Loading poll…" : "Caricamento sondaggio…",
    "Fetching configuration…" : "Recupero della configurazione in corso…",
    "Collecting elements…" : "Raccolta elementi…",
    "This seems to be a huge poll, please be patient…" : "Sembra che questo sia un sondaggio enorme, per favore abbiate pazienza...",
    ...
    "Error loading more participants" : "Errore durante il caricamento di altri partecipanti",
    ...
    "Access" : "Accesso",
    "Sort by access level" : "Ordina per livello di accesso",
    "Owner" : "Proprietario",
    "Sort by name of the owner" : "Ordina per nome del proprietario",
    "Expiration" : "Scadenza",
    "Sort by expiration date" : "Ordina per data di scadenza",
    "Sort by activity" : "Ordina per attività",
    "Relevant" : "Importante",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "Vengono mostrati solo i sondaggi pertinenti che ti riguardano, in quanto partecipante, proprietario o invitato. Vengono visualizzati solo i sondaggi non più vecchi di 100 giorni rispetto alla data di creazione, all'ultima attività, alla data di scadenza o all'ultima opzione (per i sondaggi basati su date).",
