OC.L10N.register(
    ...
    "This are your polls (where you are the owner)." : "Questi sono i tuoi sondaggi (di cui sei il proprietario).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Questi sono tutti i sondaggi che sono pertinenti o importanti per te, perché sei un partecipante o il proprietario o sei invitato a. Senza sondaggi scaduti.",
    ...
    "These are all hidden polls, to which you have access." : "Questi sono tutti sondaggi nascosti a cui hai accesso.",
    "This is simply the trash bin." : "Questo è un semplice cestino.",
