OC.L10N.register(
    ...
    "_%n confirmation has been sent_::_%n confirmations have been sent_" : ["%n la conferma è stata inviata","%n le conferme sono state inviate","%n le conferme sono state inviate"],
    "_%n confirmation could not be sent_::_%n confirmations could not be sent:_" : ["%n la conferma non è stata inviata","%n le conferme non sono state inviate","%n confirmations could not be sent:"],
    ...
    "_%n vote is allowed per option._::_%n votes are allowed per option._" : ["%n è consentito il voto per opzione.","%n sono consentiti voti per opzione.","%n sono consentiti voti per opzione."],
    "_%n vote is allowed per participant._::_%n votes are allowed per participant._" : ["%n è consentito il voto per partecipante.","%nsono consentiti voti per partecipante.","%n sono consentiti voti per partecipante."],
    "_You have %n vote left._::_You have %n votes left._" : ["Ti è rimasto %n voto.","Ti sono rimasti %n voti.","Ti sono rimasti %n voti."],
    ...
    "_{usedVotes} of %n vote left._::_{usedVotes} of %n votes left._" : ["{usedVotes} di%n voto rimasto.","{usedVotes} di %n voti rimasti.","{usedVotes} di %n voti rimasti."],
    ...
    "Administrative poll management" : "Gestione del sondaggio amministrativo",
    "Manage polls of other accounts. You can take over the ownership or delete polls." : "Gestisci i sondaggi di altri account. Puoi assumerne la proprietà o eliminare i sondaggi.",
    "Take over" : "Rileva",
    ...
    "Relevant" : "Importante",
    "Relevant polls which are relevant or for you, because you are a participant or the owner or you are invited to." : "Sondaggi pertinenti che sono rilevanti per te, perché sei un partecipante o il proprietario o sei stato invitato.",
