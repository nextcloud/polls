OC.L10N.register(
    ...
    "%s is the new owner of your poll. " : "%s iè il nuovo proprietario del tuo sondaggio.",
    ...
    "Edit poll group" : "Modifica gruppo di sondaggi",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduces your vote quota._" : ["%n voto orfano riduce la tua quota di voto.","%n voti orfani riduce la tua quota di voti.","%n orphaned votes reduces your vote quota."],
    ...
    "Choose a more meaningful title for the overview page" : "Scegli un titolo più significativo per la pagina di anteprima",
    "Choose a description for the overview page" : "Scegli una descrizione per la pagina di anteprima",
    "Note: Changing the title, also changes the URL" : "Nota: cambiando il titolo, cambia anche l'URL",
    "Error updating PollGroup" : "Errore durante l'aggiornamento del gruppo di sondaggi",
    ...
    "Use fixed table headers" : "Utilizzare intestazioni di tabella fisse",
    ...
    "Group without title" : "Gruppo senza titolo",
    ...
    "Group without description" : "Gruppo senza descrizione",
