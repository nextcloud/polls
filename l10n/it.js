OC.L10N.register(
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "Utilizzateli solo se assolutamente necessario (ad esempio se il vostro cron non funziona correttamente) o per effettuare dei test.",
    ...
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "Le informazioni sull'ora mostrano solo l'ultima esecuzione regolare del cron job, non le esecuzioni avviate manualmente.",
    ...
    "Click to vote with {nextAnswer} for option {option}" : "Clicca per votare con {nextAnswer} per opzione {option}",
