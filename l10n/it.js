OC.L10N.register(
    ...
    "Relevant" : "Importante",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Sondaggi pertinenti per te, perché sei un partecipante, il proprietario o sei stato invitato. Vengono visualizzati solo i sondaggi non più vecchi di 100 giorni rispetto alla creazione, all'ultima interazione, alla scadenza o all'opzione più recente (per i sondaggi con data).",
