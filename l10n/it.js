OC.L10N.register(
    ...
    "_You have only one vote left._::_You have %n votes left._" : ["Ti è rimasto un solo voto","Ti sono rimasti %n voti"],
    "_This is an exclusive vote, where only one user is allowed to vote for an option._::_Only %n votes per option are permitted._" : ["Si tratta di un voto esclusivo, in cui solo un utente può votare per un'opzione.","Sono consentiti solo %n voti per opzione."],
    ...
    "If vote limits are used, \"maybe\" should be not be allowed." : "Se sono utilizzati i limiti di voto, \"forse\" non dovrebbe essere consentito.",
    ...
    "Closing {relativeExpirationTime}" : "Chiusura {relativeExpirationTime}",
