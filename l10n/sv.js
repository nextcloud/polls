OC.L10N.register(
    ...
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "Denna omröstning är anonym för alla, inklusive ägaren. Att de-anonymisera är inaktiverat för denna omröstning.",
    ...
    "To participate, register with a name." : "Registrera ett namn för att delta.",
    ...
    "Transfer poll" : "Överför omröstning",
    ...
    "Use explicit \"No\" votes" : "Visa markör för \"nej\"-röst",
    ...
    "Transfered poll to {user}." : "Överförde omröstning till {user}.",
    "Error transfering poll." : "Fel vid överföring av omröstning",
    "Transfering a poll to another user may result in loss of access to this poll." : "Att överföra en omröstning till en annan användare kan resultera i att du förlorar åtkomst till omröstningen.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "Att överföra en omröstning till {user} kan resultera i att du förlorar åtkomst till omröstningen.",
    ...
    "Type to start searching …" : "Skriv för att söka ...",
    ...
    "Relevant" : "Relevant",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Omröstningar som är aktuella för dig eftersom du antingen är deltagare, ägare eller för att du är inbjuden. Endast omröstningar vars senaste interaktion, utgångstid eller senaste datum (för datum-omröstningar) inte är äldre än 100 dagar visas.",
    ...
    "A complete list with all openly accessible polls on this site." : "En komplett lista med alla öppet tillgängliga omröstningar på denna webbplats",
