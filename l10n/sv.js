OC.L10N.register(
    ...
    "Allow admins to edit this poll" : "Tillåt administratörer att redigera denna omröstning",
    ...
    "Limit \"Yes\" votes per user" : "Begränsa \"Ja\"-röster per användare",
    "Title" : "Titel",
    ...
    "Shifting dates is disabled to prevent shifting of other user's proposals." : "Ändring av datum är inaktiverad för att förhindra ändring av andra användares förslag.",
    ...
    "Openly accessible and relevant poll" : "Öppet tillgänglig och relevant omröstning",
    ...
    "Public participation" : "Publikt deltagande",
    "To participate, tell us how we can call you!" : "För att delta, berätta hur vi kan nå dig!",
    "Enter your name" : "Ange ditt namn",
    "Remember me for 30 days" : "Kom ihåg mig i 30 dagar",
    "You are a registered user of this site?" : "Är du en registrerad användare av denna sida?",
    "Login" : "Logga in",
    "As a regular user of this site, you can participate with your internal identity after logging in." : "Som en vanlig användare av denna sida kan du delta med din interna identitet efter att ha loggat in.",
    "Otherwise participate publicly." : "Annars delta publikt.",
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Din e-postadress krävs. Efter registreringen kommer din personliga länk till omröstningen att skickas till denna adress.",
    "With your email address you can subscribe to notifications and you will receive your personal link to this poll." : "Med din e-postadress kan du prenumerera på aviseringar och du kommer att få din personliga länk till denna omröstning.",
    ...
    "Deactivate combo view for all users" : "Inaktivera kombinerad vy för alla användare",
    "Allow combo view for the following groups" : "Tillåt kombinerad visning för följande grupper",
    "Leave empty to disallow for all." : "Lämna tomt för att avvisa för alla.",
    ...
    "Hide email addresses of internal users" : "Dölj e-postadresser för interna användare",
    "Show email addresses of internal users to members of the following groups" : "Visa e-postadresser för interna användare för medlemmar i följande grupper",
    "The privacy link and the legal notice link are automatically added to the registration dialog of public polls." : "Sekretesslänken och den juridiska informationslänken läggs automatiskt till i registreringsdialogen för publika omröstningar.",
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Som standard används länkarna som konfigurerats i temaappen. För publika omröstningar kan dessa åsidosättas av individuella villkor.",
    "Privacy policy link:" : "Länk för integritetspolicy:",
    "Legal notice link:" : "Länk för juridiskt meddelande:",
    ...
    "Track activities" : "Håll koll på aktiviteter",
    "Hide login option in public polls" : "Dölj inloggningsalternativ i publika omröstningar",
    "Archive closed polls automatically" : "Arkivera stängda omröstningar automatiskt",
    "After how many days are closed polls to be archived:" : "Efter hur många dagar ska stängda omröstningar arkiveras:",
    "Activate long polling for instant updates" : "Aktivera lång avfrågning för omedelbara uppdateringar",
    "Activate periodic polling of updates from the client" : "Aktivera periodiska avfrågningar av uppdateringar från klienten",
    "Disable automatic updates (reload app for updates)" : "Inaktivera automatiska uppdateringar (ladda om appen för uppdateringar)",
    "Disallow poll creation for all users" : "Tillåt inte skapande av omröstningar för alla användare",
    "Allow poll creation for the following groups" : "Tillåt att omröstningar skapas för följande grupper",
    "Disallow poll download" : "Tillåt inte nedladdning av omröstning",
    "Allow poll download for the following groups" : "Tillåt nedladdning av omröstning för följande grupper",
    "Disallow public shares" : "Tillåt inte publika delningar",
    "Allow public shares for the following groups" : "Tillåt publika delningar för följande grupper",
    "Disallow openly accessible polls" : "Tillåt inte öppet tillgängliga omröstningar",
    "Allow creating openly accessible polls for the following groups" : "Tillåt att öppet tillgängliga omröstningar skapas för följande grupper",
    ...
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Om detta tröskelvärde överskrids kommer endast den aktuella användaren att visas, för att undvika prestandaavbrott.",
    ...
    "Do not ask for email address" : "Fråga inte efter e-postadress",
    ...
    "Allow proposals from users" : "Tillåt förslag från användare",
    ...
    "Share restrictions" : "Delningsbegränsningar",
    "Restrict the share actions globally or on a group base" : "Begränsa delningsåtgärderna globalt eller på gruppnivå",
    "Poll creation restrictions" : "Begränsningar för att skapa omröstning",
    "Restrict the creation of new polls globally or on a group base" : "Begränsa skapandet av nya omröstningar globalt eller på gruppnivå",
    "Legal terms for public poll registration" : "Juridiska villkor för registrering av publik omröstning",
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Överskrid standardlänkarna på din webbplats till dina juridiska villkor. Lämna tomt för att använda länkarna som är konfigurerade i temaappen.",
    ...
    "Activate or disable individual features." : "Aktivera eller inaktivera enskilda funktioner.",
    ...
    "Manage polls of other users. You can take over the ownership or delete polls." : "Hantera omröstningar av andra användare. Du kan ta över ägandet eller ta bort omröstningar.",
    ...
    "Allow proposals" : "Tillåt förslag",
    "Relevant" : "Relevant",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without polls closed more than five days ago." : "Alla omröstningar som är relevanta eller viktiga för dig, eftersom du är deltagare, ägare eller är inbjuden till. Utan omröstningar stängda för mer än fem dagar sedan.",
