OC.L10N.register(
    ...
    "{sharee} has changed his name" : "{sharee} heeft zijn naam gewijzigd",
    ...
    "You have changed the registration constraints for share {sharee}" : "Je hebt de registratiebeperkingen voor deelname {sharee} gewijzigd",
    "{actor} has changed the registration constraints for share {sharee}" : "{actor} heeft de registratiebeperkingen voor share {sharee} gewijzigd",
    ...
    "You have removed option {optionTitle}" : "Je verwijderde optie {optionTitle}",
    "{actor} has removed option {optionTitle}" : "{actor} verwijderde optie {optionTitle}",
    ...
    "Deactivate combo view for all users" : "Deactiveer combinatie-weergave voor alle gebruikers",
    "Allow combo view for the following groups" : "Sta combinatie-weergave toe voor de volgende groepen",
    ...
    "Disallow poll download" : "Peiling download niet toestaan",
    "Allow poll download for the following groups" : "Sta download van peiling toe voor de volgende groepen",
    ...
    "A complete list with all openly accessible polls on this site, regardless who is the owner." : "Een volledige lijst met alle open toegankelijke peilingen op deze site, ongeacht wie de eigenaar is.",
