OC.L10N.register(
    ...
    "You have only one vote left." : "Je hebt nog één stem over.",
    "This is an exclusive vote, where only one user is allowed to vote for an option." : "Dit is een exclusieve stem, waarbij slechts één gebruiker op een optie mag stemmen.",
    "_You have %n vote left._::_You have %n votes left._" : ["Je hebt %n stem over.","Je hebt %n stemmen over."],
