OC.L10N.register(
    ...
    "Updated poll configuration. Please check your votes." : "الإعداد المُحدَّث للاستبيان. يرجى التحقق من تصويتاتك.",
    ...
    "Poll created" : "تمّ إنشاء الاستبيان",
    "Add another poll" : "إضافة استبيان آخر",
    "Open poll now" : "فتح الاستبيان الآن",
    ...
    "Select a time" : "حدِّد الوقت",
    "Enter a time" : "أدخِل الوقت",
    "Conflict" : "تعارُض",
    "Add" : "إضافة",
    ...
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "هذا الاستبيان يُخفي الهُوِيَّات عن الجميع؛ بمن فيهم صاحبه. إلغاء ميزة إخفاء الهوية مُعطَّل في هذا الاستبيان.",
    "But be aware that your name is not stored in an encrypted or obfuscated way." : "لكن انتبه إلى أن اسمك محفوظ بصيغة غير مشفرة.",
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll administration." : "هذا الاستبيان هو استبيان تُخفَى فيه هُوِيَّة المُصوِّتِين عن الجميع، باستثناء المالك و المفوض بإدارة الاستبيان.",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll administration." : "إخفاء هُوِيَّة المُصوِّتِين في هذا الاستبيان يمكن إلغاؤها في أي لحظة من قِبَل المالك أو المفوضين بإدارة الاستبيان.",
    ...
    "\"{pollTitle}\" has been added" : "\"{pollTitle}\" تمّت إضافته",
    "Choose a meaningful title for your poll" : "إختَر عنواناً مُعبِّراً لاستبيانك",
    "Close" : "إغلاق",
    "Yes" : "نعم",
    "Maybe" : "ربما",
    "No" : "لا",
    ...
    "Archived poll" : "إستبيان مؤرشف",
    "Started {relativeTime} from {ownerName}" : "بَدَأ {relativeTime} لصاحبه {ownerName}",
    "Take over poll?" : "هل ستستلم مسؤولية الاستبيان؟",
    "You will become the new owner and {username} will get notified." : "سوف تصبح أنت المالك الجديد؛ وسيتم إشعار {username} بذلك.",
    ...
    "Error taking over poll." : "حدث خطأ أثناء تسليم مسؤولية الاستبيان",
    "Take over" : "تولى",
    "This will finally delete the poll and {username} will get notified." : "سيؤدي هذا لحذف الاستبيان؛ وسيتم إشعار {username} بذلك.",
    "This will finally delete the poll." : "سيؤدي هذا لحذف الاستبيان نهائياً",
    ...
    "Load polls into the navigation." : "تحميل الاستبيانات في التنقل.",
    ...
    "Anonymizing a poll of a restricted owner means that this poll is anonymous for everyone, including the owner." : "إن إخفاء هوية استبيانٍ صاحبُه مُقيَّدٌ يعني أن هذا الاستبيان سيكون مجهول الهوية بالنسبة للجميع، بمن فيهم صاحبه.",
    "Deleting and changing votes of participants is not possible" : "حذف أو تعديل أصوات المُصوِّتِين غير ممكن",
    ...
    "Check this, if you prefer to display date poll in a vertical view rather than in the grid view. The initial default is grid view." : "حدِّد هذا الخيار، إذا كنت تُفضِّل عرض استبيانات المواعيد في محاذاة رأسية بدلاً من المنظور الصندوقي. الخيار التلقائي هو منظور القائمة.",
    ...
    "Use alternative option add dialog" : "إستعمِل نافذة إضافة خيار بديل ",
    "Arrange description and card hints side by side" : "قم بترتيب الوصف وإرشادات البطاقة جنباً لجنبٍ",
    ...
    "Poll updated" : "تمّ تحديث الاستبيان",
    ...
    "My polls" : "إستبياناتي",
    "These are all polls where you are the owner." : "هذه هي الاستبيانات التي أنت صاحبها",
    ...
    "All polls in which you participated." : "جميع الاستبيانات التي ساهمتَ أنت فيها.",
    "Openly accessible polls" : "الاستبيانات المفتوحة ",
    "A complete list with all openly accessible polls on this site." : "القائمة الكاملة بجميع الاستبيانات المفتوحة على هذا الموقع.",
    ...
    "Administrative access." : "وصول إداري.",
    "You can delete, archive and take over polls in this list, but access is still not possible." : "بإمكانك حذف الاستطلاعات الموجودة في هذه القائمة وأرشفتها والتحكم فيها، ولكن لا يزال الوصول إليها غير ممكن."
},
