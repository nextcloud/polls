OC.L10N.register(
    ...
    "But be aware, that your name is not stored in an encrypted or obfuscated way." : "لكن كل على حذر من أن اسمك ليس محفوظاً بكيفية مشفرةٍ أو مُعمَّاةٍ.",
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll admins." : "هذا الاستبيان يُخفي الهُوِيَّات عن الجميع؛ ما عدا صاحبه ومشرفي الاستطلاع المُخوَّلِين.",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll admins." : "إخفاء الهُوِيَّات في هذا الاستبيان يمكن إزالته في أي وقت من قِبَل صاحبه أو مُشرِفِي الاستطلاع المُخوَّلِين.",
    ...
    "Once enabled the anonymous setting can not be reverted anymore." : "إذا تمّ تمكينه، فإن إعداد إخفاء الهُوِيَّات لايمكن التراجع عنه بعد ذلك.",
