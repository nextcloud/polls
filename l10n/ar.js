OC.L10N.register(
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "لقد قمتَ بإزالة خيار {optionTitle} من استبيان {pollTitle}",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "قام {actor} بإزالة خيار {optionTitle} من استبيان {pollTitle}",
    ...
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "سيتم بشكل تلقائي استعمال الروابط المُكوَّنة في تطبيق التِّيمَات theming app. بالنسبة للاستبيانات العامة، يمكن تجاوز ذلك بقائمة توضيحات مخصصة.",
    ...
    "Delete share and remove user from poll" : "حذف المشاركة و حذف المستخدِم من الاستبيان",
    ...
    "This poll is private" : "هذا الاستبيان خاصٌّ",
    ...
    "Manage polls of other users. You can take over the ownership or delete polls." : "إدارة استبياناتٍ لمستخدِمين الآخرين. يمكنك تَولِّي ملكيتها أو حذفها.",
