OC.L10N.register(
    ...
    "You commented poll {pollTitle}" : "Kommentoit kyselyä {pollTitle}",
    "{actor} commented poll {pollTitle}" : "{actor} kommentoi kyselyä {pollTitle}",
    "You deleted a commented from poll {pollTitle}" : "Poistit kommentin kyselystä {pollTitle}",
    "You added poll {pollTitle}" : "Lisäsit kyselyn {pollTitle}",
    "{actor} added poll {pollTitle}" : "{actor} lisäsi kyselyn {pollTitle}",
    "You archived poll {pollTitle}" : "Arkistoit kyselyn {pollTitle}",
    "{actor} archived poll {pollTitle}" : "{actor} arkistoi kyselyn {pollTitle}",
    "You restored poll {pollTitle}" : "Palautit kyselyn {pollTitle}",
    "{actor} restored poll {pollTitle}" : "{actor} palautti kyselyn {pollTitle}",
    "Poll {pollTitle} was closed" : "Kysely {pollTitle} suljettiin",
    "You changed the owner of poll {pollTitle}" : "Muutit kyselyn {pollTitle} omistajan",
    "You changed your email address" : "Muutit sähköpostiosoitteesi",
    "{actor} changed his email address" : "{actor} vaihtoi sähköpostiosoitteensa",
    "You voted in poll {pollTitle}" : "Äänestit kyselyssä {pollTitle}",
    "{actor} voted in poll {pollTitle}" : "{actor} äänesti kyselyssä {pollTitle}",
    "You commented" : "Kommentoit",
    "{actor} commented" : "{actor} kommentoi",
    "You deleted a commented" : "Poistit kommentin",
    "{actor} deleted a commented" : "{actor} poisti kommentin",
    "You created this poll" : "Loit tämän kyselyn",
    "{actor} created this poll" : "{actor} loi tämän kyselyn",
    "You archived this poll" : "Arkistoit tämän kyselyn",
    "{actor} archived this poll" : "{actor} arkistoi tämän kyselyn",
    "You restored this poll" : "Palautit tämän kyselyn",
    "{actor} restored this poll" : "{actor} palautti tämän kyselyn",
    "This poll was closed" : "Kysely suljettiin",
    "You changed the poll owner" : "Muutit kyselyn omistajan",
    "You voted" : "Äänestit",
    "{actor} voted" : "{actor} äänesti",
    ...
    "Access for all users" : "Pääsy kaikille käyttäjille",
    ...
    "Disallow publishing poll to all users" : "Älä salli kyselyn julkaisua kaikille käyttäjille",
    ...
    "Manage polls" : "Hallitse kyselyjä",
