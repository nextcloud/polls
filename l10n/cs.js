OC.L10N.register(
    ...
    "never" : "nikdy",
    "Beta - watch for updated polls in realtime" : "Beta - sledujte změny hlasování v reálném čase",
    "All changes to the current poll, done by other users, will be recognized in realtime." : "Všechny změny v této anketě, od ostatních uživatelů, budou zobrazeny v reálném čase.",
    ...
    "Error switching deleted status." : "Chyba při přepínání stavu \"smazáno\"",
