OC.L10N.register(
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Nasdíleli jste {pollTitle} s týmem {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} nasdílel/a anketu {pollTitle} týmu {sharee}",
    "You have shared this poll with team {sharee}" : "Nasdíleli jste tuto anketu týmu {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} nasdílel/a tuto anketu týmu {sharee}  ",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Smazali jste sdílení ankety {pollTitle} pro tým {sharee}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} smazal/a sdílení ankety {pollTitle} pro tým {sharee}",
    "You have deleted the share for team {sharee}" : "Smazali jste sdílení pro tým {sharee}",
    "{actor} has deleted the share for team {sharee}" : "{actor} smazal/a sdílení pro tým {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Obnovili jste sdílení ankety {pollTitle} pro tým {sharee}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} obnovil/a sdílení ankety {pollTitle} pro tým {sharee}",
    "You have restored the share for team {sharee}" : "Obnovili jste sdílení pro tým {sharee}",
    "{actor} has restored the share for team {sharee}" : "{actor} obnovil/a sdílení pro tým {sharee}",
    ...
    "Select timezone to apply" : "Vyberte časovou zónu k uplatnění",
    "Use original timezone ({pollTimezone})" : "Použít původní časové pásmo ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Použít vaše časové pásmo ({localTimezone})",
    ...
    "Allow download of poll results" : " Umožnit stáhnout si výsledky ankety",
    ...
    "Error restoring poll." : "Chyba při obnovování ankety.",
    "Error archiving poll." : "Chyba při archivaci ankety.",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Toto nevratně smaže anketu a {username} bude upozorněn/a.",
    "This will irreversibly delete the poll." : "Toto anketu nevratně smaže.",
    "OK" : "OK",
    ...
    "Submit" : "Odeslat",
    "_%n repetition_::_Last of %n repetitions_" : ["%n opakování","Poslední %n opakování","Posledních %n opakování","Poslední %n opakování"],
    ...
    "Current timezone: {timezoneString}" : "Stávající časové pásmo: {timezoneString}",
    "Original timezone: {timezoneString}" : "Původní časové pásmo: {timezoneString}",
    ...
    "Open poll, accessible to all users of this instance and invited participants" : "Otevřená anketa – přístupná všem uživatelům této instance a pozvaným účastníkům",
    ...
    "Days after which archived polls should be permanently deleted" : "Počet dnů, které když uplynou, mají být archivované ankety nevratně smazány",
    ...
    "Error sending invitations" : "Chyba při odesílání pozvánek",
    ...
    "Set default timezone for this poll" : "Výchozí časové pásmo pro tuto anketu",
    ...
    "Your timezone: ({timezone})" : "Vaše časová zóna: ({timezone})",
    "Poll timezone: ({timezone})" : "Časová zóna ankety: ({timezone})",
    ...
    "Manually start background jobs, independent from the cron schedule." : "Ručně spustit úkoly na pozadí, nezávisle na naplánování.",
