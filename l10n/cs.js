OC.L10N.register(
    ...
    "_You have %n vote left._::_You have %n votes left._" : ["Zbývá vám %n hlas.","Zbývají vám %n hlasy.","Zbývá vám %n hlasů.","Zbývají vám %n hlasy."],
    ...
    "All day" : "Celý den",
    "Duaration" : "Doba trvání",
    "Duration time unit" : "Jednotka času doby trvání",
    "Repetitions" : "Opakování",
    "Preview" : "Náhled",
    "_%n repetition until_::_%n repetitions until_" : ["%n opakování dokud","%n opakování dokud","%n opakování dokud","%n opakování dokud"],
    ...
    "Error loading polls list for admins" : "Chyba při načítání seznamu anket pro správce",
    "Administrative poll management" : "Správa ankety správců",
    "Manage polls of other accounts. You can take over the ownership or delete polls." : "Spravujte ankety ostatních účtů. Můžete převzít vlastnictví nebo mazat ankety.",
    "Take over" : "Převzít",
