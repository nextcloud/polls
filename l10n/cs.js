OC.L10N.register(
    ...
    "An open accessible poll from {name}" : "Otevřeně přístupná anketa od {name}",
    ...
    "Open accessible and relevant poll" : "Otevřeně přístupná a příslušná anketa",
    "Open accessible poll" : "Otevřeně přístupná anketa",
    ...
    "Disallow open accessible polls" : "Neumožňovat otevřeně přístupné ankety",
    "Allow creating open accessible polls for the following groups" : "Umožnit vytváření otevřeně přístupných anket následujícím skupinám",
    ...
    "This is an open accessible poll" : "Toto je otevřeně přístupná anketa",
    ...
    "Open accessible polls" : "Otevřeně přístupné ankety",
    "A complete list with all open accessible polls on this site, regardless who is the owner." : "Úplný seznam všech otevřeně přístupných anket na této instanci, bez ohledu, kdo je vlastník.",
