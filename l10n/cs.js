OC.L10N.register(
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "Odebrali jste možnost {optionTitle} z ankety {pollTitle}",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor} odebral(a) možnost {optionTitle} z ankety {pollTitle}",
    "You have removed option {optionTitle}" : "Odebrali jste možnost {optionTitle}",
    "{actor} has removed option {optionTitle}" : "{actor} odebral(a) možnost {optionTitle}",
    ...
    "Confirmation sent to {participant} ({emailAddress})" : "Potvrzení odesláno {participant} ({emailAddress})",
    "Confirmation could not be sent to {participant} ({emailAddress})" : "Potvrzení se nepodařilo odeslat {participant} ({emailAddress})",
    "_Confirmations sent to {count} recipient_::_Confirmations sent to {count} recipients_" : ["Potvrzení odesláno {count} příjemci","Potvrzení odesláno {count} příjemcům","Potvrzení odesláno {count} příjemcům","Potvrzení odesláno {count} příjemcům"],
    ...
    "Openly accessible and relevant poll" : "Otevřeně přístupná a příslušná anketa",
    ...
    "Otherwise participate as a guest user." : "Jinak se zůčastnit jako host.",
    ...
    "After how many days are closed polls to be archived:" : "Po kolika dnech mají být uzavřené ankety přemístěny do archivu:",
    ...
    "Disallow poll download" : "Neumožnit stažení si ankety",
    ...
    "Styles" : "Styly",
    "User is only able to see the votes." : "Uživatel si může pouze zobrazovat hlasy.",
    ...
    "Re-Revoke share" : "Znovu odvolat sdílení",
    "Delete share and remove user from poll" : "Smazat sdílení a odebrat uživatele z ankety",
    "Revoke share" : "Odvolat sdílení",
    "Delete share" : "Smazat sdílení",
    "Deleted share and votes for {displayName}" : "Smazáno sdílení a hlasy pro {displayName}",
    "Share for user {displayName} revoked" : "Sdílení pro uživatele {displayName} revoked",
    "Deleted share for user {displayName}" : "Smazáno sdílení pro uživatele {displayName}",
    "Error deleting or revoking share for user {displayName}" : "Chyba při mazání či odvolávání sdílení pro uživatele {displayName}",
    ...
    "Shares" : "Sdílení",
    "Revoked shares" : "Odvolaná sdílení",
    ...
    "Relevant" : "Relevantní",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Všechny ankety, které s vámi souvisí nebo jsou pro vás důležité, protože jste účastníky nebo vlastníky nebo jste do nich byli přizváni.",
