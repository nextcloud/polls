OC.L10N.register(
    ...
    "{actor} has did something indescribable with poll {pollTitle}" : "{actor} udělal(a) něco nepopsatelného s anketou {pollTitle}",
    ...
    "{sharee}'s email address has been changed" : "E-mailová adresa uživatele {sharee} byla změněna",
    ...
    "You have deleted {sharee}'s share" : "Smazali jste sdílení uživatele {sharee}",
