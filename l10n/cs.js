OC.L10N.register(
    ...
    "Participants names are hidden, because this is an anoymous poll" : "Jména účastníků jsou skrytá, protože toto je anonymní anketa",
    "The names of other participants is hidden, as this is a anonymous poll. " : "Jméno ostatních účastníků jsou skrytá, protože toto je anonymní anketa.",
    "%n voters participated in this poll until now." : "Této ankety se doposud zúčastnilo %n hlasujících.",
    "Deleted" : "Smazáno",
    "Group" : "Skupina",
    ...
    "Poll schedule" : "Naplánování ankety",
    "Text based" : "Textové",
    "Cancel" : "Storno",
    "Apply" : "Použít",
    "Poll \"%n\" added" : "Anketa „%n“ přidána",
    "Voting is no more possible, because this poll expired since %n" : "Hlasování už není možné, protože tato anketa už byla %n uzavřena",
