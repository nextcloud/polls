OC.L10N.register(
    ...
    "Error while changing lock status of user {displayName}" : "Chyba při měnění stavu zámku uživatele {displayName}",
    "Share and votes of {displayName} deleted" : "Sdílení a hlasy {displayName} smazány",
    "Share of {displayName} deleted" : "Sdílení {displayName} smazáno",
    "Error deleting share of {displayName}" : "Chyba při mazání sdílení {displayName}",
