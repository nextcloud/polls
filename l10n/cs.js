OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{sharee} změnil(a) svou e-mailovou adresu",
    ...
    "Save username in cookie for 30 days" : "Uložit uživatelské jméno do cookie po dobu 30 dnů",
    ...
    "Activate all calendars to consult for the search of conflicting events." : "Aktivujte všechny kalendáře ohledně zjišťování kolidujicích událostí hledáním.",
    "Set the time interval in hours, a calendar event must be finished before a date option, to get accounted to the conflict check." : "Nastavte interval (v hodinách), do kterého když událost v kalendáři má skončit před volbou data, bude brána v potaz ohledně kontroly konfliktů.",
    "Set the time interval in hours, a calendar event must start after a date option, to get accounted to the conflict check." : "Nastavte interval (v hodinách), do kterého když událost v kalendáři má začít před volbou data, bude brána v potaz ohledně kontroly konfliktů.",
    ...
    "No polls found" : "Nenalezeny žádné ankety",
    "Select poll" : "Vybrat anketu",
