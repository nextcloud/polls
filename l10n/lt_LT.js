OC.L10N.register(
    ...
    "Allow Proposals" : "Leisti pasiūlymus",
    "Proposal closing date" : "Pasiūlymų teikimo pabaigos data",
    "Proposals possible until" : "Pasiūlymai yra galimi iki",
    ...
    "You are asked to propose more options for this poll." : "Jūsų prašoma pridėti daugiau variantų į šią apklausą.",
    "Adding proposals ends {timeRelative}." : "Pasiūlymų teikimas užbaigiamas {timeRelative}.",
    "Adding proposals ended {timeRelative}." : "Pasiūlymų teikimas pasibaigė {timeRelative}.",
    ...
    "Add some!" : "Pridėkite!",
    "Add new date option" : "Pridėti naują datos variantą",
    ...
    "Option proposal term ends {timeRelative}" : "Variantų siūlymo terminas baigiasi {timeRelative}",
    "Option proposal term ended {timeRelative}" : "Variantų siūlymo terminas pasibaigė {timeRelative}",
    "No proposals are allowed" : "Siūlymai neleidžiami",
