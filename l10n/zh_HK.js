OC.L10N.register(
    ...
    "You have delegated admin rights" : "您已經授予管理員權限。",
    ...
    "Check thisfor more poll information in the overview." : "在概覽中檢查此處以取得更多資訊",
    ...
    "Relevant" : "相關",
    "Relevant polls which are relevant or to you, because you are a participant or the owner or you are invited to. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "與你相關的投票，無論你是參與者、擁有者還是受邀者。只會顯示在創建、最後互動、過期或最新選項（對於日期投票）不超過 100 天的投票。",
    "My polls" : "我的投票",
