OC.L10N.register(
    ...
    "One or more orphaned votes heve been deleted from {pollTitle}" : "已從 {pollTitle} 刪除一個或多個無主投票",
    "{actor} has deleted your orphaned polls from poll {pollTitle}" : "{actor} 已從投票 {pollTitle} 刪除您的無主投票",
    "Orphaned votes deleted" : "已刪除無主投票",
    "{actor} deleted orphaned votes" : "{actor} 已刪除無主投票",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "你已將投票「{pollTitle}」分享給團隊 {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} 已將投票「{pollTitle}」分享給團隊 {sharee}",
    "You have shared this poll with team {sharee}" : "你已將此投票分享給團隊 {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} 已將此投票分享給團隊 {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "你已從投票「{pollTitle}」移除團隊 {sharee} 的分享",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} 已從投票「{pollTitle}」移除團隊 {sharee} 的分享",
    "You have deleted the share for team {sharee}" : "你已移除團隊 {sharee} 的分享",
    "{actor} has deleted the share for team {sharee}" : "{actor} 已移除團隊 {sharee} 的分享",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "你已將投票「{pollTitle}」中團隊 {sharee} 的分享還原",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} 已將投票「{pollTitle}」中團隊 {sharee} 的分享還原",
    "You have restored the share for team {sharee}" : "你已還原團隊 {sharee} 的分享",
    "{actor} has restored the share for team {sharee}" : "{actor} 已還原團隊 {sharee} 的分享",
    ...
    "plus" : "加",
    "Please wait…" : "請稍候…",
    "Possibly affected calendar events" : "可能受影響的日曆活動",
    "Add" : "添加",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduce your vote quota._" : ["%n 個無主投票會減少您的投票配額。"],
    ...
    "You have no votes left." : "您已經沒有選票了。",
    "_You have %n vote left out of {maxVotes}._::_You have %n votes left out of {maxVotes}._" : ["您共有 {maxVotes} 票，還剩 %n 票。"],
    "Limited votes." : "已限制投票。",
    ...
    "Messages sent." : "已傳送訊息。",
    "Select timezone to apply" : "選擇要套用的時區",
    "Use original timezone ({pollTimezone})" : "使用原先的時區 ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "使用您的時區 ({localTimezone})",
    ...
    "Allow Comments" : "允許評論",
    "Allow download of poll results" : "允許下載投票結果",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "這將會不可逆轉地刪除該投票，並將會通知 {username}。",
    "This will irreversibly delete the poll." : "這將會不可逆轉地刪除該投票。",
    "OK" : "確定",
    ...
    "Confirm option" : "確認選項",
    "Sort by answers of this option" : "按選項答案排序",
    "Expand options" : "展開選項",
    ...
    "Submit" : "遞交",
    "_%n repetition_::_Last of %n repetitions_" : ["最後 %n 次重複"],
    ...
    "Expand description" : "展開描述",
    "Poll information" : "民意調查資訊",
    "Archived" : "已封存",
    "Unpublished" : "未發佈",
    ...
    "Poll owner:" : "民意調查所有者：",
    "Created {dateTime}" : "創建日期 {dateTime}",
    "Created {dateRelative}" : "創建日期 {dateRelative}",
    "Closing: {dateTime}" : "結束日期：{dateTime}",
    "Closing: {dateRelative}" : "結束日期：{dateRelative}",
    "Current timezone: {timezoneString}" : "目前時區：{timezoneString}",
    "Original timezone: {timezoneString}" : "原先的時區：{timezoneString}",
    ...
    "Error updating poll group" : "更新投票群組時發生錯誤",
    "Extended title" : "延伸標題",
    "Description" : "描述",
    "Expired {dateTime}" : "已過期 {dateTime}",
    "Last activity {dateTime}" : "上次活動於 {dateTime}",
    "No access" : "無法存取",
    ...
    "Open poll, accessible to all users of this instance and invited participants" : "公開投票，此站台的所有用戶與受邀的參與者皆可存取",
    "{count} participants" : "{count} 位參與者",
    "Open poll, accessible to all users of this instance" : "公開投票，此站台的所有使用者皆可存取",
    "You have been granted administrative rights" : "您已被授予管理權限",
    ...
    "The poll group was deleted by removing the last member." : "通過刪除最後一位成員，投票組已被刪除。",
    "Error removing poll from group." : "從群組移除投票時發生錯誤",
    "Error creating new poll group." : "建立新投票群組時發生錯誤",
    ...
    "Days after which archived polls should be permanently deleted" : "已封存投票在多少天後永久刪除",
    ...
    "Sends out pending automatic reminders." : "傳送待處理的自動提醒。",
    "Cleans up old or irrelevant data from the system to maintain optimal performance and organization." : "清理系統中的舊資料或無關資料，以維持最佳效能與組織結構。",
    "Sends out pending notifications about poll updates." : "傳送關於投票更新的待處理通知。",
    "Description is missing." : "缺少描述。",
    "Execution failed" : "執行失敗",
    "The last execution of this job has failed. Please check the logs for more details." : "此作業上次執行失敗。請檢查紀錄檔以取得更多資訊。",
    "Not run yet" : "尚未運行",
    "This job has never been run yet." : "這項作業從未運行。",
    "{jobName} has been executed." : "已執行 {jobName}。",
    "Start {jobName} manually." : "人手開始 {jobName}。",
    "{jobName} does not support manually run." : "{jobName} 不支援人手運行。",
    "Request Execution" : "請求執行",
    "Request job execution" : "請求執行作業",
    "Enter the URL of your privacy policy" : "輸入您隱私政策的 URL",
    "Enter the URL of your legal notice" : "輸入您法律聲明的 URL",
    "Use the default terms for public polls" : "使用公開投票的默認條款",
    ...
    "Grant administrative poll access" : "授予管理投票的權限",
    "Withdraw administrative poll access" : "撤回管理投票的權限",
    ...
    "Error sending invitations" : "傳送邀請時發生錯誤",
    ...
    "Be the first." : "成為第一個。",
    "Configuration" : "設定",
    "Comments are disabled, except for owner and delegated poll administration." : "評論功能已禁用，僅限擁有者和授權的調查管理員可以發表評論。",
    "You have been granted administrative rights." : "您已被授予管理權限。",
    "Changes may affect existing votes." : "更改可能會影響現有的投票。",
    "Poll configuration" : "投票設定",
    "Poll closing status" : "投票關閉狀態",
    "Result display" : "結果顯示",
    "Forced display mode" : "強制顯示模式",
    "Set default timezone for this poll" : "設定此投票的預設時區",
    ...
    "Add a date" : "添加日期",
    "Shares for a poll group grant voting access to the polls contained in the poll group." : "投票組的分享權限可讓成員對該組內的投票進行投票。",
    ...
    "Public link" : "公開連結",
    "Your timezone: ({timezone})" : "您的時區：({timezone})",
    "Poll timezone: ({timezone})" : "投票時區：({timezone})",
    ...
    "Click to vote with {nextAnswer} for option {option}" : "按一下以 {nextAnswer} 投票給選項 {option}",
    ...
    "Loading overview…" : "概覽加載中 ...",
    "Fetching polls…" : "正在擷取投票…",
    ...
    "Or [link]login[/link] if you are a member of this site." : "如果您是本站會員，請點選[link]登入[/link]。",
    "participated" : "參與了",
    "closed" : "已關閉",
    "By:" : "由：",
    "Comments" : "留言",
    ...
    "This seems to be a huge poll, please be patient…" : "這似乎是一個超大的投票，請稍候…",
    ...
    "Sort by title" : "按標題排序",
    "Access" : "存取",
    "Sort by access level" : "按存取等級排序",
    "Owner" : "所有者",
    "Sort by name of the owner" : "按擁有者名稱排序",
    "Expiration" : "過期",
    "Sort by expiration date" : "按到期日排序",
    "Sort by activity" : "按活動排序",
    "Relevant" : "相關",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "這些是與您相關的投票，因為您是參與者、擁有者或被邀請者。僅顯示創建、最後活動紀錄、過期或最新選項（針對日期投票）不超過 100 天的投票。",
    "My polls" : "我的投票",
