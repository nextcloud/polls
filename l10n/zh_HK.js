OC.L10N.register(
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "僅在絕對必要（亦即錯誤，例如您的 cron 無法正常運作），或是用於測試時才使用它們。",
    "Starting the jobs does not mean, that the rules for these actions are overridden." : "啟動作業並不表示這些動作的規則無效。",
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "時間資訊僅顯示最後一次定期 cron 工作執行，不包含人手啟動的運行紀錄。",
