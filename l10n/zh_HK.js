OC.L10N.register(
    ...
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll admins." : "這個投票是針對所有人的匿名投票，唯獨所有者和被授權的投票管理員除外。",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll admins." : "此投票的匿名性可以隨時由所有者和被授權的投票管理員移除。",
    ...
    "Once enabled the anonymous setting can not be reverted anymore." : "一旦啟用，匿名設置將無法恢復。",
    ...
    "Deletion and changing votes of participants is not possible" : "刪除或更改參與者投票是不可能的",
    ...
    "Error deleting pollStore." : "刪除 pollStore 時發生錯誤。",
    ...
    "My polls" : "我的投票",
    "This are all polls, where you are the owner." : "這些都是你作為擁有者的投票。",
    "Private polls" : "私人投票",
