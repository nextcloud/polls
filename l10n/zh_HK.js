OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{actor} 更改了其電郵地址",
    ...
    "An open accessible poll from {name}" : "來自 {name} 向所有註冊用戶開放的投票",
    ...
    "Private poll" : "私人投票",
    "Open accessible poll" : "向所有註冊用戶開放的投票",
    ...
    "Save username in cookie for 30 days" : "將用戶名保存在 cookie 中 30 天",
    ...
    "Disallow open accessible polls" : "禁止向所有註冊用戶開放的投票",
    "Allow creating open accessible polls for the following groups" : "允許以下群組建立向所有註冊用戶開放的投票",
    ...
    "This is an open accessible poll" : "這是向所有註冊用戶開放的投票",
    ...
    "No polls found" : "未找到民意調查",
    "Select poll" : "選擇民意調查",
    "Link to a poll" : "連結到一個民意調查",
    "Details" : "詳細資料",
    "Configuration" : "設定",
    "Options" : "選項",
    "Sharing" : "分享",
    ...
    "Open accessible polls" : "向所有註冊用戶開放的投票",
    "A complete list with all open accessible polls on this site, regardless who is the owner." : "此網站上的所有向所有註冊用戶開放的投票的完整清單，無論誰是所有者。",
    "All polls" : "所有投票",
