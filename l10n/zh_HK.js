OC.L10N.register(
    ...
    "Option proposals allowed" : "允許選項建議",
    "Option proposal term ends {timeRelative}" : "選項建議提交截止日期為 {timeRelative}",
    "Option proposal term ended {timeRelative}" : "選項建議提交已於 {timeRelative} 結束",
    ...
    "_%n yes vote_::_%n yes votes_" : ["%n 是選票"],
    ...
    "Enter amount of maximal allowed vote boxes." : "輸入允許的最大投票框數。",
    "User Settings" : "用戶設定",
