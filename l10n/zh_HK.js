OC.L10N.register(
    ...
    "started this poll on {dateString}." : "於 {dateString} 開始進行這項投票。",
    ...
    "You can place your vote until {dateString}." : "您可以在 {dateString} 之前投票。",
    "This is an anonymous poll. Except to the poll owner, participants names are hidden." : "這是匿名投票。只有投票擁有者才能看到參與者的身份。",
    "Results are hidden." : "結果是隱藏的。",
    "They will be revealed after the poll is closed." : "它們將在投票結束後公佈。",
    ...
    "This is an exclusive vote, where only one user is allowed to vote for an option." : "這是排他性投票，只允許一個用戶投票選擇一個選項。",
    ...
    "Login" : "登入",
    "As a regular user of this site, you can participate with your internal identity after logging in." : "作為此網站的常規用戶，您可以在登入後以內部身份參與。",
    ...
    "Remove share" : "移除分享",
    "Invitation sent to {emailAddress}" : "邀請已傳送到 {emailAddress}",
    ...
    "Allow Comments" : "允許評論",
    "If vote limits are used, 'maybe' shouldn't be allowed." : "如果使用投票限制，則不應允許“也許”。",
    "Anonymous poll" : "匿名投票",
    ...
    "Hide results until poll is closed" : "直到投票結束前都隱藏結果",
    ...
    "Switch to mobile view" : "切換到流動版檢視",
