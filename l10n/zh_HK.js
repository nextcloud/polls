OC.L10N.register(
    ...
    "Set the time interval in hours, a calendar event must be finished before a date option, to get accounted to the conflict check." : "時間間隔以小時數設置的日曆事件必須在給定日期之前完成，才能包含在衝突檢查中。",
