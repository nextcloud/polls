OC.L10N.register(
    ...
    "{actor} has did something indescribable with poll {pollTitle}" : "{actor} 對民意調查 {pollTitle} 做了一些難以形容的事情",
    ...
    "{sharee}'s email address has been changed" : "{actor} 的電郵地址已更改",
    ...
    "You have deleted {sharee}'s share" : "你刪除了 {sharee} 的分享",
