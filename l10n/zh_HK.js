OC.L10N.register(
    ...
    "Delete share" : "刪除分享",
    "Share for user {displayName} unlocked" : "已解鎖用戶 {displayName} 的分享",
    "Share for user {displayName} locked" : "已鎖上用戶 {displayName} 的分享",
    "Error while changing lock status for user {displayName}" : "更改用戶 {displayName} 的鎖定狀態時發生錯誤",
    "Share and votes for {displayName} deleted" : "已刪除 {displayName} 的分享與投票",
    "Share for user {displayName} deleted" : "已刪除 {displayName} 的分享",
    "Error deleting share for user {displayName}" : "刪除用戶 {displayName} 分享時發生錯誤",
