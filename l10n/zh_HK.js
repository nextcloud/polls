OC.L10N.register(
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduces your vote quota._" : ["%n 個無主投票會減少您的投票配額。"],
    ...
    "Choose a more meaningful title for the overview page" : "為概覽頁面選擇有意義的標題",
    "Choose a description for the overview page" : "為概覽頁面選擇描述",
    "Note: Changing the title, also changes the URL" : "注意：變更標題也會變更 URL",
    "Error updating PollGroup" : "更新 PollGroup 時發生錯誤",
    "Extended title" : "延伸標題",
    ...
    "Use fixed table headers" : "使用固定的數據庫表標題",
