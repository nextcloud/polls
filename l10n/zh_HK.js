OC.L10N.register(
    ...
    "Styles" : "風格",
    "User is only able to see the votes." : "用戶僅能檢視投票。",
    "Has voted" : "已投票",
    "Has not voted" : "未投票",
    "Share label" : "分享標籤",
    ...
    "Share for user {displayName} revoked" : "用戶 {displayName} 的分享已撤銷",
    "Deleted share for user {displayName}" : "用戶 {displayName} 的分享已刪除",
    "Error deleting or revoking share for user {displayName}" : "刪除或撤銷用戶 {displayName} 的分享時發生錯誤",
