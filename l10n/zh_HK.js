OC.L10N.register(
    ...
    "If you want to use diferent terms for public polls, enter them below." : "如果您想在公開投票中使用不同的條款，請在下面輸入。",
    ...
    "Use alternative option add dialog" : "使用替代選項添加對話方塊",
    "Arrange description and card hints side by side" : "將描述與卡片提示並排排列",
    "Calendar check" : "日曆檢查",
