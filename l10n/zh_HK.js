OC.L10N.register(
    ...
    "You are asked to propose more poll options." : "邀請您為此次民意調查提議更多選項。",
    "Clone option" : "再製選項",
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "添加 URL 參數 'name=' 和/或 'email=' 以預定義名稱和電郵地址。例如：https://example.com/s/aUubZAvweQ6PaX2?name=John Doe Email=john doe@example.org",
