OC.L10N.register(
    ...
    "Activate all calendars to consult for the search of conflicting events." : "啟動所有日曆並搜尋相互抵觸活動",
    "Set the time interval in hours, a calendar event must be finished before a date option, to get accounted to the conflict check." : "以小時為單位設定時間間隔。日曆事件必須在給定日期之前完成，才能包含在衝突檢查中。",
    "Set the time interval in hours, a calendar event must start after a date option, to get accounted to the conflict check." : "時間間隔以小時數設置的日曆事件必須在給定日期之後完成才能包含在衝突檢查中。",
