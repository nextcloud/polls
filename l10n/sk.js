OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "Používa sa časové pásmo „%s“. Ak chcete zobraziť časy vo svojom aktuálnom časovom pásme, vstúpte do ankety kliknutím na tlačidlo nižšie.",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Zdieľali ste anketu {pollTitle} s tímom {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} zdieľal anketu {pollTitle} s tímom {sharee}",
    "You have shared this poll with team {sharee}" : "Túto anketu ste zdieľali s tímom {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} zdieľal túto anketu s tímom {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Odstránili ste zdieľanie ankety {pollTitle} s tímom {sharee}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} odstránil zdieľanie ankety {pollTitle} s tímom {sharee}",
    "You have deleted the share for team {sharee}" : "Odstránili ste zdieľanie s tímom {sharee}",
    "{actor} has deleted the share for team {sharee}" : "{actor} odstránil zdieľanie s tímom {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Obnovili ste zdieľanie ankety {pollTitle} s tímom {sharee}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor} obnovil zdieľanie ankety {pollTitle} s tímom {sharee}",
    "You have restored the share for team {sharee}" : "Obnovili ste zdieľanie s tímom {sharee}",
    "{actor} has restored the share for team {sharee}" : "{actor} obnovil zdieľanie s tímom {sharee}",
    ...
    "Delete" : "Zmazať",
    "_Deleting in {countdown} second_::_Deleting in {countdown} seconds_" : ["Odstraňuje sa za {countdown} sekundu","Odstraňuje sa za {countdown} sekundy","Odstraňuje sa za {countdown} sekúnd","Odstraňuje sa za {countdown} sekúnd"],
    ...
    "Select timezone to apply" : "Vyberte časové pásmo, ktoré sa má použiť",
    "Use original timezone ({pollTimezone})" : "Použiť pôvodné časové pásmo ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Použiť svoje časové pásmo ({localTimezone})",
    ...
    "Allow download of poll results" : "Povoliť stiahnutie výsledkov ankety",
    ...
    "This will irreversibly delete the poll and {username} will get notified." : "Anketa sa nenávratne odstráni a používateľ {username} bude o tom informovaný.",
    "This will irreversibly delete the poll." : "Anketa sa nenávratne odstráni.",
    "OK" : "OK",
    ...
    "Expand options" : "Rozbaliť možnosti",
    ...
    "Submit" : "Odoslať",
    "_%n repetition_::_Last of %n repetitions_" : ["%n opakovanie","Posledné z %n opakovaní","Posledné z %n opakovaní","Posledné z %n opakovaní"],
    ...
    "Expand description" : "Rozbaliť popis",
    ...
    "Current timezone: {timezoneString}" : "Aktuálne časové pásmo: {timezoneString}",
    "Original timezone: {timezoneString}" : "Pôvodné časové pásmo: {timezoneString}",
    ...
    "Description" : "Popis",
    "Expired {dateTime}" : "Platnosť uplynula {dateTime}",
    "Last activity {dateTime}" : "Posledná aktivita {dateTime}",
    ...
    "Register to this poll" : "Zaregistrovať sa do tejto ankety",
    ...
    "Days after which archived polls should be permanently deleted" : "Počet dní, po ktorých sa archivované ankety natrvalo odstránia",
    ...
    "Use the default terms for public polls" : "Použiť predvolené podmienky pre verejné ankety",
    ...
    "Error sending invitations" : "Chyba pri odosielaní pozvánok",
    ...
    "Set default timezone for this poll" : "Nastaviť predvolené časové pásmo pre túto anketu",
    ...
    "Your timezone: ({timezone})" : "Vaše časové pásmo: ({timezone})",
    "Poll timezone: ({timezone})" : "Časové pásmo ankety: ({timezone})",
    ...
    "Type to start searching …" : "Ak chcete začať vyhľadávať, píšte …",
    ...
    "Or [link]login[/link] if you are a member of this site." : "Alebo sa [link]prihláste[/link], ak ste členom tejto stránky.",
    ...
    "Access" : "Prístup",
    "Sort by access level" : "Zoradiť podľa úrovne prístupu",
    "Owner" : "Vlastník",
    "Sort by name of the owner" : "Zoradiť podľa mena vlastníka",
    "Expiration" : "Koniec platnosti",
    "Sort by expiration date" : "Zoradiť podľa dátumu exspirácie",
    "Sort by activity" : "Zoradiť podľa aktivity",
    "Relevant" : "Dôležité",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "Relevantné ankety, ktoré sa vás týkajú, pretože ste účastníkom, vlastníkom alebo ste pozvaní. Zobrazujú sa iba ankety, ktoré nie sú staršie ako 100 dní vzhľadom na vytvorenie, poslednú aktivitu, uplynutie platnosti alebo najnovšiu možnosť (pri anketách s dátumami).",
