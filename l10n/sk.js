OC.L10N.register(
    ...
    "Currently no users have access to this poll" : "V súčasnosti nemá žiadny užívateľ prístup k tejto ankete",
    ...
    "{username} is invalid or reserved." : "{username} je neplatné alebo rezervované",
    ...
    "After how many days are the closed polls to be archived:" : "Po koľkých dňoch budú uzavreté ankety archivované:",
    ...
    "Disallow open polls" : "Zakázať otvoriť ankety",
    "Allow creating open polls for the following groups" : "Povoliť zdieľanie hlasovaní pre všetkých užívateľov nasledujúcich skupín",
    ...
    "Access for all users of this site is disabled" : "Prístup k tejto stránke je pre všetkých užívateľov zakázaný",
    "Access for all users of this site is enabled" : "Prístup k tejto stránke je pre všetkých užívateľov povolený",
    ...
    "Take over" : "Prebrať",
    "Do you want to take over this poll from {username} and change the ownership?" : "Chcete prevziať túto anketu od používateľa {username} a zmeniť vlastníctvo?",
    "The original owner will be notified." : "Pôvodný vlastník bude upozornený.",
    "Yes" : "Áno",
    ...
    "Your app settings" : "Nastavenia vašej aplikácie",
    ...
    "Select poll" : "Vyberte anketu",
    "Link to a poll" : "Odkaz na anketu",
    "Details" : "Podrobnosti",
    ...
    "Open polls" : "Otvoriť ankety",
    "A complete list with all open polls on this site, regardless who is the owner." : "Úplný zoznam všetkých verejných ankiet na tejto stránke bez ohľadu na to, kto je vlastníkom.",
