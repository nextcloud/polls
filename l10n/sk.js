OC.L10N.register(
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "Odstránili ste voľbu {optionTitle} z ankety {pollTitle}",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor} odstránil voľbu {optionTitle} z ankety {pollTitle}",
    ...
    "{sharee} has changed his email address" : "{sharee} zmenil svoju emailovú adresu",
    "You have changed your name" : "Zmenili ste si vaše meno",
    "{sharee} has changed his name" : "{sharee} zmenil svoje meno",
    ...
    "You have removed option {optionTitle}" : "Odstránili ste možnosť {optionTitle}",
    "{actor} has removed option {optionTitle}" : "{actor} odstránil možnosť {optionTitle}",
    ...
    "Send confirmation emails" : "Posielať potvrdenie e-mailom",
    "Sent emails to:" : "Poslať e-maily na:",
    "Emails could not be sent:" : "E-maily nemohli byť odoslané:",
    "Send information about confirmed options by email" : "Poslať informácie o potvrdených možnostiach e-mailom",
    "Inform your participants about the confirmed options" : "Informujte svojich účastníkov o potvrdených možnostiach",
    "Confirmations processed" : "Potvrdenia boli spracované",
    "Confirmation sent to ${confirmation}" : "Potvrdenie odoslané ${confirmation}",
    "Confirmation could not be sent to ${confirmation}" : "Potvrdenie sa nepodarilo odoslať ${confirmation}",
    ...
    "Limit \"Yes\" votes per user" : "Obmedziť hlasovanie \"Áno\" na jedného užívateľa",
    "Title" : "Názov",
    ...
    "Download Excel spreadsheet" : "Stiahnuť Excel tabluľku",
    ...
    "Each line creates a new option. Duplicates will get skipped without warning." : "Každý riadok vytvára jednu novú možnosť. Duplikáty budú preskočené bez varovania.",
    "Close" : "Zatvoriť",
    ...
    "Invite users via the share tab in the sidebar" : "Pozvite užívateľov cez kartu zdieľania na bočnom paneli",
    "A private poll from {name}" : "Privátna anketa od {name}",
    ...
    "Openly accessible and relevant poll" : "Otvorene prístupná a relevantná anketa",
    ...
    "You are a registered user of this site?" : "Ste registrovaným uživateľom na tejto stránke?",
    "Login" : "Prihlásiť sa",
    "As a regular user of this site, you can participate with your internal identity after logging in." : "Ako pravidelný používateľ týchto stránok sa môžete zúčastniť so svojou identitou po prihlásení.",
    "Otherwise participate publicly." : "Inak sa môžete zúčastniť verejne.",
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Je vyžadovaná vaša e-mail adresa. Po registrácii bude váš osobný odkaz odoslaný na túto adresu.",
    "With your email address you can subscribe to notifications and you will receive your personal link to this poll." : "Pomocou svojej e-mailovej adresy sa môžete prihlásiť na odber upozornení a dostanete svoj osobný odkaz na túto anketu.",
    ...
    "Deactivate combo view for all users" : "Deaktivovať kombinované zobrazenie pre všetkých užívateľov",
    "Allow combo view for the following groups" : "Povoliť kombinované zobrazenie pre nasledujúce skupiny",
    "Leave empty to disallow for all." : "Nechajte prázdne pre zákaz pre všetkých.",
    ...
    "Preview" : "Náhľad",
    "Hide email addresses of internal users" : "Skryť e-mail adresy interných užívateľov",
    "Show email addresses of internal users to members of the following groups" : "Zobraziť e-mail adresy užívateľom z nasledujúcich skupín",
    "The privacy link and the legal notice link are automatically added to the registration dialog of public polls." : "Odkaz na ochranu osobných údajov a odkaz na právne oznámenie sa automaticky pridajú do dialógu registrácie verejných ankiet.",
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "V predvolenom nastavení sa používajú odkazy nakonfigurované v aplikácii vzhľadu. Vo verejných anketách môžu byť tieto prepísané individuálnymi termínmi.",
    ...
    "Track activities" : "Zaznamenať aktivity",
    "Hide login option in public polls" : "Skryť možnosť prihlásenia vo verejných anketách",
    "Archive closed polls automatically" : "Archivovať uzavreté ankety automaticky",
    "After how many days are closed polls to be archived:" : "Po koľkých dňoch budú uzavreté ankety archivované:",
    "Activate long polling for instant updates" : "Aktivujte si dlhé dotazovanie pre okamžité aktualizácie",
    "Activate periodic polling of updates from the client" : "Aktivujte si periodické dotazovanie na aktualizácie z klienta",
    "Disable automatic updates (reload app for updates)" : "Vypnúť automatické aktualizácie (reštartovať aplikáciu pre aktualizácie)",
    "Disallow poll creation for all users" : "Zakázať vytváranie ankiet pre všetkých užívateľov",
    "Allow poll creation for the following groups" : "Povoliť vytváranie ankiet pre nasledujúce skupiny",
    "Disallow poll download" : "Vypnúť možnosť stiahnutia ankety",
    "Allow poll download for the following groups" : "Povoliť stiahnutie ankety pre nasledujúce skupiny",
    "Disallow public shares" : "Zakázať verejné zdieľanie",
    "Allow public shares for the following groups" : "Povoliť verejné zdieľanie pre nasledujúce skupiny",
    "Disallow openly accessible polls" : "Nepovoliť otvorene prístupné ankety",
    "Allow creating openly accessible polls for the following groups" : "Povoliť vytváranie otvorene prístupných ankiet pre nasleducúce skupiny",
    ...
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Ak sa tento prah prekročí, zobrazí sa iba aktuálny užívateľ, aby sa predišlo zníženiu výkonu.",
    ...
    "Use alternative styling for the comments sidebar" : "Použite alternatívny štýl pre bočný panel komentárov",
    ...
    "Do not ask for email address" : "Nepýtať si e-mail adresu",
    ...
    "Please be careful when changing options, because it can affect existing votes in an unwanted manner." : "Pri zmene možností buďte opatrní, pretože to môže nežiaducim spôsobom ovplyvniť existujúce hlasovania.",
    ...
    "Allow proposals from users" : "Povoliť návrhy užívateľov",
    ...
    "Restrict the share actions globally or on a group base" : "Obmedzte akcie zdieľania globálne alebo na skupinovej báze",
    "Poll creation restrictions" : "Obmedzenia pre vytváranie ankety",
    "Restrict the creation of new polls globally or on a group base" : "Obmedzte vytváranie nových ankiet globálne alebo na skupinovej báze",
    "Legal terms for public poll registration" : "Právne podmienky registrácie verejnej ankety",
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Prepíšte predvolené odkazy svojho webu na vaše právne podmienky. Ak chcete použiť odkazy, ktoré sú nakonfigurované v aplikácii na vytváranie tém, nechajte prázdne.",
    ...
    "_%n of {maximalVotes} vote left._::_%n of {maximalVotes} votes left._" : ["ostáva %n z {maximalVotes} hlasu.","ostáva %n z {maximalVotes} hlasov.","ostáva %n z {maximalVotes} hlasov.","ostáva %n z {maximalVotes} hlasov."],
    "Minute" : "Minúta",
    "Hour" : "Hodina",
    "Day" : "Deň",
    "Month" : "Mesiac",
    ...
    "Allow proposals" : "Povoliť návrhy",
    "Relevant" : "Dôležité",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without polls closed more than five days ago." : "Všetky ankety, ktoré s vami súvisia alebo sú pre vás dôležité, pretože ste ich účastníkom alebo vlastníkom alebo ste boli k nim pozvaní. Ankety, ktorých platnosť skončila pred viac ako piatimi dňami, sa tu nezobrazujú.",
    ...
    "Openly accessible polls" : "Otvorene prístupný ankety",
