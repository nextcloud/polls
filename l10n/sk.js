OC.L10N.register(
    ...
    "The names of other participants are hidden, as this is an anonymous poll. " : "Mená ostatných účastníkov sú skryté, pretože ide o anonymnú anketu.",
    "Results are hidden. " : "Výsledky sú skryté. ",
    "They will be revealed after the poll is expired. " : "Budú zverejnené po skončení ankety. ",
    "_%n person participated in this poll until now. _::_%n persons participated in this poll until now. _" : ["Do tejto ankety sa doteraz zapojil %n človek.","Do tejto ankety sa doteraz zapojili %n ľudia.","Do tejto ankety sa doteraz zapojili %n ľudia.","Do tejto ankety sa doteraz zapojilo %n ľudí."],
    "New comment …" : "Nový komentár …",
    "Your comment was added" : "Váš komentár bol pridaný",
    "You can place your vote until %n. " : "Hlasovať môžete do %n. ",
    "Error while saving comment" : "Pri ukladaní komentára sa vyskytla chyba",
    "Voting is no more possible, because this poll expired since %n. " : "Hlasovanie už nie je možné, pretože platnosť tejto ankety skončila %n.",
    "Comments" : "Komentáre",
    ...
    "Cancel" : "Zrušiť",
    "Apply" : "Aplikovať",
    "Poll \"%n\" added" : "Anketa „%n“ bola pridaná",
    "Error while creating Poll \"%n\"" : "Chyba pri vytváraní ankety „%n“",
    ...
    "Delete poll as admin" : "Odstrániť anketu ako správca",
    "Delete poll" : "Zmazať anketu",
    "Restore poll as admin" : "Obnoviť anketu ako správca",
    "Restore poll" : "Obnoviť anketu",
    "Delete poll permanently as admin" : "Natrvalo odstrániť anketu ako správca",
    ...
    "To participate, enter a username with at least 3 characters." : "Ak sa chcete zúčastniť, zadajte používateľské meno s najmenej 3 znakmi.",
    "Enter your name" : "Zadajte svoje meno",
    "Username is not valid. Please enter at least 3 characters." : "Používateľské meno nie je platné. Zadajte aspoň 3 znaky.",
    "This username is not valid, i.e. because it is already in use." : "Toto používateľské meno už bolo použité - zadajte prosím iné.",
    ...
    "This are your polls (where you are the owner)." : "Toto sú vaše ankety (ktorých ste vlastníkom)",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Toto sú všetky ankety, ktoré s vami súvisia alebo sú pre vás dôležité, pretože ste ich účastníkom alebo vlastníkom alebo ste boli  k nim pozvaní. Ankety, ktorým už skončila platnosť, sa tu nezobrazujú.",
    ...
    "These are all hidden polls, to which you have access." : "Toto sú všetky skryté ankety, ku ktorým máte prístup.",
    "This is simply the trash bin." : "Toto je jednoducho kôš.",
    ...
    "Switch view" : "Prepnúť zobrazenie",
    "Toggle Sidebar" : "Prepnúť bočný panel",
    "Expired" : "Platnosť skončila",
    "Deleted" : "Zmazané",
    "There are no vote options, add some in the options section of the right side bar." : "Nie sú tu žiadne možnosti voľby, pridajte nejaké v časti Voľby na pravej bočnej lište.",
    ...
    "You are either not allowed to delete this poll or it doesn't exist." : "Buď nemáte povolenie túto anketu odstrániť alebo neexistuje."
},
