OC.L10N.register(
    ...
    "This is a public poll." : "Toto je verejná anketa.",
    "Your personal link to this poll: {linkURL}" : "Váš osobný odkaz k tejto ankete: {linkURL}",
    "Copy this link to the clipboard" : "Skopírovať tento odkaz do schránky",
    "Invitation sent to {emailAddress}" : "Pozvánka poslaná na {emailAddress}",
    "Error sending invitation to {emailAddress}" : "Chyba pri posielaní pozvánky na {emailAddress}",
    ...
    " " : " ",
    "This email address is not valid." : "Táto emailová adresa nie je platná.",
    "This email address is valid." : "Táto emailová adresa je platná.",
