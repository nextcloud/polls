OC.L10N.register(
    ...
    "Send confirmation emails" : "Megerősítő e-mailek küldése",
    ...
    "Otherwise participate as a guest user." : "Ellenkező esetben vegyen részt vendégfelhasználóként.",
    ...
    "After how many days are closed polls to be archived:" : "Hány nap után legyenek a lezárt szavazások archiválva:",
    ...
    "Delete share and remove user from poll" : "Megosztás törlése és a felhasználó eltávolítása a szavazásból",
    "Delete share" : "Megosztás törlése",
    "Share for user {displayName} unlocked" : "{displayName} megosztásának zárolása feloldva",
    "Share for user {displayName} locked" : "{displayName} megosztása zárolva",
    "Error while changing lock status for user {displayName}" : "Hiba lépett fel {displayName} felhasználó zárolási állapotának megváltoztatása közben",
    "Share and votes for {displayName} deleted" : "{displayName} megosztása és szavazásai törölve",
    "Share for user {displayName} deleted" : "{displayName} megosztása törölve",
    "Error deleting share for user {displayName}" : "Hiba lépett fel {displayName} felhasználó megosztásának törlése közben",
    ...
    "Allow proposals" : "Javaslatok engedélyezése",
    "Relevant" : "Releváns",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Az összes olyan szavazás, amely releváns és fontos Önnek, mert résztvevő, tulajdonos vagy meghívták.",
