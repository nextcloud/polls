OC.L10N.register(
    ...
    "Updated poll configuration. Please check your votes." : "A szavazás beállításai frissültek. Ellenőrizze a szavazatait.",
    "The poll has been deleted." : "Szavazás törölve.",
    "The poll has been restored." : "Szavazás visszaállítva.",
    "The poll has been closed." : "Szavazás lezárva.",
    "A voting option has been added." : "Egy opciót hozzáadva a szavazáshoz.",
    "A voting option has been changed." : "Egy opciót módosítva a szavazáshoz.",
    "A voting option has been confirmed." : "Szavazási opció jóváhagyva.",
    "A voting option has been removed." : "Szavazási opció eltávolítva.",
    ...
    "{actor} has invited you to the poll \"%s\"." : "{actor} meghívott a \" 1%s\" szavazásra.",
    ...
    "For polls with expiration:" : "Lejárt szavazásaid:",
    "48 hours before the expiration date, if the poll is created more than 5 days before the expiration." : "2 nap van az idő lejárta előtt, de a szavazást 5 napja hozták létre",
    ...
    "Propose a date" : "Válassz dátumot",
    ...
    "Receive notification email on activity to {emailAddress}" : "Értesítő e-mail a tevékenységről a(z) {emailAddress} címre",
    ...
    "Error deleting email address {emailAddress}" : "Hiba történt a(z) {emailAddress} e-mail-cím törlésekor",
    "Email address {emailAddress} saved." : "A(z) {emailAddress} e-mail-cím mentve.",
    "Error saving email address {emailAddress}" : "Hiba történt a(z) {emailAddress} e-mail-cím mentésekor",
    ...
    "Vote saved" : "Szavazás mentve",
    "Error saving vote" : "Hiba a szavazás mentésekor",
    "Delete votes" : "Szavazatok törlése",
    "User {userId} removed" : "{userId} felhasználó törölve",
    "Share restrictions" : "Megosztási korlátozások",
    "Poll creation restrictions" : "Szavazás létrehozási korlátozások",
    ...
    "Error archiving/restoring poll." : "Hiba a szavazás archiválása/visszaállítása közben.",
    ...
    "Archive" : "Archívum",
    "My archived polls" : "Archivált szavazásaim",
    "Your archived polls are only accessible to you." : "Archivált szavazásaidhoz csak te férsz hozzá."
},
