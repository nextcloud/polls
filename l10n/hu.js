OC.L10N.register(
    ...
    "You have removed option {optionTitle}" : "Eltávolította a(z) {optionTitle} lehetőséget",
    "{actor} has removed option {optionTitle}" : "{actor} eltávolította a(z) {optionTitle} lehetőséget",
    ...
    "Limit \"Yes\" votes per user" : "Az „Igen” szavazatok korlátozása felhasználónként",
    "Title" : "Cím",
    ...
    "Number of items to create:" : "Létrehozandó elemek száma:",
    "OK" : "Rendben",
    "Week" : "Hét",
    ...
    "Openly accessible and relevant poll" : "Nyilvánosan elérhető és releváns szavazás",
    ...
    "Save username in cookie for 30 days" : "Felhasználónév sütibe mentése 30 napig",
    ...
    "Deactivate combo view for all users" : "Összevont nézet kikapcsolása az összes felhasználónál",
    "Allow combo view for the following groups" : "Összevont nézet engedélyezése a következő csoportoknak",
    "Leave empty to disallow for all." : "Hagyja üresen, hogy mindenkinél tiltsa.",
    ...
    "Track activities" : "Tevékenységek követése",
    "Hide login option in public polls" : "Bejelentkezési lehetőség elrejtése a nyilvános szavazásoknál",
    "Archive closed polls automatically" : "Lezárt szavazások automatikus archiválása",
    "After how many days are the closed polls to be archived:" : "Hány nap után legyenek a lezárt szavazások archiválva:",
    "Activate long polling for instant updates" : "Hosszú lekérdezés aktiválása az azonnali frissítéshez",
    "Activate periodic polling of updates from the client" : "Frissítések periodikus lekérésének aktiválása",
    "Disable automatic updates (reload app for updates)" : "Automatikus frissítések letiltása (alkalmazás újratöltése a frissítéshez)",
    "Disallow poll creation for all users" : "Szavazások létrehozásának letiltása az összes felhasználó számára",
    "Allow poll creation for the following groups" : "Szavazások létrehozásának engedélyezése a következő csoportok számára",
    "Disallow poll download" : "Szavazások letöltésének letiltása",
    "Allow poll download for the following groups" : "Szavazások letöltésének engedélyezése a következő csoportok számára",
    "Disallow public shares" : "Nyilvános megosztások letiltása",
    "Allow public shares for the following groups" : "Nyilvános meogsztások engedélyezése a következő csoportok számára",
    ...
    "Use calendar lookup" : "Naptárkeresés használata",
    "Check, if an option in a date poll is conflicting with or near an entry in your calendar." : "Ellenőrzés, hogy a dátumszavazás egyik lehetősége ütközik-e a naptár bejegyzésével vagy annak közelében van-e.",
    "Opt in to the calendars, which should be checked." : "Válassza ki azokat a naptárakat, amelyeket ellenőrizni szeretne.",
    ...
    "Adopt dashboard style" : "Irányítópult stílusának átvétele",
    "Set individual styles" : "Különálló stílusok beállítása",
    "Use background color" : "Háttérszín használata",
    "Use background image" : "Háttérkép használata",
    "Enter the URL of your favorite background image." : "Adja meg a kedvenc háttérképének URL-jét.",
    ...
    "Do not ask for email address" : "Nem kérjen e-mail-címet",
    ...
    "Share restrictions" : "Megosztási korlátozások",
    "Restrict the share actions globally or on a group base" : "Megosztási műveletek globális vagy csoportszintű korlátozása",
    "Poll creation restrictions" : "Szavazáslétrehozási korlátozások",
    ...
    "Goto Nextcloud" : "Ugrás a Nextcloudhoz",
    "Error loading poll" : "Hiba a szavazás betöltése során",
    "No polls found" : "Nem találhatók szavazások",
    "Select poll" : "Válasszon szavazást",
    "Link to a poll" : "Hivatkozás egy szavazáshoz",
    "Details" : "Részletek",
    ...
    "Polls user settings" : "Szavazások felhasználói beállításai",
    ...
    "Due to performance concerns {countHiddenParticipants} voters are hidden." : "Teljesítménybeli okok miatt {countHiddenParticipants} szavazó rejtett.",
