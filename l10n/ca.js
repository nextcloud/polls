OC.L10N.register(
    ...
    "The used time zone is \"%s\". To view the times in your current time zone, enter the poll by clicking the button below." : "La zona horària utilitzada és \"%s\". Per veure els horaris de la vostra zona horària actual, introduïu l'enquesta fent clic al botó següent.",
    ...
    "%s is the new owner of your poll." : "%s és el nou propietari de la teva enquesta.",
    "{actor} transfered your poll \"%s\" to {newOwner}. You are no more the owner." : "{actor} ha transferit l'enquesta \"%s\" a {newOwner}. Ja no n'ets el propietari.",
    ...
    "This poll does not exist (anymore)." : "Aquesta enquesta ja no existeix.",
    "Access denied" : "Accés denegat",
    "You have no access to this poll. Contact %s if you think this is a mistake." : "No tens accés a aquesta enquesta. Contacta amb %s si creus que es tracta d'un error.",
    ...
    "You have closed the poll \"{pollTitle}\"" : "Heu tancat l'enquesta \"{pollTitle}\"",
    ...
    "You have reopened the poll \"{pollTitle}\"" : "Heu reobert l'enquesta \"{pollTitle}\"",
    ...
    "One or more orphaned votes heve been deleted from {pollTitle}" : "S'han suprimit un o més vots orfes de {pollTitle}",
    "Orphaned votes deleted" : "Vots orfes suprimits",
    "{actor} deleted orphaned votes" : "{actor} ha suprimit vots orfes",
    ...
    "You have shared poll {pollTitle} with team {sharee}" : "Heu compartit l'enquesta {pollTitle} amb l'equip {sharee}",
    "{actor} has shared poll {pollTitle} with team {sharee}" : "{actor} ha compartit l'enquesta {pollTitle} amb l'equip {sharee}",
    "You have shared this poll with team {sharee}" : "Heu compartit aquesta enquesta amb l'equip {sharee}",
    "{actor} has shared this poll with team {sharee}" : "{actor} ha compartit aquesta enquesta amb l'equip {sharee}",
    ...
    "You have deleted the share for team {sharee} from poll {pollTitle}" : "Heu suprimit la compartició per a l'equip {sharee} de l'enquesta {pollTitle}",
    "{actor} has deleted the share for team {sharee} from poll {pollTitle}" : "{actor} ha eliminat la compartició per a l'equip {sharee} de l'enquesta {pollTitle}",
    "You have deleted the share for team {sharee}" : "Heu suprimit la compartició per a l'equip {sharee}",
    "{actor} has deleted the share for team {sharee}" : "{actor} ha suprimit la compartició per a l'equip {sharee}",
    ...
    "You have restored the share for team {sharee} from poll {pollTitle}" : "Heu restaurat la compartició per a l'equip {sharee} de l'enquesta {pollTitle}",
    "{actor} has restored the share for team {sharee} from poll {pollTitle}" : "{actor}ha restaurat la compartició per a l'equip {sharee} de l'enquesta {pollTitle}",
    "You have restored the share for team {sharee}" : "Heu restaurat la compartició per a l'equip {sharee}",
    "{actor} has restored the share for team {sharee}" : "{actor} ha restaurat la compartició per a l'equip {sharee}",
    ...
    "Someone voted in a <strong>poll</strong>" : "Algú ha votat en una <strong>enquesta</strong>",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access." : "Una aplicació d'enquestes, similar a Doodle/DuD-Poll amb la possibilitat de restringir l'accés.",
    "A polls app, similar to Doodle/DuD-Poll with the possibility to restrict access (members, certain groups/users, hidden and public)." : "Una aplicació d'enquestes, similar a Doodle/DuD-Poll amb la possibilitat de restringir l'accés (membres, determinats grups/usuaris, ocult i públic).",
    "Add option" : "Afegeix una opció",
    "Add poll" : "Afegeix una enquesta",
    "\"{pollTitle}\" has been successfully created." : "\"{pollTitle}\" s'ha creat correctament.",
    "Poll created" : "Enquesta creada",
    "Add another poll" : "Afegeix una altra enquesta",
    ...
    "Please wait…" : "Espereu…",
    "Add" : "Afegeix",
    "You are asked to propose more options." : "Se us demana que proposeu més opcions. ",
    "The proposal period ends {timeRelative}." : "El període de propostes acaba el {timeRelative}",
    "Propose an option" : "Proposa una opció",
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "Aquesta enquesta és anònima per a tothom, inclòs el propietari. La desanonimització està desactivada per a aquesta enquesta.",
    ...
    "No more voting options are available." : "No hi ha més opcions de vot disponibles.",
    ...
    "You have no votes left." : "No et queden vots.",
    ...
    "Select timezone to apply" : "Selecciona la zona horària a aplicar",
    "Use original timezone ({pollTimezone})" : "Utilitza la zona horària original ({pollTimezone})",
    "Use your timezone ({localTimezone})" : "Utilitza la teva zona horària ({localTimezone})",
    ...
    "For polls with expiration" : "Per a enquestes amb data de caducitat",
    ...
    "For date polls without expiration" : "Per a enquestes de data sense caducitat",
    ...
    "Transfer poll" : "Transferir l'enquesta",
    ...
    "Use explicit \"No\" votes" : "Utilitzeu vots explícits de \"No\"",
    ...
    "\"{pollTitle}\" has been added" : "\"{pollTitle}\" s'ha afegit",
    "Choose a meaningful title for your poll" : "Escull un títol significatiu per a la vostra enquesta",
    "Close" : "Tanca",
    "Yes" : "Sí",
    "No" : "No",
    ...
    "OK" : "D'acord",
    "Add date option" : "Afegir una opció de data",
    "Existing options" : "Opcions existents",
    "Transfered poll to {user}." : "Transfereix l'enquesta a {user}.",
    "Error transfering poll." : "Error en transferir l'enquesta.",
    "Transfering a poll to another user may result in loss of access to this poll." : "Transferir una enquesta a un altre usuari pot comportar la pèrdua d'accés a aquesta enquesta.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "Transferir una enquesta a {user} pot comportar la pèrdua d'accés a aquesta enquesta.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "No ets el propietari d'aquesta enquesta. {owner} rebrà informació sobre la transferència a {newUser}.",
    ...
    "Expand options" : "Expandir opcions",
    "Available options" : "Opcions disponibles",
    "Add a new date/time" : "Afegeix una nova data/hora",
    "Timezone" : "Fus horari",
    "Duration" : "Duració",
    "Duration time unit" : "Unitat de temps de la durada",
    "Repetitions" : "Repeticions",
    "All day" : "Tot el dia",
    "Automatically vote \"Yes\" for new option." : "Vota automàticament \"Sí\" per a la nova opció.",
    ...
    "Current timezone: {timezoneString}" : "Zona horària actual: {timezoneString}",
    "Original timezone: {timezoneString}" : "Zona horària original: {timezoneString}",
    ...
    "Choose a description for the overview page" : "Trieu una descripció per a la pàgina de resum",
    "Enter extended title" : "Introduïu un títol ampliat",
    "Description" : "Descripció",
    "Open poll, accessible to all users of this instance and invited participants" : "Enquesta oberta, accessible a tots els usuaris d'aquesta instància i als participants convidats",
    "never" : "mai",
    ...
    "Transfer poll ownership" : "Transfereix la propietat de l'enquesta",
    "Ascending" : "Ascendent",
    "Legal notice" : "Avís legal",
    "Privacy policy" : "Política de privadesa",
    ...
    "Register to this poll" : "Registra't en aquesta enquesta",
    ...
    "Verbose poll list" : "Llista d'enquestes detallada",
    "Check this for more poll information in the overview." : "Consulteu això per obtenir més informació sobre l'enquesta a la vista general.",
    ...
    "Forced display mode" : "Força el mode de visualització",
    "Set default timezone for this poll" : "Estableix la zona horària predeterminada per a aquesta enquesta",
    "Deletion and owner" : "Supressió i propietari",
    ...
    "Your timezone: ({timezone})" : "La teva zona horària: ({timezone})",
    "Poll timezone: ({timezone})" : "Zona horària de l'enquesta: ({timezone})",
    ...
    "Or [link]login[/link] if you are a member of this site." : "O [link]inicia sessió[/link] si ets membre d'aquest lloc.",
    ...
    "Relevant" : "Important",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last activity, expiration or latest option (for date polls) are shown." : "Enquestes rellevants que són rellevants per a tu, perquè ets participant, propietari o hi estàs convidat. Només es mostren les enquestes que no tinguin més de 100 dies d'antiguitat respecte a la creació, l'última activitat, el venciment o es mostren les últimes opcions (per a enquestes de dates).",
    "My polls" : "Les meves enquestes",
    "These are all polls where you are the owner." : "Totes aquestes són enquestes on tu ets el propietari.",
    ...
    "All polls in which you participated." : "Totes les enquestes en què has participat.",
    "Openly accessible polls" : "Enquestes d'accés obert",
    "A complete list with all openly accessible polls on this site." : "Una llista completa amb totes les enquestes d'accés obert en aquest lloc.",
