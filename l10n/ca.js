OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{sharee} ha canviat la seva adreça electrònica",
    "You have changed your name" : "Heu canviat el teu nom",
    "{sharee} has changed his name" : "{sharee} ha canviat el seu nom",
    ...
    "{actor} has deleted the share for circle {sharee} from poll {pollTitle}" : "{actor} ha suprimit la compartida del cercle {sharee} de l'enquesta {pollTitle}",
    ...
    "You have removed option {optionTitle}" : "Heu eliminat l'opció {optionTitle}",
    "{actor} has removed option {optionTitle}" : "{actor} ha eliminat l'opció {optionTitle}",
    ...
    "Send confirmation emails" : "Envieu correus electrònics de confirmació",
    "Sent emails to:" : "Enviat correus electrònics a:",
    "Emails could not be sent:" : "No s'han pogut enviar correus electrònics:",
    "Send information about confirmed options by email" : "Envieu informació sobre les opcions confirmades per correu electrònic",
    "Inform your participants about the confirmed options" : "Informeu els vostres participants sobre les opcions confirmades",
    "Confirmations processed" : "Confirmes processades",
    "Confirmation sent to ${confirmation}" : "Confirmació enviada a ${confirmation}",
    "Confirmation could not be sent to ${confirmation}" : "No s'ha pogut enviar la confirmació a ${confirmation}",
    ...
    "Conflict" : "Conflicte",
    "Got a network error while checking calendar events." : "S'ha produït un error de xarxa en comprovar els esdeveniments del calendari.",
    ...
    "If a share already got a reminder (no matter, if the expiration date got changed)." : "Si una quota ja ha rebut un recordatori (no importa, si la data de caducitat ha canviat).",
    ...
    "Delete vote when switched to \"No\"" : "Suprimeix el vot quan es canvia a \"No\"",
    "Limit \"Yes\" votes per user" : "Limiteu els vots \"Sí\" per usuari",
    "Title" : "Títol",
    ...
    "Download Excel spreadsheet" : "Descarregar full de càlcul Excel",
    "Download Open Document spreadsheet" : "Descarrega el full de càlcul Open Document",
    "Download CSV file" : "Descarrega el fitxer CSV",
    "Download HTML file" : "Descarrega el fitxer HTML",
    ...
    "Propose a date" : "Proposar una data",
    ...
    "Shifting dates is disabled to prevent shifting of other user's proposals." : "El canvi de dates està desactivat per evitar el canvi de propostes d'altres usuaris.",
    "Add option" : "Afegeix una opció",
    "Create multiple options at once" : "Creeu diverses opcions alhora",
    ...
    "Invite users via the share tab in the sidebar" : "Convida usuaris a través de la pestanya compartir a la barra lateral",
    ...
    "Openly accessible and relevant poll" : "Enquesta rellevant i d'accés obert",
    ...
    "valid email address." : "adreça de correu vàlida.",
    "Invalid email address." : "Adreça de correu electrònic invàlida.",
    "Public participation" : "Participació pública",
    ...
    "You are a registered user of this site?" : "Sou un usuari registrat d'aquest lloc?",
    "Login" : "Entra",
    "As a regular user of this site, you can participate with your internal identity after logging in." : "Com a usuari habitual d'aquest lloc, podeu participar amb la vostra identitat interna després d'iniciar sessió.",
    "Otherwise participate publicly." : "En cas contrari participa públicament.",
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "La vostra adreça de correu electrònic és necessària. Després del registre, el vostre enllaç personal a l'enquesta s'enviarà a aquesta adreça.",
    ...
    "Deactivate combo view for all users" : "Desactiva la vista combinada per a tots els usuaris",
    "Allow combo view for the following groups" : "Permet la vista combinada per als grups següents",
    "Leave empty to disallow for all." : "Deixeu buit per no permetre a tothom.",
    "Add terms links also to the email footer" : "Afegiu també enllaços de termes al peu de pàgina del correu electrònic",
    "Additional email disclaimer" : "Exempció de responsabilitat addicional per correu electrònic",
    "Preview" : "Previsualitza",
    "Hide email addresses of internal users" : "Amaga les adreces de correu electrònic dels usuaris interns",
    "Show email addresses of internal users to members of the following groups" : "Mostra les adreces de correu electrònic dels usuaris interns als membres dels grups següents",
    "The privacy link and the legal notice link are automatically added to the registration dialog of public polls." : "L'enllaç de privadesa i l'enllaç d'avís legal s'afegeixen automàticament al diàleg de registre de les enquestes públiques.",
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Per defecte s'utilitzen els enllaços configurats a l'aplicació de tematització. Per a les enquestes públiques, aquestes poden ser anul·lades per termes individuals.",
    ...
    "Track activities" : "Seguiment d'activitats",
    "Hide login option in public polls" : "Amaga l'opció d'inici de sessió a les enquestes públiques",
    "Archive closed polls automatically" : "Arxiva les enquestes tancades automàticament",
    "After how many days are closed polls to be archived:" : "Al cap de quants dies s'han d'arxivar les enquestes tancades:",
    "Activate long polling for instant updates" : "Activeu l'enquesta llarga per obtenir actualitzacions instantànies",
    "Activate periodic polling of updates from the client" : "Activar l'enquesta periòdica d'actualitzacions del client",
    "Disable automatic updates (reload app for updates)" : "Desactiva les actualitzacions automàtiques (recarrega l'aplicació per a actualitzacions)",
    "Disallow poll creation for all users" : "No permetre la creació d'enquestes per a tots els usuaris",
    "Allow poll creation for the following groups" : "Permet la creació d'enquestes per als grups següents",
    "Disallow poll download" : "No permet la baixada de l'enquesta",
    "Allow poll download for the following groups" : "Permet la baixada de les enquestes per als grups següents",
    "Disallow public shares" : "No permetre les accions públiques",
    "Allow public shares for the following groups" : "Permet compartir públics per als grups següents",
    "Disallow openly accessible polls" : "No permetre les enquestes d'accés obert",
    "Allow creating openly accessible polls for the following groups" : "Permet crear enquestes d'accés obert per als grups següents",
    ...
    "Check this, if you prefer to display text poll in a vertical aligned list rather than in the grid view. The initial default is list view." : "Marqueu-ho si preferiu mostrar l'enquesta de text en una llista alineada verticalment en lloc de la vista de quadrícula. El valor predeterminat inicial és la vista de llista.",
    "Date polls default to list view" : "Les enquestes de dates tenen per defecte la vista de llista",
    "Check this, if you prefer to display date poll in a vertical view rather than in the grid view. The initial default is grid view." : "Marqueu-ho si preferiu mostrar l'enquesta de data en una vista vertical en lloc de la vista de quadrícula. El valor predeterminat inicial és la vista de quadrícula.",
    ...
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Si aquest llindar es supera, només es mostrarà l'usuari actual, per evitar una caiguda de rendiment.",
    ...
    "The style settings are still experimental!" : "La configuració d'estil encara és experimental!",
    ...
    "Resolving of {name} is not possible. The circles app is not enabled." : "La resolució de {name} no és possible. L'aplicació cercles no està activada.",
    "Resolving of {name} is not possible. The contacts app is not enabled." : "La resolució de {name} no és possible. L'aplicació de contactes no està activada.",
    ...
    "Allow proposals from users" : "Permetre propostes dels usuaris",
    ...
    "Remove Email Address" : "Elimina l'adreça de correu electrònic",
    ...
    "Logout as {name} (delete cookie)" : "Tanca la sessió com a {name} (suprimeix la galeta)",
    "Email address deleted." : "S'ha suprimit l'adreça de correu electrònic.",
    "Error deleting email address {emailAddress}" : "S'ha produït un error en suprimir l'adreça electrònica {emailAddress}",
    "Valid name." : "Nom vàlid.",
    "Email address {emailAddress} saved." : "S'ha desat l'adreça electrònica {emailAddress}.",
    "Error saving email address {emailAddress}" : "S'ha produït un error en desar l'adreça electrònica {emailAddress}",
    ...
    "Share restrictions" : "Restriccions per compartir",
    "Restrict the share actions globally or on a group base" : "Restringeix les accions de compartició globalment o en grup",
    "Poll creation restrictions" : "Restriccions de creació d'enquestes",
    "Restrict the creation of new polls globally or on a group base" : "Restringeix la creació de noves enquestes a nivell global o grupal",
    "Legal terms for public poll registration" : "Condicions legals per al registre de votacions públiques",
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Substituïu els enllaços predeterminats del vostre lloc als vostres termes legals. Deixeu-lo en blanc per utilitzar els enllaços, que es configuren a l'aplicació de tematització.",
    ...
    "Activate or disable individual features." : "Activa o desactiva les funcions individuals.",
    ...
    "Manage polls of other users. You can take over the ownership or delete polls." : "Gestionar les enquestes d'altres usuaris. Podeu fer-ne càrrec de la propietat o suprimir les enquestes.",
    ...
    "Polls settings" : "Configuració de les enquestes",
    ...
    "Polls user settings" : "Enquestes de configuració de l'usuari",
    ...
    "Due to performance concerns {countHiddenParticipants} voters are hidden." : "A causa de l’efecte en el rendiment, s'han amagat {countHiddenParticipants} votants.",
    ...
    "Additionally the owner can remove the anonymous flag at any time, which will reveal the participant's names." : "A més, el propietari pot eliminar la marca anònima en qualsevol moment, la qual cosa revelarà els noms dels participants.",
    ...
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without polls closed more than five days ago." : "Totes les enquestes que siguin rellevants o importants per a tu, perquè ets un participant o el propietari o hi estàs convidat. Sense les enquestes tancades fa més de cinc dies.",
