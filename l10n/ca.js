OC.L10N.register(
    ...
    "{sharee} has changed his email address" : "{sharee} ha canviat la seva adreça de correu electrònic",
    ...
    "Inform your participants about the confirmed options" : "Informeu els vostres participants quant a les opcions confirmades",
    ...
    "Shifting dates is disabled to prevent shifting of other user's proposals." : "El canvi de dates està inhabilitat per evitar el canvi de propostes d'altres usuaris.",
    ...
    "Activate long polling for instant updates" : "Activa l'enquesta llarga per obtenir actualitzacions instantànies",
    "Activate periodic polling of updates from the client" : "Activa l'enquesta periòdica d'actualitzacions del client",
    "Disable automatic updates (reload app for updates)" : "Inhabilita les actualitzacions automàtiques (recarrega l'aplicació per a actualitzacions)",
    ...
    "Share restrictions" : "Restriccions de compartició",
    ...
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Substituïu els enllaços per defecte del vostre lloc als vostres termes legals. Deixeu-lo en blanc per utilitzar els enllaços, que es configuren a l'aplicació de tematització.",
    ...
    "Activate or disable individual features." : "Activa o inhabilita les funcions individuals.",
    ...
    "Polls settings" : "Paràmetres de les enquestes",
    ...
    "Polls user settings" : "Paràmetres de configuració de l'usuari",
