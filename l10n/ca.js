OC.L10N.register(
    ...
    "Edit poll as admin" : "Edita l'enquesta com a administrador",
    ...
    "Event schedule" : "Calendari d’esdeveniments",
    ...
    "Configuration is locked. Changing options may result in unwanted behaviour, but you can unlock it anyway." : "La configuració està blocada. El canvi d’opcions pot comportar un comportament no desitjat, però ho podeu desblocar de totes maneres.",
    ...
    "Yes, delete poll." : "Sí, suprimeix l'enquesta.",
    "Poll \"%n\" deleted" : "S'ha suprimit l'enquesta \"%n\"",
    "Error while deleting Poll \"%n\"" : "S'ha produït un error mentre es suprimia l'Enquesta \"%n\"",
