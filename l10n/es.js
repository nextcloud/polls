OC.L10N.register(
    ...
    "Create multiple options at once" : "Crear opciones múltiples de una vez",
    "Each line creates a new option. Duplicates will get skipped without warning." : "Cada línea crea una opción nueva. Los duplicados se saltarán sin ninguna advertencia.",
    "Close" : "Cerrar",
    ...
    "Openly accessible and relevant poll" : "Votación libremente accesible y relevante",
    "Openly accessible poll" : "Votación libremente accesible",
    ...
    "Otherwise participate as a guest user." : "De lo contrario, participe como invitado.",
    ...
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Por defecto se utilizan los enlaces configurados en la aplicación temática. En el caso de las votaciones públicas, estos pueden ser anulados por términos individuales.",
    ...
    "After how many days are closed polls to be archived:" : "Después de cuántos días se archivan las votaciones cerradas:",
    ...
    "Enter the amount of days, polls without activity stay in the relevant list:" : "Ingrese la cantidad de días que las votaciones sin actividad se mantendrán en la lista de relevantes:",
    ...
    "Allow proposals" : "Permitir propuestas",
    "Relevant" : "Relevante",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Todas las votaciones que son relevantes o importantes para ti, porque has participado, eres el propietario o te han invitado.",
