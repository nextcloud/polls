OC.L10N.register(
    ...
    "%s took over your poll" : "%s se ha hecho cargo de tu encuesta",
    "{actor} took over your poll \"%s\" and is the new owner." : "{actor} se ha hecho cargo de tu encuesta «%s» y es su nuevo/a dueño/a.",
    "%s deleted your poll" : "%s ha eliminado tu encuesta",
    "{actor} deleted your poll \"%s\"." : "{actor} ha eliminado tu encuesta «%s».",
    "%s archived your poll" : "%s ha archivado tu encuesta",
    "{actor} archived your poll \"%s\"." : "{actor} ha archivado tu encuesta «%s».",
    ...
    "You have unconfirmed option {optionTitle} of poll {pollTitle}" : "Has desconfirmado la opción {optionTitle} en la encuesta {pollTitle}",
    "{actor} has unconfirmed option {optionTitle} of poll {pollTitle}" : "{actor} ha desconfirmado la opción {optionTitle} en la encuesta {pollTitle}",
    ...
    "You have removed option {optionTitle} from poll {pollTitle}" : "Has eliminado la opción {optionTitle} de la encuesta {pollTitle}",
    "{actor} has removed option {optionTitle} from poll {pollTitle}" : "{actor} ha eliminado la opción {optionTitle} de la encuesta {pollTitle}",
    ...
    "You have reordered the options of poll {pollTitle}" : "Has reordenador las opciones de la encuesta {pollTitle}",
    ...
    "You have locked the share of {sharee}" : "Has bloqueado la compartición de {sharee}",
    "{actor} has locked the share of {sharee}" : "{actor} ha bloqueado la compartición de {sharee}",
    "You have unlocked the share of {sharee}" : "Has desbloqueado la compartición de {sharee}",
    "{actor} has unlocked the share of {sharee}" : "{actor} ha desbloqueado la compartición de {sharee}",
    "You have added a public share to poll {pollTitle}" : "Has añadido un enlace para compartir públicamente la encuesta {pollTitle}",
    "{actor} has added a public share to poll {pollTitle}" : "{actor} ha añadido un enlace para compatir públicamente la encuesta {pollTitle}",
    ...
    "You have deleted the share for {sharee} from poll {pollTitle}" : "Has dejado de compartir la encuesta {pollTitle} con {sharee}",
    "{actor} has deleted the share for {sharee} from poll {pollTitle}" : "{actor} ha dejado de compartir la encuesta {pollTitle} con {sharee}",
    ...
    "You have deleted a public share from poll {pollTitle}" : "Has eliminado una enlace público de la encuesta {pollTitle}",
    "{actor} has deleted a public share from poll {pollTitle}" : "{actor} ha eliminado un enlace público de la encuesta {pollTitle}",
    ...
    "You have deleted the share for group {sharee} from poll {pollTitle}" : "Has dejado de compartir la encuesta {pollTitle} con el grupo {sharee}",
    "{actor} has deleted the share for group {sharee} from poll {pollTitle}" : "{actor} ha dejado de compartir la encuesta {pollTitle} con el grupo {sharee}",
    ...
    "You have deleted the share for circle {sharee} from poll {pollTitle}" : "Has dejado de compartir la encuesta {pollTitle} con el círculo {sharee}",
    "{actor} has deleted the share for circle {sharee} from poll {pollTitle}" : "{actor} ha dejado de compartir la encuesta {pollTitle} con el círculo {sharee}",
    ...
    "You have deleted the share for contact group {sharee} from poll {pollTitle}" : "Has dejado de compartir la encuesta {pollTitle} con el grupo de contactos {sharee}",
    "{actor} has deleted the share for contact group {sharee} from poll {pollTitle}" : "{actor} ha dejado de compartir la encuesta {pollTitle} con el grupo de contactos {sharee}",
    ...
    "You have deleted a share from poll {pollTitle}" : "Has eliminado una forma de compartir la encuesta {pollTitle}",
    "{actor} has deleted a share from poll {pollTitle}" : "{actor} ha eliminado una forma de compartir la encuesta {pollTitle}",
    ...
    "Events happening inside of a <strong>poll</strong>" : "Eventos que suceden en una <strong>encuesta</strong>",
    "Someone voted inside a <strong>poll</strong>" : "Alguien ha votado en una <strong>encuesta</strong>",
    ...
    "48 hours before the expiration date, if the poll is created more than 5 days before the expiration." : "48 horas antes de la fecha de caducidad, si la encuesta ha sido creada más de 5 días antes de la fecha de caducidad.",
    "36 hours before the expiration date, if the poll is created more than 2 and less than 5 days before the expiration." : "36 horas antes de la fecha de caducidad, si la encuesta ha sido creada entre 2 y 5 días antes de la fecha de caducidad.",
    "For date polls without expiration:" : "Para encuestas sin caducidad:",
    "48 hours before the first date option, if the poll is created more than 5 days before the first date option." : "48 horas antes de la primera opción de fecha, si la encuesta ha sido creada más de 5 días antes de la primera opción de fecha.",
    ...
    "For polls created less than 2 days before the expiration." : "Para encuestas creadas menos de 2 días antes de su caducidad.",
    "If a share already got a reminder (no matter, if the expiration date got changed)." : "Si alguien con quien se ha compartido la encuesta ya ha recibido un recordatorio (independientemente de si ha cambiado o no la caducidad).",
    "If the poll is already closed." : "Si la encuesta ya está ha caducado.",
    ...
    "Openly accessible and relevant poll" : "Encuesta libremente accesible y relevante",
    ...
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Por defecto se utilizan los enlaces configurados en la aplicación temática. En el caso de las encuestas públicas, estos pueden ser anulados por términos individuales.",
    ...
    "Hide login option in public polls" : "Ocultar inicio de sesión en encuestas públicas",
    "Archive closed polls automatically" : "Archivar encuestas cerradas automáticamente",
    "After how many days are closed polls to be archived:" : "Después de cuántos días se archivan las encuestas cerradas:",
    ...
    "Disallow poll creation for all users" : "Prohibir la creación de encuestas para todos los usuarios",
    "Allow poll creation for the following groups" : "Permitir la creación de encuestas a los siguientes grupos",
    "Disallow poll download" : "No permitir la descarga de la encuesta",
    "Allow poll download for the following groups" : "Permitir que los siguientes grupos se bajen la encuesta",
    ...
    "Delete share and remove user from poll" : "Eliminar recurso compartido y quitar al usuario de la encuesta",
    ...
    "Share and votes of {displayName} deleted" : "Comparticiones y votos de {displayName} eliminados",
    "Share of {displayName} deleted" : "Comparticiones de {displayName} eliminadas",
    "Error deleting share of {displayName}" : "Error al eliminar compartición de {displayName}",
    ...
    "Your votes are reset" : "Tus votos han sido reiniciados",
    "Error while resetting votes" : "Se ha producido un error mientras se reiniciaban los votos",
    ...
    "Poll creation restrictions" : "Restricciones en la creación de encuestas",
    ...
    "Manage polls of other users. You can take over the ownership or delete polls." : "Gestionar encuestas de otros usuarios. Puedes tomar el control de las mismas, o eliminarlas.",
    ...
    "Select polls by clicking on them in the right sidebar!" : "¡Selecciona una encuesta pulsando en ella en la barra lateral derecha!",
    ...
    "Enter a poll or start a new one." : "Selecciona una encuesta o inicia una nueva.",
    ...
    "Activity" : "Actividad",
    "Select polls to combine" : "Selecciona las encuestas a combinar",
    "Search for conflicting calendar entries" : "Búsqueda de entradas conflictivas en el calendario",
    "Polls user settings" : "Configuración de usuario de las encuestas",
    ...
    "You can reveal them, but you may expect an unwanted long loading time." : "Puede revelarlos, pero espere por tiempos largos de carga no deseados.",
    ...
    "To participate, register a name and optionally with your email address." : "Para participar, regístrate con un nombre y, opcionalmente, con tu dirección de correo.",
    "To participate, register with a name." : "Para participar, regístrate con un nombre.",
    "This share is locked and allows only read access. Registering is not possible." : "Este recurso compartido está bloqueado y sólo permite acceso de sólo lectura. Registrarse no es posible.",
    ...
    "Some confirmation messages could not been sent." : "Algunos mensajes de confirmación podrían no haber sido enviados.",
    ...
    "Allow proposals" : "Permitir propuestas",
    "Relevant" : "Relevante",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Todas las encuestas que son relevantes o importantes para ti, porque has participado, eres el propietario o te han invitado.",
    "My polls" : "Mis encuestas",
    "Your polls (in which you are the owner)." : "Tus encuestas (de las que eres el propietario).",
    "Private polls" : "Encuestas privadas",
    "All private polls, to which you have access." : "Todas las encuestas a las que tienes acceso.",
    "Participated" : "Participado",
    "All polls, where you placed a vote." : "Todas las encuestas en las que has votado.",
    ...
    "Your archived polls are only accessible to you." : "Solo usted puede acceder a sus encuestas archivadas.",
    "Maybe" : "Quizás"
},
