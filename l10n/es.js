OC.L10N.register(
    ...
    "Hide email address" : "Esconder tu correo electrónico",
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "Agregue los parámetros de URL 'name =' y/o 'email =' para predefinir el nombre y la dirección de correo electrónico. Por ejemplo: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org",
