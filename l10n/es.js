OC.L10N.register(
    ...
    "_%n vote is allowed per user._::_%n votes are allowed per user._" : ["Se permite %n voto por usuario.","Se permiten %n votos por usuario.","Se permiten %n votos por usuario."],
    ...
    "_%n orphaned vote of a probaly deleted option is possibly blocking your vote limit._::_%n orphaned votes of probaly deleted options are possibly blocking your vote limit._" : ["%n voto huérfano de una opción que está probablemente eliminada está bloqueando posiblemente su límite de votos.","%n votos huérfanos de opciones que están probablemente eliminadas están bloqueando posiblemente su límite de votos.","%n votos huérfanos de opciones que están probablemente eliminadas están bloqueando posiblemente su límite de votos."],
    ...
    "Limit \"Yes\" votes per user" : "Limitar el número de votos \"Sí\" por usuario/a",
    "Title" : "Título",
    ...
    "Leave empty to disallow for all." : "Déjelo vacío para prohibirlo a todos.",
    ...
    "As a default the links configured in the theming app are used. For public polls these can be overriden by individual terms." : "Se utilizan los enlaces configurados en la aplicación temática de forma predeterminada. En el caso de las encuestas públicas, estos pueden ser anulados por términos individuales.",
    ...
    "Track activities" : "Monitorizar actividades",
    ...
    "Disallow poll download" : "No permitir la descarga de encuestas",
    "Allow poll download for the following groups" : "Permitir que los siguientes grupos descarguen encuestas",
    "Disallow public shares" : "Prohibir recursos compartidos públicos",
    "Allow public shares for the following groups" : "Permitir recursos compartidos públicos para los siguientes grupos",
    ...
    "Share restrictions" : "Restricciones del recurso compartido",
    "Restrict the share actions globally or on a group base" : "Restringir las acciones del recurso compartido globalmente o en base a grupos",
    "Poll creation restrictions" : "Restricciones en la creación de encuestas",
    "Restrict the creation of new polls globally or on a group base" : "Restringir la creación de nuevas encuestas de forma global o basada en grupos",
    "Legal terms for public poll registration" : "Términos legales para el registro de encuestas públicas",
    "Override the default links of your site to your legal terms. Leave empty to use the links, which are configured in the theming app." : "Anule los enlaces predeterminados de su sitio con sus términos legales. Déjelo vacío para utilizar los enlaces, que se configurarán en la aplicación de temas.",
    ...
    "Allow proposals" : "Permitir propuestas",
    "Relevant" : "Relevante",
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to." : "Todas las encuestas que son relevantes o importantes para ti, porque ha participado, Ud. es el propietario o te ha sido invitado.",
