OC.L10N.register(
    ...
    "A poll from {name}" : "Una encuesta de {name}",
    "Archived" : "Archivada",
    ...
    "Your email address is required. After the registration your personal link to the poll will be sent to this address." : "Tu dirección de correo es obligatoria. Tras registrarte, tu enlace personal a la encuesta será enviado a ese correo.",
    ...
    "After how many days are the closed polls to be archived:" : "Después de cuántos días se archivan las encuestas cerradas:",
    ...
    "Disallow publishing poll to all users" : "Prohibir la publicación de encuestas a todos los usuarios",
    "Allow poll sharing to all users for the following groups" : "Permitir compartir encuestas a todos los usuarios de los siguientes grupos",
    ...
    "Add a translucent effect on foreground elements like sidebar and poll table (Does not work with all browsers)." : "Añadir un efecto translúcido en elementos en primer plano como la barra lateral y la tabla de la encuesta (No funciona en todos los navegadores).",
    "Shares" : "Compartidos",
    "Has voted" : "Ha votado",
    ...
    "Poll creation restrictions" : "Limitaciones en la creación de encuestas",
