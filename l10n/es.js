OC.L10N.register(
    ...
    "%s is the new owner of your poll." : "%s es el nuevo propietario de su encuesta.",
    "{actor} transfered your poll \"%s\" to {newOwner}. You are no more the owner." : "{actor} transfirió su encuesta \"%s\" a {newOwner}. Ya Ud. no es el propietario.",
    ...
    "This poll does not exist (anymore)." : "Esta encuesta ya no existe.",
    "No one." : "Nadie.",
    "Access denied" : "Acceso denegado",
    "You have no access to this poll. Contact %s if you think this is a mistake." : "No tiene acceso a esta encuesta. Contacte a %s si piensa que es un error.",
    ...
    "You have closed the poll \"{pollTitle}\"" : "Ha cerrado la encuesta \"{pollTitle}\"",
    ...
    "You have reopened the poll \"{pollTitle}\"" : "Ha reabierto la encuesta \"{pollTitle}\"",
    ...
    "One or more orphaned votes heve been deleted from {pollTitle}" : "Uno o más votos huérfanos han sido eliminados de {pollTitle}",
    "{actor} has deleted your orphaned polls from poll {pollTitle}" : "{actor} ha eliminado sus encuestas huérfanas de la encuesta {pollTitle}",
    "Orphaned votes deleted" : "Votos huérfanos eliminados",
    "{actor} deleted orphaned votes" : "{actor} eliminó los votos huérfanos",
    ...
    "Add another poll" : "Añadir otra encuesta",
    "Open poll now" : "Abrir encuesta ahora",
    ...
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "Esta encuesta es una encuesta anónima para todos, incluyendo al propietario. Deanonimizar la misma está deshabilitado.",
    ...
    "This poll is an anonymous poll for everyone, except for the owner and delegated poll administration." : "Esta encuesta es una encuesta anónima para todos, excepto para el propietario y para cualquier administración delegada de la misma.",
    "Anonymization of this poll can be removed at any time by the owner and delegated poll administration." : "La anonimización de esta encuesta puede ser removida en cualquier momento por el propietario y por la administración delegada de la misma.",
    "This poll is closed." : "Esta encuesta está cerrada.",
    "No further action is possible." : "No es posible tomar ninguna acción adicional.",
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduce your vote quota._" : ["%n voto huérfano reducen su cuota de votación.","%n votos huérfanos reducen su cuota de votación.","%n votos huérfanos reducen su cuota de votación."],
    ...
    "You have no votes left." : "No tiene votos disponibles.",
    "_You have %n vote left out of {maxVotes}._::_You have %n votes left out of {maxVotes}._" : ["Tiene disponible %n voto de {maxVotes}","Tiene disponibles %n votos de {maxVotes}","Tiene disponibles %n votos de {maxVotes}"],
    ...
    "Anonymize poll irrevocably" : "Anonimizar encuesta de manera irrevocable",
    "Cancel" : "Cancelar",
    "Ok" : "Aceptar",
    ...
    "Use explicit \"No\" votes" : "Utilizar votos \"No\" explícitos",
    ...
    "\"{pollTitle}\" has been added" : "\"{pollTitle}\" se ha añadido",
    "Choose a meaningful title for your poll" : "Escoja un nombre significativo para su encuesta",
    "Close" : "Cerrar",
    "Yes" : "Si",
    "No" : "No",
    ...
    "Error exporting file." : "Error exportando archivo.",
    ...
    "This will finally delete the poll and {username} will get notified." : "Esto eliminará finalmente la encuesta y se le notificará a {username}.",
    "This will finally delete the poll." : "Esto eliminará finalmente la encuesta.",
    "OK" : "OK",
    ...
    "Transfered poll to {user}." : "Se transfirió la encuesta a {user}.",
    "Error transfering poll." : "Error al transferir la encuesta.",
    "Transfering a poll to another user may result in loss of access to this poll." : "Transferir una encuesta a otro usuario puede resultar en la pérdida de acceso a esta encuesta.",
    "Transfering a poll to {user} may result in loss of access to this poll." : "Transferir una encuesta a {user} puede resultar en la pérdida de acceso a esta encuesta.",
    "You are not the owner of this poll. {owner} will get informed about this action." : "Ud. no es el propietario de esta encuesta. {owner} será informado acerca de esta acción.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "Ud. no es el propietario de esta encuesta. {owner} será informado acerca de la transferencia a {newUser}.",
    ...
    "Sort by answers of this option" : "Ordenar por las respuestas a esta opción",
    "Option already exists" : "La opción ya existe",
    "Error adding Option" : "Error al añadir la opción",
    "Add times" : "Añadir horas",
    "All day" : "Todo el día",
    "Add a new date/time" : "Añadir una nueva fecha/hora",
    "Duration" : "Duración",
    "Duration time unit" : "Unidad de tiempo de duración",
    "Repetitions" : "Repeticiones",
    "Automatically vote \"Yes\" for new option." : "Votar automáticamente \"Sí\" para la nueva opción.",
    ...
    "Created {dateTime}" : "Creado el {dateTime}",
    "Created {dateRelative}" : "Creado hace {dateRelative}",
    "Closing: {dateTime}" : "Cerrando: {dateTime}",
    ...
    "You participated" : "Ud. Participó",
    "Poll owner: {ownerName}" : "Propietario de la encuesta: {ownerName}",
    "never" : "nunca",
    "Take over poll?" : "¿Tomar el control de la encuesta?",
    "You will become the new owner and {username} will get notified." : "Se convertirá en el nuevo propietario y se le notificará a {username}.",
    "The poll group was deleted by removing the last member." : "El grupo de encuesta se ha eliminado al quitar al último miembro.",
    "Error removing poll from group." : "Error al quitar encuesta del grupo.",
    "Error creating new poll group." : "Error al crear nuevo grupo de encuesta",
    "Error archiving/restoring poll." : "Error al archivar/restaurar encuesta.",
    "Error cloning poll." : "Error al clonar encuesta.",
    "Error taking over poll." : "Error al tomar el control de la encuesta.",
    "Back" : "Atrás",
    "Take over" : "Tomar el control",
    "Transfer poll ownership" : "Transferir propiedad de encuesta",
    ...
    "Enable the automatic deletion of archived polls" : "Habilitar la eliminación automática de las encuestas archivadas",
    "Days after which archived polls should be finally deleted" : "Días después de los cuales las encuestas archivadas deben ser finalmente eliminadas",
    ...
    "{jobName} has been executed." : "Se ha ejecutado {jobName}.",
    "Start {jobName} manually." : "Iniciar {jobName} manualmente.",
    "{jobName} does not support manually run." : "{jobName} no permite ejecutarse manualmente.",
    "Request Execution" : "Solicitar ejecución",
    "Request job execution" : "Solicitar ejecución de trabajo",
    ...
    "If you want to use different terms for public polls, enter them below." : "Si desea utilizar términos diferentes para las encuestas públicas, ingrese los mismos a continuación",
    ...
    "Anonymizing a poll of a restricted owner means that this poll is anonymous for everyone, including the owner." : "Anonimizar una encuesta de un propietario restringido significa que esta encuesta será anónima para todos, incluyendo al propietario.",
    "Deleting and changing votes of participants is not possible" : "Eliminar y cambiar votos de los participantes no es posible",
    ...
    "Verbose poll list" : "Lista de encuestas detallada",
    "Check this for more poll information in the overview." : "Marque aquí para más información de la encuesta en el resumen.",
    ...
    "Poll group access" : "Acceso del grupo de encuesta",
    "(deleted)" : "(borrado)",
    "(locked)" : "(bloqueado)",
    ...
    "Grant administrative poll access" : "Conceder acceso administrativo a la encuesta",
    "Withdraw administrative poll access" : "Retirar acceso administrativo a la encuesta",
    ...
    "Comments are disabled, except for owner and delegated poll administration." : "Los comentarios están deshabilitados, excepto los del propietario y la administración delegada para la encuesta.",
    "You have been granted administrative rights." : "Se le han concedido derechos administrativos.",
    "Changes may affect existing votes." : "Los cambios podrían afectar los votos existentes.",
    "Poll configuration" : "Configuración de la encuesta",
    "Poll closing status" : "Estado de cierre de la encuesta",
    "Result display" : "Muestra de resultados",
    "Forced display mode" : "Modo de visualización forzado",
    "Deletion and owner" : "Eliminación y propietario",
    ...
    "Shares for a poll group grant voting access to the polls contained in the poll group." : "Los recursos compartidos hacia un grupo de encuesta conceden acceso de votación a las encuestas contenidas en ese grupo de encuesta.",
    ...
    "Vote already booked out" : "El voto ya ha sido contabilizado",
    "Error saving vote" : "Error al guardar el voto",
    "Click to vote with {nextAnswer} for option {option}" : "Haga clic para votar con {nextAnswer} para la opción {option}",
    "Participant {userId} has been removed" : "El participante {userId} ha sido eliminado",
    "Remove votes of {displayName}" : "Quitar votos de {displayName}",
    "Click to sort by name" : "Haga clic para ordenar por nombre",
    "Click to remove sorting" : "Haga clic para quitar el ordenamiento",
    ...
    "Manually start background jobs, independent from the cron schedule." : "Iniciar manualmente los trabajos en segundo plano, independientes del esquema de cron.",
    ...
    "Fetching polls…" : "Obteniendo encuestas…",
    ...
    "Loading poll…" : "Cargando encuesta…",
    "Fetching configuration…" : "Obteniendo configuración…",
    "Collecting elements…" : "Recolectando elementos…",
    "This seems to be a huge poll, please be patient…" : "Esta parece ser una encuesta enorme, por favor, tenga paciencia…",
    ...
    "Poll updated" : "Encuesta actualizada",
    ...
    "Relevant" : "Relevante",
    "Relevant polls which are relevant to you, because you are a participant, the owner or you are invited. Only polls not older than 100 days compared to creation, last interaction, expiration or latest option (for date polls) are shown." : "Encuestas relevantes que son relevantes para Ud., bien sea por que es un participante, ell propietario o a que ha sido invitado. Sólo se mostrarán encuestas con una antigüedad no mayor a 100 días comparándolas con fecha de creación, última interacción, caducidad o la última opción (para encuestas de fecha).",
    "My polls" : "Mis encuestas",
    "These are all polls where you are the owner." : "Estas son todas las encuestas en las que Ud. es el propietario.",
    ...
    "All polls in which you participated." : "Todas las encuestas en las que ha participado.",
    "Openly accessible polls" : "Encuestas de libre acceso",
    "A complete list with all openly accessible polls on this site." : "Una lista completa de todas las encuestas abiertamente accesibles en este sitio.",
    ...
    "You can delete, archive and take over polls in this list, but access is still not possible." : "Puede eliminar, archivar o tomar posesión de las encuestas en esta lista, pero el acceso a ellas será siendo imposible."
},
