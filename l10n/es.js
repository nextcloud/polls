OC.L10N.register(
    ...
    "_%n orphaned vote of a probaly deleted option is possibly blocking your vote limit._::_%n orphaned votes of probaly deleted options are possibly blocking your vote limit._" : ["%n voto huérfano de una opción que está probablemente eliminada está bloqueando su límite de votos.","%n votos huérfanos de opciones que están probablemente eliminadas están bloqueando su límite de votos.","%n votos huérfanos de opciones que están probablemente eliminadas están bloqueando su límite de votos."],
    ...
    "Use alternative option add dialog" : "Utilizar diálogo alternativo para adición de opciones",
    "Arrange description and card hints side by side" : "Ordenar las pistas de descripción y tarjetas de lado a lado",
