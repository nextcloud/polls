OC.L10N.register(
    ...
    "_%n person participated in this poll until now. _::_%n persons participated in this poll until now. _" : ["Dosad je anketu ispunila %n osoba. ","Dosad su anketu ispunile %n osobe. ","Dosad je anketu ispunilo %n osoba. "],
    ...
    "Voting is no more possible, because this poll expired since %n. " : "Glasanje nije moguće jer je anketa zatvorena od %n. ",
    "Comments" : "Komentari",
    ...
    "Hide results until poll is expired" : "Sakrij rezultate do isteka ankete",
    ...
    "To participate, enter a username with at least 3 characters." : "Ako želite sudjelovati, unesite korisničko ime koje sadrži najmanje 3 znaka.",
    "Enter your name" : "Unesite svoje ime",
    ...
    "This are your polls (where you are the owner)." : "Ovo su vaše ankete (kojima ste vlasnik).",
    "This are all polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without expired polls." : "Ove ankete imaju odgovarajuće značenje za vas jer ste njihov sudionik ili vlasnik ili ste pozvani da u njima sudjelujete. Bez isteklih anketa.",
    ...
    "These are all hidden polls, to which you have access." : "Ovo su skrivene ankete kojima možete pristupiti.",
    "This is simply the trash bin." : "Ovo je kanta za smeće.",
