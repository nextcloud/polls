OC.L10N.register(
    ...
    "You are asked to propose more options for this poll." : "Od vas se traži da predložite dodatne mogućnosti za ovu anketu.",
    "Adding proposals ends {timeRelative}." : "Dodavanje prijedloga završava {timeRelative}.",
    "Adding proposals ended {timeRelative}." : "Dodavanje prijedloga završeno {timeRelative}.",
    ...
    "Add some!" : "Dodajte ih!",
    "Add new date option" : "Dodaj novu mogućnost datuma",
    ...
    "Add new text option" : "Dodaj novu mogućnost teksta",
    ...
    "Option proposals allowed" : "Dopušteno je predlaganje mogućnosti",
    "Option proposal term ends {timeRelative}" : "Rok prijedloga mogućnosti završava {timeRelative}",
    "Option proposal term ended {timeRelative}" : "Rok prijedloga mogućnosti je završio {timeRelative}",
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "Dodajte parametre URL-a 'name=' i/ili 'email=' kako bi se unaprijed definiralo ime i adresa e-pošte. Na primjer: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org",
