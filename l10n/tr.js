OC.L10N.register(
    ...
    "_%n orphaned vote of a probaly deleted option is possibly blocking your vote limit._::_%n orphaned votes of probaly deleted options are possibly blocking your vote limit._" : ["Büyük olasılıkla silinmiş bir seçenekteki %n sahipsiz oy, oy sınırınızı aşıyor.","Büyük olasılıkla silinmiş seçeneklerdeki %n sahipsiz oy, oy sınırınızı aşıyor."],
    ...
    "Preview" : "Ön izleme",
    "Added" : "Eklendi",
    "Shifting dates is disabled to prevent shifting of proposals of other participants." : "Diğer katılımcıların önerilerinin kaydırılmaması için tarihlerin kaydırılması kullanımdan kaldırıldı.",
    "Submit" : "Gönder",
    ...
    "Arrange description and card hints side by side" : "Açıklama ve kart ipuçlarını yan yana düzenleyin",
    ...
    "Resolving of {name} is not possible. The circles app is not enabled." : "{name} adı çözümlenemedi. Takımlar uygulaması kullanıma alınmadı.",
    "Resolving of {name} is not possible. The contacts app is not enabled." : "{name} adı çözümlenemedi. Kişiler uygulaması kullanıma alınamadı.",
