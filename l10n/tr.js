OC.L10N.register(
    ...
    "This poll is an anonymous poll for everyone, including the owner. Deanonymizing is disabled for this poll." : "Bu anket, sahibi ile birlikte herkes için anonim bir ankettir. Bu anket için anonimleştirme kapalı.",
    ...
    "Anonymization of this poll can be removed at any time by the owner and delegated poll administration." : "Bu anketin anonimleştirmesi, sahibi ve atanmış anket yöneticisi tarafından herhangi bir zamanda kapatılabilir.",
    ...
    "_You have %n vote left out of {maxVotes}._::_You have %n votes left out of {maxVotes}._" : ["Verebileceğiniz %n/{maxVotes} oy kaldı.","Verebileceğiniz %n/{maxVotes} oy kaldı."],
    ...
    "You are not the owner of this poll. {owner} will get informed about this action." : "Bu anletin sahibi değilsiniz. Bu işlem {owner} kullanıcısına bildirilecek.",
    "You are not the owner of this poll. {owner} will get informed about the transfer to {newUser}." : "Bu anletin sahibi değilsiniz. {newUser} kullanıcısına aktarma {owner} kullanıcısına bildirilecek.",
    ...
    "Closing: {dateTime}" : "Tamamlanma: {dateTime}",
    ...
    "Private poll, only invited participants have access" : "Gizli anket. Yalnızca davet edilmiş katılımcılar erişebilir",
    "Open poll, accessible to all users of this instance" : "Açık anket. Bu kopyadaki tüm kullanıcılar erişebilir",
    ...
    "Anonymizing a poll of a restricted owner means that this poll is anonymous for everyone, including the owner." : "Kısıtlanmış bir sahibin anketini anonimleştirmek, bu anketin sahibiyle birlikte herkes için anonim olduğu anlamına gelir.",
    ...
    "All closed polls, where voting is disabled." : "Oy vermenin kapatıldığı tüm sona ermemiş anketler. ",
    "Archive" : "Arşiv",
