OC.L10N.register(
    ...
    "Edit poll group" : "Anket grubunu düzenle",
    ...
    "Due to possible performance issues {countHiddenParticipants} voters are hidden." : "Yaşanabilecek başarım sorunlarını engellemek için {countHiddenParticipants} oy veren gizlendi.",
    ...
    "_%n orphaned vote reduces your vote quota._::_%n orphaned votes reduces your vote quota._" : ["%n sahipsiz oy oy kotanızı azaltıyor.","%n sahipsiz oy oy kotanızı azaltıyor."],
    ...
    "Choose a more meaningful title for the overview page" : "Özet sayfası için anlamlı bir başlık seçin",
    "Choose a description for the overview page" : "Özet sayfası için bir açıklama seçin",
    "Note: Changing the title, also changes the URL" : "Not: Başlığın değiştirilmesi adresi de değiştirir",
    ...
    "Use fixed table headers" : "Sabit tablo başlıkları kullanılsın",
    ...
    "Deletion and Owner" : "Silme ve Sahiplik",
    ...
    "Group without title" : "Başlığı olmayan grup",
    ...
    "Group without description" : "Açıklaması olmayan grup",
