OC.L10N.register(
    ...
    "{actor} has shared poll {pollTitle} with circle {sharee}" : "{actor}, {pollTitle} anketini {sharee} takımı ile paylaştı",
    "You have shared this poll with circle {sharee}" : "Bu anketi {sharee} takımı ile paylaştınız",
    "{actor} has shared this poll with circle {sharee}" : "{actor}, bu anketi {sharee} takımı ile paylaştı",
    ...
    "You have deleted the share for circle {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} takımı ile paylaşımını sildiniz",
    "{actor} has deleted the share for circle {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} takımı ile paylaşımını sildi",
    ...
    "You have restored the share for {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} paylaşımını geri yüklediniz",
    ...
    "You have restored the share for group {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} grubuyla paylaşımını geri yükledi",
    "{actor} has restored the share for group {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} grubuyla paylaşımını geri yükledi",
    ...
    "You have restored the share for circle {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} takımı ile paylaşımını geri yüklediniz",
    "{actor} has restored the share for circle {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} takımı ile paylaşımını geri yükledi",
    ...
    "You have restored the share for contact group {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} kişi grubuyla paylaşımını geri yüklediniz",
    "{actor} has restored the share for contact group {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} kişi grubuyla paylaşımını geri yükledi",
