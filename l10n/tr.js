OC.L10N.register(
    ...
    "Activate all calendars to consult for the search of conflicting events." : "Çakışan etkinliklerin aranması için tüm takvimlere başvurulsun. ",
    "Set the time interval in hours, a calendar event must be finished before a date option, to get accounted to the conflict check." : "Saat olarak zamanı ayarlayın. Bir takvim etkinliği çakışma denetiminden geçebilmesi için bir tarih seçeneğinden önce bitmelidir.",
    "Set the time interval in hours, a calendar event must start after a date option, to get accounted to the conflict check." : "Saat olarak zamanı ayarlayın. Bir takvim etkinliği çakışma denetiminden geçebilmesi için bir tarih seçeneğinden sonra başlamalıdır.",
