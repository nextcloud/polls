OC.L10N.register(
    ...
    "Share and votes of {displayName} deleted" : "{displayName} kullanıcısının paylaşımı ve oyları silindi",
    "Share of {displayName} deleted" : "{displayName} kullanıcısının paylaşımı silindi",
    "Error deleting share of {displayName}" : "{displayName} kullanıcısının paylaşımı silinirken sorun çıktı",
