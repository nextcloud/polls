OC.L10N.register(
    ...
    "Select a time" : "Bir saat seçin",
    "Enter a time" : "Bir saat yazın",
    "Conflict" : "Çakışma",
    "Add" : "Ekle",
    ...
    "Preview" : "Ön izleme",
    "_%n repetition until_::_%n repetitions until_" : ["Şu zamana kadar %n yineleme","Şu zamana kadar %n yineleme"],
    "No duration" : "Herhangi bir süre belirtilmemiş",
    "_year_::_years_" : ["yıl","yıl"],
    "_month_::_months_" : ["ay","ay"],
    "_day_::_days_" : ["gün","gün"],
    "_hour_::_hours_" : ["saat","saat"],
    "_minute_::_minutes_" : ["dakika","dakika"],
    "Time range" : "Saat aralığı",
    ...
    "Use alternative option add dialog" : "Alternatif seçenek ekleme penceresi kullanılsın",
    ...
    "Error deleting pollStore." : "Anket kaydı silinirken sorun çıktı.",
    ...
    "Error loading polls list for admins" : "Yöneticiler için anket listesi yüklenirken sorun çıktı",
