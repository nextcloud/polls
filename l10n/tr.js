OC.L10N.register(
    ...
    "Only use them, if it is absolutely neccessary (i.e. your cron does not work properly) or for testing." : "Bunları yalnızca kesinlikle gerekliyse (örneğin zamanlanmış göreviniz düzgün çalışmıyorsa) ya da deneme amaçlıysa kullanın.",
    ...
    "The time information just displays the last regular cron job run, not the manually initiated runs." : "Zaman bilgisi, el ile başlatılan yürütmeleri değil, yalnızca son normal zamanlanmış görevin yürütülmesi gösterir.",
