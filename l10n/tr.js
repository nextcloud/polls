OC.L10N.register(
    ...
    "Preview" : "Ön izleme",
    "Added" : "Eklendi",
    "Shifting dates is disabled to prevent shifting of proposals of other participants." : "Diğer katılımcıların önerilerinin kaydırılmaması için tarihlerin kaydırılması devre dışı bırakıldı.",
    "Submit" : "Gönder",
    ...
    "Resolving of {name} is not possible. The contacts app is not enabled." : "{name} adı çözümlenemedi. Kişiler uygulaması etkin değil.",
    "Resolving of {name} is not possible. The circles app is not enabled." : "{name} adı çözümlenemedi. Takımlar uygulaması etkin değil.",
