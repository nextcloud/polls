OC.L10N.register(
    ...
    "%s permanently deleted your poll" : "%s anketinizi kalıcı olarak sildi",
    ...
    "- The poll was closed." : "- Anket bitirildi.",
    ...
    "Hide results until poll is closed" : "Sonuçlar anket bitirilene kadar gizlensin",
    ...
    "Option proposals allowed" : "Seçenek önerileri yapılabilir",
    "Option proposal term ends {timeRelative}" : "Seçenek önerilerinin bitiş zamanı {timeRelative}",
    "Option proposal term ended {timeRelative}" : "Seçenek önerilerinin zamanı bitti {timeRelative}",
    ...
    "Deleted" : "Silindi",
    "Closed {relativeTimeAgo}" : "Bitmiş {relativeTimeAgo}",
