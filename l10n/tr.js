OC.L10N.register(
    ...
    "_%n vote is allowed per user._::_%n votes are allowed per user._" : ["Her kullanıcı için %n oy verilebilir.","Her kullanıcı için %n oy verilebilir."],
    ...
    "Otherwise participate as a guest user." : "Yoksa konuk kullanıcı olarak katılın.",
    ...
    "Archive closed polls automatically" : "Sona ermiş anketler otomatik olarak arşivlensin",
    "After how many days are closed polls to be archived:" : "Sona ermiş anketlerin kaç gün sonra arşivleneceği:",
    ...
    "If this threshold gets tresspasses only the current user will be displayed, to avoid a performance breakdown." : "Bu eşik aşılırsa, başarımın olumsuz etkilenmesini önlemek için yalnızca geçerli kullanıcı görüntülenir.",
    ...
    "Error while changing lock status of user {displayName}" : "{displayName} kullanıcısının kilit durumu değiştirilirken sorun çıktı",
    ...
    "Anonymized user" : "Anonimleştirilmiş kullanıcı",
