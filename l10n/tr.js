OC.L10N.register(
    ...
    "You have restored the share for circle {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} çevresiyle paylaşımını geri yüklediniz",
    "{actor} has restored the share for circle {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} çevresiyle paylaşımını geri yükledi",
    "You have restored the share for circle {sharee}" : "{sharee} çevresiyle paylaşımı geri yüklediniz",
    "{actor} has restored the share for circle {sharee}" : "{actor}, {sharee} çevresiyle paylaşımı geri yükledi",
