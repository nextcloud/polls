OC.L10N.register(
    ...
    "You commented poll {pollTitle}" : "{pollTitle} anketi hakkında yorum yaptınız",
    "{actor} commented poll {pollTitle}" : "{actor}, {pollTitle} anketi hakkında yorum yaptı",
    "You deleted a commented from poll {pollTitle}" : "{pollTitle} anketi hakkındaki bir yorumu sildiniz",
    "{actor} deleted a commented from poll {pollTitle}" : "{actor}, {pollTitle} anketi hakkındaki bir yorumu sildi",
    "You added an option to poll {pollTitle}" : "{pollTitle} anketine bir seçenek eklediniz",
    "{actor} added an option to poll {pollTitle}" : "{actor}, {pollTitle} anketine bir seçenek ekledi",
    "You changed an option of poll {pollTitle}" : "{pollTitle} anketindeki bir seçeneği değiştirdiniz",
    "{actor} changed an option of poll {pollTitle}" : "{actor}, {pollTitle} anketindeki bir seçeneği değiştirdi",
    "You confirmed option {optionTitle} of poll {pollTitle}" : "{pollTitle} anketindeki {optionTitle} seçeneğini onayladınız",
    "{actor} confirmed option {optionTitle} of poll {pollTitle}" : "{actor}, {pollTitle} anketindeki bir seçeneği onayladı",
    "You unconfirmed option {optionTitle} of poll {pollTitle}" : "{pollTitle} anketindeki {optionTitle} seçeneğini onaylamadınız",
    "{actor} unconfirmed option {optionTitle} of poll {pollTitle}" : "{actor}, {pollTitle} anketindeki bir seçeneği onaylamadı",
    "You removed option {optionTitle} from poll {pollTitle}" : "{pollTitle} anketindeki {optionTitle} seçeneğini kaldırdınız",
    "{actor} removed option {optionTitle} from poll {pollTitle}" : "{actor}, {pollTitle} anketindeki bir seçeneği kaldırdı",
    "You added poll {pollTitle}" : "{pollTitle} anketini eklediniz",
    "{actor} added poll {pollTitle}" : "{actor}, {pollTitle} anketini ekledi",
    "You changed the configuration of poll {pollTitle}" : "{pollTitle} anketinin yapılandırmasını değiştirdiniz",
    "{actor} changed the configuration of poll {pollTitle}" : "{actor}, {pollTitle} anketinin yapılandırmasını değiştirdi",
    "You archived poll {pollTitle}" : "{pollTitle} anketini arşivlediniz",
    "{actor} archived poll {pollTitle}" : "{actor}, {pollTitle} anketini arşivledi",
    "You restored poll {pollTitle}" : "{pollTitle} anketini geri yüklediniz",
    "{actor} restored poll {pollTitle}" : "{actor}, {pollTitle} anketini geri yükledi",
    "Poll {pollTitle} was closed" : "\"{pollTitle}\" anketi bitmiş",
    "You changed the owner of poll {pollTitle}" : "{pollTitle} anketinin sahibini değiştirdiniz",
    "{actor} changed the owner of poll {pollTitle}" : "{actor}, {pollTitle} anketinin sahibini değiştirdi",
    "You reordered the options of poll {pollTitle}" : "{pollTitle} anketinin seçeneklerini yeniden sıraladınız",
    "{actor} reordered the options of poll {pollTitle}" : "{actor}, {pollTitle} anketinin seçeneklerini yeniden sıraladı",
    "You added a public share to poll {pollTitle}" : "{pollTitle} anketine herkese açık bir paylaşım eklediniz",
    "{actor} added a public share to poll {pollTitle}" : "{actor}, {pollTitle} anketine herkese açık bir paylaşım ekledi",
    "You shared poll {pollTitle} with group {sharee}" : "{pollTitle} anketini {sharee} grubu ile paylaştınız",
    "{actor} You shared poll {pollTitle} with group {sharee}" : "{actor}, {pollTitle} anketini {sharee} grubu ile paylaştı",
    "You shared poll {pollTitle} with circle {sharee}" : "{pollTitle} anketini {sharee} çevresi ile paylaştınız",
    "{actor} shared poll {pollTitle} with circle {sharee}" : "{actor}, {pollTitle} anketini {sharee} çevresi ile paylaştı",
    "You shared poll {pollTitle} with contact group {sharee}" : "{pollTitle} anketini {sharee} kişi grubu ile paylaştınız",
    "{actor} shared poll {pollTitle} with contact group {sharee}" : "{actor}, {pollTitle} anketini {sharee} kişi grubu ile paylaştı",
    "You shared poll {pollTitle} with {sharee}" : "{pollTitle} anketini {sharee} ile paylaştınız",
    "{actor} shared poll {pollTitle} with {sharee}" : "{actor}, {pollTitle} anketini {sharee} ile paylaştı",
    "You changed your email address" : "E-posta adresinizi değiştirdiniz",
    "{actor} changed his email address" : "{actor} e-posta adresini değiştirdi",
    "You changed the share type" : "Paylaşım türünü değiştirdiniz",
    "{actor} changed the share type" : "{actor} paylaşım türünü değiştirdi",
    "You changed the registration constraints for share {sharee}" : "{sharee} paylaşımı için kayıt kısıtlamalarını değiştirdiniz",
    "{actor} changed the registration constraints for share {sharee}" : "{actor}, {sharee} paylaşımı için kayıt kısıtlamalarını değiştirdi",
    "You registered to poll {pollTitle}" : "{pollTitle} anketine kayıt oldunuz",
    "{sharee} registered to poll {pollTitle}" : "{sharee}, {pollTitle} anketine kayıt oldu",
    "You deleted a public share from poll {pollTitle}" : "{pollTitle} anketindeki herkese açık bir paylaşımı sildiniz",
    "{actor} deleted a public share from poll {pollTitle}" : "{actor}, {pollTitle} anketindeki herkese açık bir paylaşımı sildi",
    "You deleted the share for group {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} grubuyla paylaşımını sildiniz",
    "{actor} deleted the share for group {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} grubuyla paylaşımını sildi",
    "You deleted the share for {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} ile paylaşımını sildiniz",
    "{actor} deleted the share for {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} ile paylaşımını sildi",
    "You deleted the share for circle {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} çevresiyle paylaşımını sildiniz",
    "{actor} deleted the share for circle {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} çevresiyle paylaşımını sildi",
    "You deleted the share for contact group {sharee} from poll {pollTitle}" : "{pollTitle} anketinin {sharee} kişi grubuyla paylaşımını sildiniz",
    "{actor} deleted the share for contact group {sharee} from poll {pollTitle}" : "{actor}, {pollTitle} anketinin {sharee} kişi grubuyla paylaşımını sildi",
    "You deleted a share from poll {pollTitle}" : "{pollTitle} anketindeki bir paylaşımı sildiniz",
    "{actor} deleted a share from poll {pollTitle}" : "{actor}, {pollTitle} anketindeki bir paylaşımı sildi",
    "You voted in poll {pollTitle}" : "{pollTitle} anketinde bir oy verdiniz",
    "{actor} voted in poll {pollTitle}" : "{actor}, {pollTitle} anketinde bir oy verdi",
    "You did something indescribable with poll {pollTitle}" : "{pollTitle} anketinde anlaşılamayan bir şey yaptınız",
    "{actor} did something indescribable with poll {pollTitle}" : "{actor}, {pollTitle} anketinde anlaşılamayan bir şey yaptı",
    "You commented" : "Yorum yaptınız",
    "{actor} commented" : "{actor} yorum yaptı",
    "You deleted a commented" : "Bir yorumu sildiniz",
    "{actor} deleted a commented" : "{actor} bir yorumu sildi",
    "You added an option" : "Bir seçenek eklediniz",
    "{actor} added an option" : "{actor} bir seçenek ekledi",
    "You changed an option" : "Bir seçeneği değiştirdiniz",
    "{actor} changed an option" : "{actor} bir seçeneği değiştirdi",
    "You confirmed option {optionTitle}" : "{optionTitle} seçeneğini onayladınız",
    "{actor} confirmed option {optionTitle}" : "{actor}, {optionTitle} seçeneğini onayladı",
    "You unconfirmed option {optionTitle}" : "{optionTitle} seçeneğini onaylamadınız",
    "{actor} unconfirmed option {optionTitle}" : "{actor}, {optionTitle} seçeneğini onaylamadı",
    "You removed option {optionTitle}" : "{optionTitle} seçeneğini kaldırdınız",
    "{actor} removed option {optionTitle}" : "{actor}, {optionTitle} seçeneğini kaldırdı",
    "You created this poll" : "Bu anketi oluşturdunuz",
    "{actor} created this poll" : "{actor} bu anketi oluşturdu",
    "You changed the configuration" : "Yapılandırmayı değiştirdiniz",
    "{actor} changed the configuration" : "{actor} yapılandırmayı değiştirdi",
    "You archived this poll" : "Bu anketi arşivlediniz",
    "{actor} archived this poll" : "{actor} bu anketi arşivledi",
    "You restored this poll" : "Bu anketi geri yüklediniz",
    "{actor} restored this poll" : "{actor} bu anketi geri yükledi",
    "This poll was closed" : "Bu anket bitti",
    "You changed the poll owner" : "Anket sahibini değiştirdiniz",
    "{actor} changed the poll owner" : "{actor} anket sahibini değiştirdi",
    "You reordered the options" : "Seçeneklerin sıralamasını değiştirdiniz",
    "{actor} reordered the options" : "{actor} seçeneklerin sıralamasını değiştirdi",
    "You added a public share" : "Herkese açık bir paylaşım eklediniz",
    "{actor} added a public share" : "{actor} herkese açık bir paylaşım ekledi",
    "You shared this poll with group {sharee}" : "Bu anketi {sharee} grubu ile paylaştınız",
    "{actor} You shared this poll with group {sharee}" : "{actor}, bu anketi {sharee} grubu ile paylaştı",
    "You shared this poll with circle {sharee}" : "Bu anketi {sharee} çevresi ile paylaştınız",
    "{actor} shared this poll with circle {sharee}" : "{actor}, bu anketi {sharee} çevresi ile paylaştı",
    "You shared this poll with contact group {sharee}" : "Bu anketi {sharee} kişi grubu ile paylaştınız",
    "{actor} shared this poll with contact group {sharee}" : "{actor}, bu anketi {sharee} kişi grubu ile paylaştı",
    "You shared this poll with {sharee}" : "Bu anketi {sharee} ile paylaştınız",
    "{actor} shared this poll with {sharee}" : "{actor}, bu anketi {sharee} ile paylaştı",
    "{actor}'s email address was changed" : "{actor} e-posta adresi değiştirildi",
    "You registered" : "Kayıt oldunuz",
    "{sharee} registered" : "{sharee} kayıt oldu",
    "You deleted a public share" : "Herkese açık bir paylaşımı sildiniz",
    "{actor} deleted a public share" : "{actor} herkese açık bir paylaşımı sildi",
    "You deleted the share for group {sharee}" : "{sharee} grubuyla paylaşımı sildiniz",
    "{actor} deleted the share for group {sharee}" : "{actor}, {sharee} grubuyla paylaşımı sildi",
    "You deleted the share for circle {sharee}" : "{sharee} çevresiyle paylaşımı sildiniz",
    "{actor} deleted the share for circle {sharee}" : "{actor}, {sharee} çevresiyle paylaşımı sildi",
    "You deleted the share for contact group {sharee}" : "{sharee} kişi grubuyla paylaşımı sildiniz",
    "{actor} deleted the share for contact group {sharee}" : "{actor}, {sharee} kişi grubuyla paylaşımı sildi",
    "You deleted {sharee}'s share" : "{sharee} paylaşımını sildiniz",
    "{actor} deleted a share" : "{actor} bir paylaşımı sildi",
    "You voted" : "Oyladınız",
    "{actor} voted" : "{actor} oyladı",
    "You did something indescribable with this poll" : "Bu ankette anlaşılamayan bir şey yaptınız",
    "{actor} did something indescribable with this poll" : "{actor} bu ankette anlaşılamayan bir şey yaptı",
    "Events happening inside of a <strong>poll</strong>" : "Bir <strong>ankette</strong> etkinlikler oluyor",
    "Someone votes inside a <strong>poll</strong>" : "Birileri bir <strong>ankete</strong> oy veriyor",
