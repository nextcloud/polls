OC.L10N.register(
    ...
    "{user} has invited you to the poll \"%s\"." : "{user} t'at invitadu a su sondàgiu \"%s\".",
    "%s took over your poll" : "%s at rilevadu su sondàgiu tuo",
    "{user} took over your poll \"%s\" and is the new owner." : "{user} at rilevadu su sondàgiu tuo \"%s\" e immoe nde tenet sa propiedade.",
    "%s permanently deleted your poll" : "%s at cantzelladu su sondàgiu tuo in manera permanente",
    "{user} permanently deleted your poll \"%s\"." : "{user} at cantzelladu su sondàgiu tuo \"%s\" in manera permanente.",
    "%s changed the deleted status of your poll." : "%s at cambiadu s'istadu de cantzellatzione de su sondàgiu tuo.",
    "{user} changed the deleted status of your poll \"%s\"." : " at cambiadu s'istadu de cantzellatzione de su sondàgiu tuo \"%s\".",
    "- %s voted." : "- %s at votadu.",
    ...
    "- The poll was closed." : "- Su sondàgiu est istadu serradu.",
    ...
    "Delete poll permanently" : "Cantzella sondàgiu in manera permanente",
    ...
    "Take over" : "Rileva",
    "Set \"deleted\" status" : "Imposta istadu \"cantzelladu\"",
    ...
    "Error switching deleted status." : "Errore cambiende s'istatus de cantzelladura.",
    ...
    "All polls which are relevant or important to you, because you are a participant or the owner or you are invited to. Without closed polls." : "Totu is sondàgios chi sunt pertinentes o importantes pro tue, ca ses partetzipante o sa propiedade t'at invitadu. Chene sondàgios serrados. ",
    ...
    "Deleted polls" : "Sondàgios cantzellados",
    "My deleted polls" : "Is sondàgios cantzellados mios",
    "The trash bin." : "S'àliga."
},
