OC.L10N.register(
    ...
    "Add URL parameters 'name=' and/or 'email=' to predefine name and email address. For example: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org" : "Agiunghe is paràmetros de s'URL 'name=' and/or 'email=' pro definire su nùmene e s'indiritzu de posta eletrònica. Pro esèmpiu: https://example.com/s/aUubZAvweQ6PaX2?name=John Doe&email=johndoe@example.org",
    ...
    "Comments" : "Cummentos",
    "Poll settings" : "Impostatzione de su sondàgiu",
