...
const proposalsStatus = computed(() => {
	if (pollStore.isProposalsOpen && !pollStore.isProposalExpirySet) {
...
const accessCaption = computed(() => pollStore.configuration.access === 'private' ? t('polls', 'Private poll') : t('polls', 'Openly accessible poll'))
