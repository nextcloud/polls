...
class AnonymizeService {
	 ...
	 *
	 * @param (Comment|Option|Vote|Poll)[]|Comment|Option|Vote|Poll $arrayOrObject
	 *
	 * @psalm-param Comment|Option|Vote|Poll|array<Comment|Option|Vote|Poll> $arrayOrObject
	 */
