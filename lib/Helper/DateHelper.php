...
abstract class DateHelper {
    ...
    public static function dateIntervalToSeconds(null|DateInterval $interval, DateTimeImmutable $baseDate): null|int {
        if ($interval === null) {
            return null;
        }
     ...
     */
    public static function dateIntervalToIso(null|DateInterval $interval): null|string {
        if ($interval === null) {
            return null;
        }
        $dateParts = [];
